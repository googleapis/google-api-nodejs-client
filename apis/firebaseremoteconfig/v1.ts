...
function Firebaseremoteconfig(options) {
  ...
  self.projects = {
    ...
    , /**
       ...
       * project id). * VERSION_MISMATCH (HTTP status 412) when trying to update
       * when the expected eTag (passed in via the "If-match" header) is not
       * specified, or is specified but does does not match the current eTag. *
...
Example: parameter key &quot;p1&quot;, default value &quot;v1&quot;, submap
specified as
{&quot;c1&quot;: v2, &quot;c2&quot;: v3} where &quot;c1&quot; and &quot;c2&quot;
are names of conditions in the condition list (where &quot;c1&quot; in this
example appears before &quot;c2&quot;).  The value of p1 would be v2 as long as
c1 is true.  Otherwise, if c2 is true, p1 would evaluate to v3, and if c1 and c2
are both false, p1 would evaluate to v1.  If no default value was specified, and
c1 and c2 were both false, no value for p1 would be generated.
...
&quot;CONDITION_DISPLAY_COLOR_UNSPECIFIED&quot; value (0) have the same meaning:
Let the UI choose any valid color when displaying the condition.
 */
/**
