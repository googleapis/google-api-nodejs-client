    ...
    builds: {
      ...
      get(params, options, callback) {
        ...
        return createAPIRequest(parameters, callback);
          ...
          * builds may still be in-progress, or may have finished successfully
          * or unsuccessfully.
 ...
 * @property {string} createTime Time when the trigger was created.  @OutputOnly
 ...
 * @property {string} filename Path, from the source root, to a file whose contents is used for the template.
 * @property {string} id Unique identifier of the trigger.  @OutputOnly
 * @property {object} substitutions Substitutions data for Build resource.
 * @property {cloudbuild(v1).RepoSource} triggerTemplate Template describing the types of source changes to trigger a build.  Branch and tag names in trigger templates are interpreted as regular expressions. Any branch or tag change that matches that regular expression will trigger a build.
 */
/**
 * @typedef BuiltImage
 * @memberOf! cloudbuild(v1)
