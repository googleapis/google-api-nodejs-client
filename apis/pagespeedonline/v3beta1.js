...
function Pagespeedonline(options) {
  ...
  this.pagespeedapi = {
     ...
     * @memberOf! pagespeedonline(v3beta1)
     *
    ...
    runpagespeed: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/pagespeedonline/v3beta1/runPagespeed',
          method: 'GET'
        },
        params: params,
        requiredParams: ['url'],
  ...
  this.mobilereadyapi = {
    ...
    /**
     * pagespeedonline.mobilereadyapi.runmobileready
     *
     * @desc Runs MobileReady analysis on the page at the specified URL, and returns MobileReady scores, a list of suggestions to make that page faster, and other information.
     *
     * @alias pagespeedonline.mobilereadyapi.runmobileready
     * @memberOf! pagespeedonline(v3beta1)
     *
     * @param  {object} params - Parameters for request
     * @param  {boolean=} params.filter_third_party_resources - Indicates if third party resources should be filtered out before PageSpeed analysis.
     ...
     * @return {object} Request object
     */
    runmobileready: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/pagespeedonline/v3beta1/mobileReady',
          method: 'GET'
        },
        params: params,
        requiredParams: ['url'],
