    ...
    agent: {
      ...
      intents:
          {
             ...
             * @desc Deletes intents in the specified agent.
      ...
      sessions: {
        ...
        , /**
           ...
           * actionable data as a result. This method is not idempotent, because
           * it may cause contexts and session entity types to be updated, which
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} avatarUri Optional. The URI of the agent&#39;s avatar.
Avatars are used throughout API.AI console and in the self-hosted
[Web Demo](https://dialogflow.com/docs/integrations/web-demo) integration.
 * @property {number} classificationThreshold Optional. To filter out false positive results and still get variety in
 ...
 * @property {string} defaultLanguageCode Required. The default language of the agent as a language tag. See
[Language Support](https://dialogflow.com/docs/reference/language) for a
list of the currently supported language codes.
This field cannot be set by the `Update` method.
 * @property {string} description Optional. The description of this agent.
 ...
 * @property {string} parent Required. The project of this agent.
Format: `projects/&lt;Project ID&gt;`.
 * @property {string[]} supportedLanguageCodes Optional. The list of all languages supported by this agent (except for the
`default_language_code`).
 * @property {string} timeZone Required. The time zone of this agent from the
 ...
 * @property {string} languageCode Optional. The language of entity synonyms defined in `entities`. If not
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string[]} entityValues Required. The canonical `values` of the entities to delete. Note that
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string[]} entityTypeNames Required. The names entity types to delete. All names must point to the
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).Intent[]} intents Required. The collection of intents to delete. Only intent `name` must be
filled in.
 */
/**
 ...
 * @property {string} entityTypeBatchUri Warning: Importing entity types from a URI is not implemented yet.
This feature is coming soon.
The URI to a Google Cloud Storage file containing entity types to update
or create. The file format can either be a serialized proto (of
EntityBatch type) or a JSON object. Note: The URI must start with
&quot;gs://&quot;.
 * @property {string} languageCode Optional. The language of entity synonyms defined in `entity_types`. If not
specified, the agent&#39;s default language is used.
[More than a dozen
languages](https://dialogflow.com/docs/reference/language) are supported.
Note: languages must be enabled in the agent, before they can be used.
 ...
 * @property {string} intentBatchUri Warning: Importing intents from a URI is not implemented yet.
This feature is coming soon.
 ...
 * @property {string} languageCode Optional. The language of training phrases, parameters and rich messages
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {integer} lifespanCount Optional. The number of conversational query requests after which the
context expires. If set to `0` (the default) the context expires
immediately. Contexts expire automatically after 10 minutes even if there
are no matching queries.
 * @property {string} name Required. The unique identifier of the context. Format:
`projects/&lt;Project ID&gt;/agent/sessions/&lt;Session
ID&gt;/contexts/&lt;Context ID&gt;`. Note: The Context ID is always converted to
lowercase.
 * @property {object} parameters Optional. The collection of parameters associated with this context.
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} inputAudio Optional. The natural language speech audio to be processed. This field
should be populated iff `query_input` is set to an input audio config.
A single request can contain up to 1 minute of speech audio data.
 * @property {dialogflow(v2beta1).QueryInput} queryInput Required. The input specification. It can be set to:
 ...
 * @property {string} responseId The unique identifier of the response. It can be used to
locate a response in the training example set or for reporting issues.
 * @property {dialogflow(v2beta1).Status} webhookStatus Specifies the status of the webhook request. `webhook_status`
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} autoExpansionMode Optional. Indicates whether the entity type can be automatically
expanded.
 ...
 * @property {string} name Required for all methods except `create` (`create` populates the name
automatically.
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string[]} synonyms Required. A collection of synonyms. For `KIND_LIST` entity types this
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} languageCode Required. The language of this query. See [Language
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} agentUri Warning: Exporting agents to a URI is not implemented yet.
This feature is coming soon.
 ...
 * @property {string} agentUri The URI to a file containing the exported agent. This field is populated
only if `agent_uri`
 */
/**
 ...
 * @property {string} agentUri Warning: Importing agents from a URI is not implemented yet.
This feature is coming soon.
 ...
 * @property {string} languageCode Required. The language of the supplied audio. Dialogflow does not do
translations. See [Language
Support](https://dialogflow.com/docs/languages) for a list of the
currently supported language codes. Note that queries in the same session
do not necessarily need to specify the same language.
 * @property {string[]} phraseHints Optional. The collection of phrase hints which are used to boost accuracy
of speech recognition.
Refer to [Cloud Speech API documentation](/speech/docs/basics#phrase-hints)
for more details.
 * @property {integer} sampleRateHertz Required. Sample rate (in Hertz) of the audio content sent in the query.
 ...
 * @property {string[]} defaultResponsePlatforms Optional. The list of platforms for which the first response will be
taken from among the messages assigned to the DEFAULT_PLATFORM.
 * @property {string} displayName Required. The name of this intent.
 * @property {string[]} events Optional. The collection of event names that trigger the intent.
If the collection of input contexts is not empty, all of the contexts must
be present in the active user session for an event to trigger this intent.
 * @property {dialogflow(v2beta1).IntentFollowupIntentInfo[]} followupIntentInfo Optional. Collection of information about all followup intents that have
name of this intent as a root_name.
 * @property {string[]} inputContextNames Optional. The list of context names required for this intent to be
triggered.
 ...
 * @property {dialogflow(v2beta1).IntentMessage[]} messages Optional. The collection of rich messages corresponding to the
`Response` field in API.AI console.
 * @property {boolean} mlEnabled Optional. Indicates whether Machine Learning is enabled for the intent.
 ...
 * @property {dialogflow(v2beta1).Context[]} outputContexts Optional. The collection of contexts that are activated when the intent
 ...
 * @property {string} parentFollowupIntentName The unique identifier of the parent intent in the chain of followup
intents.
It identifies the parent followup intent.
Format: `projects/&lt;Project ID&gt;/agent/intents/&lt;Intent ID&gt;`.
 * @property {integer} priority Optional. The priority of this intent. Higher numbers represent higher
priorities. Zero or negative numbers mean that the intent is disabled.
 * @property {boolean} resetContexts Optional. Indicates whether to delete all contexts in the current
session when this intent is matched.
 * @property {string} rootFollowupIntentName The unique identifier of the root intent in the chain of followup intents.
It identifies the correct followup intents chain for this intent.
Format: `projects/&lt;Project ID&gt;/agent/intents/&lt;Intent ID&gt;`.
 * @property {dialogflow(v2beta1).IntentTrainingPhrase[]} trainingPhrases Optional. The collection of examples/templates that the agent is
trained on.
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} followupIntentName The unique identifier of the followup intent.
Format: `projects/&lt;Project ID&gt;/agent/intents/&lt;Intent ID&gt;`.
 * @property {string} parentFollowupIntentName The unique identifier of the followup intent parent.
Format: `projects/&lt;Project ID&gt;/agent/intents/&lt;Intent ID&gt;`.
 */
/**
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} postback Optional. The text to send back to the Dialogflow API or a URI to
open.
 ...
 * @property {string} uri Required. The URI of the app or site to open when the user taps the
suggestion chip.
 */
/**
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} key Required. A unique key that will be sent back to the agent if this
response is given.
 * @property {string[]} synonyms Optional. A list of synonyms that can also be used to trigger this
item in dialog.
 */
/**
 ...
 * @property {string} ssml One of text_to_speech or ssml must be provided. Structured spoken
response to the user in the SSML format. Mutually exclusive with
text_to_speech.
 * @property {string} textToSpeech One of text_to_speech or ssml must be provided. The plain text of the
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} defaultValue Optional. The default value to use when the `value` yields an empty
result.
Default values can be extracted from contexts by using the following
syntax: `#context_name.parameter_name`.
 * @property {string} displayName Required. The name of the parameter.
 * @property {string} entityTypeDisplayName Optional. The name of the entity type, prefixed with `@`, that
describes values of the parameter. If the parameter is
required, this must be provided.
 * @property {boolean} isList Optional. Indicates whether the parameter represents a list of values.
 * @property {boolean} mandatory Optional. Indicates whether the parameter is required. That is,
whether the intent cannot be completed without collecting the parameter
value.
 * @property {string} name The unique identifier of this parameter.
 * @property {string[]} prompts Optional. The collection of prompts that the agent can present to the
user in order to collect value for the parameter.
 * @property {string} value Optional. The definition of the parameter value. It can be:
- a constant string,
 ...
 * @property {dialogflow(v2beta1).IntentTrainingPhrasePart[]} parts Required. The collection of training phrase parts (can be annotated).
Fields: `entity_type`, `alias` and `user_defined` should be populated
only for the annotated parts of the training phrase.
 * @property {integer} timesAddedCount Optional. Indicates how many times this example or template was added to
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} alias Optional. The parameter name for the value extracted from the
annotated part of the example.
 * @property {string} entityType Optional. The entity type name prefixed with `@`. This field is
required for the annotated part of the text and applies only to
examples.
 * @property {string} text Required. The text corresponding to the example or template,
if there are no annotations. For
annotated examples, it is the text for one of the example&#39;s parts.
 * @property {boolean} userDefined Optional. Indicates whether the text was manually annotated by the
developer.
 */
/**
 * @typedef LatLng
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).Context[]} contexts The list of contexts. There will be a maximum number of items
returned based on the page_size field in the request.
 * @property {string} nextPageToken Token to retrieve the next page of results, or empty if there are no
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).EntityType[]} entityTypes The list of agent entity types. There will be a maximum number of items
returned based on the page_size field in the request.
 * @property {string} nextPageToken Token to retrieve the next page of results, or empty if there are no
more results in the list.
 */
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).Intent[]} intents The list of agent intents. There will be a maximum number of items
returned based on the page_size field in the request.
 * @property {string} nextPageToken Token to retrieve the next page of results, or empty if there are no
more results in the list.
 */
 ...
 * @property {string} nextPageToken Token to retrieve the next page of results, or empty if there are no
more results in the list.
 * @property {dialogflow(v2beta1).SessionEntityType[]} sessionEntityTypes The list of session entity types. There will be a maximum number of items
returned based on the page_size field in the request.
 */
/**
 * @typedef Operation
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {object} payload Optional. This field is set to the value of `QueryParameters.payload` field
passed in the request.
 * @property {string} source The source of this request, e.g., `google`, `facebook`, `slack`. It is set
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).Context[]} contexts Optional. The collection of contexts to be activated before this query is
executed.
 * @property {dialogflow(v2beta1).LatLng} geoLocation Optional. The geo location of this conversational query.
 * @property {object} payload Optional. This field can be used to pass custom data into the webhook
associated with the agent. Arbitrary JSON objects are supported.
 * @property {boolean} resetContexts Optional. Specifies whether to delete all contexts in the current session
before the new ones are activated.
 * @property {dialogflow(v2beta1).SessionEntityType[]} sessionEntityTypes Optional. The collection of session entity types to replace or extend
developer entities with for this query only. The entity synonyms apply
to all languages.
 * @property {string} timeZone Optional. The time zone of this conversational query from the
[time zone database](https://www.iana.org/time-zones), e.g.,
 ...
 * @property {boolean} allRequiredParamsPresent This field is set to:
- `false` if the matched intent has required parameters and not all of
   the required parameter values have been collected.
- `true` if all required parameter values have been collected, or if the
   matched intent doesn&#39;t contain any required parameters.
 * @property {object} diagnosticInfo The free-form diagnostic info. For example, this field
 ...
 * @property {dialogflow(v2beta1).Intent} intent The intent that matched the conversational query. Some, not
all fields are filled in this message, including but not limited to:
`name`, `display_name` and `webhook_state`.
 * @property {number} intentDetectionConfidence The intent detection confidence. Values range from 0.0
(completely uncertain) to 1.0 (completely certain).
 * @property {string} languageCode The language that was triggered during intent detection.
See [Language Support](https://dialogflow.com/docs/reference/language)
for a list of the currently supported language codes.
 * @property {dialogflow(v2beta1).Context[]} outputContexts The collection of output contexts. If applicable,
`output_contexts.parameters` contains entries with name
`&lt;parameter name&gt;.original` containing the original parameter values
before the query.
 * @property {object} parameters The collection of extracted parameters.
 * @property {string} queryText The original conversational query text:
 ...
 * @property {number} speechRecognitionConfidence The confidence estimate between 0.0 and 1.0. A higher number
indicates an estimated greater likelihood that the recognized words are
correct. The default of 0.0 is a sentinel value indicating that confidence
was not set. This field is populated if natural speech audio was provided
as input.
 * @property {object} webhookPayload If the query was fulfilled by a webhook call, this field is set to the
value of the `payload` field returned in the webhook response.
 * @property {string} webhookSource If the query was fulfilled by a webhook call, this field is set to the
 ...
 * @property {string} agentUri Warning: Restoring agents from a URI is not implemented yet.
This feature is coming soon.
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).Agent[]} agents The list of agents. There will be a maximum number of items returned based
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).EntityTypeEntity[]} entities Required. The collection of entities associated with this session entity
type.
 * @property {string} entityOverrideMode Required. Indicates whether the additional data should override or
supplement the developer entity type definition.
 * @property {string} name Required. The unique identifier of this session entity type. Format:
`projects/&lt;Project ID&gt;/agent/sessions/&lt;Session
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {string} languageCode Required. The language of this conversational query. See [Language
Support](https://dialogflow.com/docs/languages) for a list of the
currently supported language codes. Note that queries in the same session
do not necessarily need to specify the same language.
 * @property {string} text Required. The UTF-8 encoded natural language text to be processed.
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).OriginalDetectIntentRequest} originalDetectIntentRequest Optional. The contents of the original request that was passed to
`[Streaming]DetectIntent` call.
 * @property {dialogflow(v2beta1).QueryResult} queryResult The result of the conversational query or event processing. Contains the
same value as `[Streaming]DetectIntentResponse.query_result`.
 * @property {string} responseId The unique identifier of the response. Contains the same value as
`[Streaming]DetectIntentResponse.response_id`.
 * @property {string} session The unique identifier of detectIntent request session.
 ...
 * @memberOf! dialogflow(v2beta1)
 * @type object
 * @property {dialogflow(v2beta1).EventInput} followupEventInput Optional. Makes the platform immediately invoke another `DetectIntent` call
internally with the specified event as input.
 * @property {dialogflow(v2beta1).IntentMessage[]} fulfillmentMessages Optional. The collection of rich messages to present to the user. This
value is passed directly to `QueryResult.fulfillment_messages`.
 * @property {string} fulfillmentText Optional. The text to be shown on the screen. This value is passed directly
to `QueryResult.fulfillment_text`.
 * @property {dialogflow(v2beta1).Context[]} outputContexts Optional. The collection of output contexts. This value is passed directly
