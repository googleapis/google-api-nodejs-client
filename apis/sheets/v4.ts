...
function Sheets(options) {
  ...
  self.spreadsheets = {
    ...
    , /**
       ...
       * returned. You can include grid data one of two ways:  * Specify a field
       * mask listing your desired fields using the `fields` URL parameter in
       * HTTP  * Set the includeGridData URL parameter to true.  If a field mask
       * is set, the `includeGridData` parameter is ignored  For large
       * spreadsheets, it is recommended to retrieve only the specific fields of
       * the spreadsheet that you want.  To retrieve only subsets of the
       * spreadsheet, use the ranges URL parameter. Multiple ranges can be
 ...
 * @property {boolean} interpolateNulls If some values in a series are missing, gaps may appear in the chart (e.g,
segments of lines in a line chart will be missing).  To eliminate these
gaps set this to true.
Applies to Line, Area, and Combo charts.
 * @property {string} legendPosition The position of the chart legend.
 * @property {boolean} lineSmoothing Gets whether all lines should be rendered smooth or straight by default.
Applies to Line charts.
 * @property {sheets(v4).BasicChartSeries[]} series The data this chart is visualizing.
 * @property {string} stackedType The stacked type for charts that support vertical stacking.
Applies to Area, Bar, Column, and Stepped Area charts.
 * @property {boolean} threeDimensional True to make the chart 3D.
 ...
 * @property {integer} bubbleMaxRadiusSize The max radius size of the bubbles, in pixels.
If specified, the field must be a positive value.
 * @property {integer} bubbleMinRadiusSize The minimum radius size of the bubbles, in pixels.
If specific, the field must be a positive value.
 * @property {number} bubbleOpacity The opacity of the bubbles between 0 and 1.0.
0 is fully transparent and 1 is fully opaque.
 * @property {sheets(v4).ChartData} bubbleSizes The data contianing the bubble sizes.  Bubble sizes are used to draw
the bubbles at different sizes relative to each other.
If specified, group_ids must also be specified.  This field is
optional.
 * @property {sheets(v4).TextFormat} bubbleTextStyle The format of the text inside the bubbles.
Underline and Strikethrough are not supported.
 * @property {sheets(v4).ChartData} domain The data containing the bubble x-values.  These values locate the bubbles
in the chart horizontally.
 * @property {sheets(v4).ChartData} groupIds The data containing the bubble group IDs. All bubbles with the same group
 ...
 * @property {sheets(v4).ChartData} series The data contianing the bubble y-values.  These values locate the bubbles
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {sheets(v4).CandlestickData[]} data The Candlestick chart data.
Only one CandlestickData is supported.
 * @property {sheets(v4).CandlestickDomain} domain The domain data (horizontal axis) for the candlestick chart.  String data
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {sheets(v4).CandlestickSeries} closeSeries The range data (vertical axis) for the close/final value for each candle.
This is the top of the candle body.  If greater than the open value the
candle will be filled.  Otherwise the candle will be hollow.
 * @property {sheets(v4).CandlestickSeries} highSeries The range data (vertical axis) for the high/maximum value for each
candle. This is the top of the candle&#39;s center line.
 * @property {sheets(v4).CandlestickSeries} lowSeries The range data (vertical axis) for the low/minimum value for each candle.
This is the bottom of the candle&#39;s center line.
 * @property {sheets(v4).CandlestickSeries} openSeries The range data (vertical axis) for the open/initial value for each
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {string} altText The alternative text that describes the chart.  This is often used
for accessibility.
 * @property {sheets(v4).Color} backgroundColor The background color of the entire chart.
 ...
 * @property {string} fontName The name of the font to use by default for all chart text (e.g. title,
 ...
 * @property {boolean} maximized True to make a chart fill the entire space in which it&#39;s rendered with
...
For example, if replacing `&quot;e&quot;` with `&quot;o&quot;` in `&quot;Google
Sheets&quot;`, this would be `&quot;3&quot;` because `&quot;Google Sheets&quot;`
-&gt; `&quot;Googlo Shoots&quot;`.
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {number} bucketSize By default the bucket size (the range of values stacked in a single
column) is chosen automatically, but it may be overridden here.
E.g., A bucket size of 1.5 results in buckets from 0 - 1.5, 1.5 - 3.0, etc.
Cannot be negative.
This field is optional.
 * @property {string} legendPosition The position of the chart legend.
 * @property {number} outlierPercentile The outlier percentile is used to ensure that outliers do not adversely
affect the calculation of bucket sizes.  For example, setting an outlier
percentile of 0.05 indicates that the top and bottom 5% of values when
calculating buckets.  The values are still included in the chart, they will
be added to the first or last buckets instead of their own buckets.
Must be between 0.0 and 0.5.
 * @property {sheets(v4).HistogramSeries[]} series The series for a histogram may be either a single series of values to be
bucketed or multiple series, each of the same length, containing the name
of the series followed by the values to be bucketed for that series.
 * @property {boolean} showItemDividers Whether horizontal divider lines should be displayed between items in each
column.
 */
/**
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {sheets(v4).Color} barColor The color of the column representing this series in each bucket.
This field is optional.
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {number} convergenceThreshold When iterative calculation is enabled and successive results differ by
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {sheets(v4).ChartData} labels The data containing the labels for all the nodes in the chart.  Labels
must be unique.
 ...
 * @property {sheets(v4).ChartData} parentLabels The data containing the label of the parent for the corresponding node.
A blank value indicates that the node has no parent and is a top-level
node.
This field is optional.
 * @property {sheets(v4).Color} selectedNodeColor The color of the selected org chart nodes.
 * @property {sheets(v4).ChartData} tooltips The data containing the tooltip for the corresponding node.  A blank value
 ...
 * @memberOf! sheets(v4)
 * @type object
 * @property {integer} angle The angle between the standard orientation and the desired orientation.
Measured in degrees. Valid values are between -90 and 90. Positive
angles are angled upwards, negative are angled downwards.

Note: For LTR text direction positive angles are in the counterclockwise
direction, whereas for RTL they are in the clockwise direction
 * @property {boolean} vertical If true, text reads top to bottom, but the orientation of individual
