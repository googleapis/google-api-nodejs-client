...
function Classroom(options) {
  ...
  self.courses =
      {
        ...
        , /**
           ...
           * mask or if no update mask is supplied. * `FAILED_PRECONDITION` for
        ...
        aliases: {
          ...
          , /**
             ...
             * `NOT_FOUND` if the alias does not exist. * `FAILED_PRECONDITION`
             * if the alias requested does not make sense for the   requesting
             * user or course (for example, if a user not in a domain   attempts
        ...
        announcements: {
          ...
          , /**
             ...
             * error codes:  * `PERMISSION_DENIED` if the requesting user is not
             * permitted to access the requested course or announcement, or for
          ...
          , /**
             ...
             * announcements. Course teachers and domain administrators may view
             * all announcements.  This method returns the following error
             * codes:  * `PERMISSION_DENIED` if the requesting user is not
             * permitted to access the requested course or for access errors. *
          ...
          , /**
             ...
             * call this method.  This method returns the following error codes:
          ...
          , /**
             ...
             * @desc Updates one or more fields of an announcement.  This method
             * returns the following error codes:  * `PERMISSION_DENIED` if the
             * requesting developer project did not create the corresponding
             * announcement or for access errors. * `INVALID_ARGUMENT` if the
             * request is malformed. * `FAILED_PRECONDITION` if the requested
             * announcement has already been deleted. * `NOT_FOUND` if the
        ...
        courseWork:
            {
              ...
              , /**
                 ...
                 * not permitted to access the requested course or course work,
                 * or for access errors. * `INVALID_ARGUMENT` if the request is
                 * malformed. * `NOT_FOUND` if the requested course or course
                 * work does not exist.
              ...
              , /**
                 ...
                 * permitted to view.  Course students may only view `PUBLISHED`
                 * course work. Course teachers and domain administrators may
                 * view all course work.  This method returns the following
                 * error codes:  * `PERMISSION_DENIED` if the requesting user is
                 * not permitted to access the requested course or for access
                 * errors. * `INVALID_ARGUMENT` if the request is malformed. *
                 * `NOT_FOUND` if the requested course does not exist.
              ...
              , /**
                 ...
                 * codes:  * `PERMISSION_DENIED` if the requesting user is not
                 * permitted to access the requested course or course work or
              ...
              , /**
                 ...
                 * may be updated and who may change them.  This request must be
                 ...
                 * make the requested modification to the student submission, or
                 * for access errors. * `INVALID_ARGUMENT` if the request is
                 * malformed. * `FAILED_PRECONDITION` if the requested course
                 * work has already been deleted. * `NOT_FOUND` if the requested
              ...
              studentSubmissions: {
                ...
                , /**
                   ...
                   * is malformed. * `NOT_FOUND` if the requested course, course
                ...
                , /**
                   ...
                   * owns the requested student submission may call this method,
                   * and only for a student submission that has been turned in.
                   * This request must be made by the Developer Console project
                   * of the [OAuth client
                   * ID](https://support.google.com/cloud/answer/6158849) used
                   * to create the corresponding course work item.  This method
                   * returns the following error codes:  * `PERMISSION_DENIED`
                ...
                , /**
                   ...
                   * submission transfers ownership of attached Drive files to
                   * the teacher and may also update the submission state.  This
                   * may only be called by the student that owns the specified
                   * student submission.  This request must be made by the
                   * Developer Console project of the [OAuth client
                   * ID](https://support.google.com/cloud/answer/6158849) used
                   * to create the corresponding course work item.  This method
                   * returns the following error codes:  * `PERMISSION_DENIED`
        ...
        students: {
          ...
          , /**
             ...
             * access errors. * `NOT_FOUND` if no student of this course has the
        ...
        teachers: {
          ...
          , /**
             ...
             * access errors. * `NOT_FOUND` if no teacher of this course has the
             * requested ID or if the course does not exist. *
  ...
  self.invitations = {
    ...
    , /**
       ...
       * codes:  * `PERMISSION_DENIED` if the requesting user is not permitted
       * to view the requested invitation or for access errors. * `NOT_FOUND` if
  ...
  self.userProfiles = {
    ...
    guardianInvitations: {
      ...
      , /**
         ...
         * @desc Returns a list of guardian invitations that the requesting user
         ...
         * to view guardian invitations for that student, if   `"-"` is
         * specified as the `student_id` and the user is not a domain
         * administrator, if guardians are not enabled for the domain in
         * question,   or for other access errors. * `INVALID_ARGUMENT` if a
         * `student_id` is specified, but its format cannot   be recognized (it
         * is not an email address, nor a `student_id` from the   API, nor the
         * literal string `me`). May also be returned if an invalid
         * `page_token` or `state` is provided. * `NOT_FOUND` if a `student_id`
      ...
      , /**
         ...
         * student, or if the `id` field does not   refer to a guardian
    ...
    guardians: {
      ...
      , /**
         ...
         * the student identified by the   `student_id`, if guardians are not
      ...
      , /**
         ...
         * if a `student_id` is specified, and the requesting   user is not
         * permitted to view guardian information for that student, if   `"-"`
         * is specified as the `student_id` and the user is not a domain
         * administrator, if guardians are not enabled for the domain in
         * question,   if the `invited_email_address` filter is set by a user
         * who is not a   domain administrator, or for other access errors. *
         * `INVALID_ARGUMENT` if a `student_id` is specified, but its format
         * cannot   be recognized (it is not an email address, nor a
         * `student_id` from the   API, nor the literal string `me`). May also
         * be returned if an invalid   `page_token` is provided. * `NOT_FOUND`
         * if a `student_id` is specified, and its format can be   recognized,
...
If the `assigneeMode` is `INDIVIDUAL_STUDENTS`, then only students specified in
