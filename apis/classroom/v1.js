...
function Classroom(options) {
  ...
  this.courses = {
     ...
     *
     * @param  {object} params - Parameters for request
     * @param  {string} params.id - Identifier of the course to return. This may either be the Classroom-assigned identifier or an [alias][google.classroom.v1.CourseAlias].
     * @param  {callback} callback - The callback that handles the response.
     * @return {object} Request object
     */
     ...
     *
     * @param  {object} params - Parameters for request
     * @param  {string} params.id - Identifier of the course to update. This may either be the Classroom-assigned identifier or an [alias][google.classroom.v1.CourseAlias].
     * @param  {object} params.resource - Request body data
     * @param  {callback} callback - The callback that handles the response.
     * @return {object} Request object
     */
     ...
     *
     * @param  {object} params - Parameters for request
     * @param  {string} params.id - Identifier of the course to delete. This may either be the Classroom-assigned identifier or an [alias][google.classroom.v1.CourseAlias].
     * @param  {callback} callback - The callback that handles the response.
     * @return {object} Request object
     */
    ...
    aliases: {
       ...
       *
       * @param  {object} params - Parameters for request
       * @param  {string} params.courseId - The identifier of the course to alias. This may either be the Classroom-assigned identifier or an [alias][google.classroom.v1.CourseAlias].
       * @param  {object} params.resource - Request body data
       * @param  {callback} callback - The callback that handles the response.
       * @return {object} Request object
       */
       ...
       *
       * @param  {object} params - Parameters for request
       * @param  {string} params.courseId - The identifier of the course whose alias should be deleted. This may either be the Classroom-assigned identifier or an [alias][google.classroom.v1.CourseAlias].
       ...
       *
       * @param  {object} params - Parameters for request
       * @param  {string} params.courseId - The identifier of the course. This may either be the Classroom-assigned identifier or an [alias][google.classroom.v1.CourseAlias].
       * @param  {integer=} params.pageSize - Maximum number of items to return. Zero or unspecified indicates that the server may assign a maximum. The server may return fewer than the specified number of results.
    ...
    students: {
       ...
       * @param  {string=} params.enrollmentCode - Enrollment code of the course to create the student in. This is required if [userId][google.classroom.v1.Student.user_id] corresponds to the requesting user; this may be omitted if the requesting user has administrative permissions to create students for any user.
       * @param  {object} params.resource - Request body data
       * @param  {callback} callback - The callback that handles the response.
       * @return {object} Request object
       */
  ...
  this.invitations = {
     ...
     *
     * @desc Returns a invitation. This method returns the following error codes: * `PERMISSION_DENIED` if the requesting user is not permitted to view the requested invitation. * `NOT_FOUND` if no invitation exists with the requested ID.
     *
     ...
     *
     * @desc Deletes a invitation. This method returns the following error codes: * `PERMISSION_DENIED` if the requesting user is not permitted to delete the requested invitation. * `NOT_FOUND` if no invitation exists with the requested ID.
     *
     ...
     *
     * @desc Returns a list of invitations that the requesting user is permitted to view, restricted to those that match the request. *Note:* At least one of `user_id` or `course_id` must be supplied.
     *
     * @alias classroom.invitations.list
     * @memberOf! classroom(v1)
     *
     * @param  {object=} params - Parameters for request
     * @param  {string=} params.userId - Restricts returned invitations to those for a specific user. This may be the unique identifier for the user or an alias. The supported aliases are: * the e-mail address of the user * the string literal `"me"`, indicating the requesting user
     * @param  {string=} params.courseId - Restricts returned invitations to those for a course with the specified identifier.
     * @param  {integer=} params.pageSize - The maximum number of items to return. Zero means no maximum. The server may return fewer than the specified number of results.
     * @param  {string=} params.pageToken - [nextPageToken][google.classroom.v1.ListInvitationsRespnse.next_page_token] value returned from a previous [list][google.classroom.v1.Users.ListInvitations] call, indicating that the subsequent page of results should be returned. The [list][google.classroom.v1.Users.ListInvitations] request must be identical to the one which resulted in this token.
     * @param  {callback} callback - The callback that handles the response.
     * @return {object} Request object
     */
    list: function(params, callback) {
