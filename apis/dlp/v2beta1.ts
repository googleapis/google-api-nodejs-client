 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} relativeFrequency The relative frequency column must contain a floating-point number
...
ZIP code or credit card number. String must have length 1. If not supplied, we
...
`reverse_order` is true, then 12345 -&gt; 12***
 */
/**
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1EntityId} entityId Optional message indicating that each distinct entity_id should not
...
associated to quasi-identifier &quot;foo&quot;, ID 2 to &quot;bar&quot;, and ID
3 to *both* quasi-identifiers &quot;foo&quot; and &quot;bar&quot; (on separate
rows), and where this ID is used as entity_id. Then, the anonymity value
associated to ID 3 will be 2, even if it is the only ID to be associated to both
values &quot;foo&quot; and &quot;bar&quot;.
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1AuxiliaryTable[]} auxiliaryTables Several auxiliary tables can be used in the analysis. Each custom_tag
used to tag a quasi-identifiers column must appear in exactly one column
of one auxiliary table.
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1TaggedField[]} quasiIds Fields considered to be quasi-identifiers. No two columns can have the
same tag. [required]
 * @property {string} regionCode ISO 3166-1 alpha-2 region code to use in the statistical modeling.
 ...
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1KMapEstimationQuasiIdValues[]} bucketValues Sample of quasi-identifier tuple values in this bucket. The total
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1KMapEstimationHistogramBucket[]} kMapEstimationHistogram The intervals [min_anonymity, max_anonymity] do not overlap. If a value
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {string} customTag A column can be tagged with a custom tag. In this case, the user must
indicate an auxiliary table that contains statistical information on
the possible values of this column (below).
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1FieldId} field Identifies the column. [required]
 * @property {dlp(v2beta1).GoogleProtobufEmpty} inferred If no semantic tag is indicated, we infer the statistical model from
the distribution of values in the input data
 * @property {dlp(v2beta1).GooglePrivacyDlpV2beta1InfoType} infoType A column can be tagged with a InfoType to use the relevant public
