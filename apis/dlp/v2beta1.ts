 ...
 * @memberOf! dlp(v2beta1)
 * @type object
* @property {dlp(v2beta1).InspectResult[]} results Each content_item from the request has a result in this list, in the
 ...
 * @memberOf! dlp(v2beta1)
 * @type object
 * @property {dlp(v2beta1).CloudStoragePath} storagePath The path to a Google Cloud Storage location to store output.
 */
/**
