...
function People(options) {
  ...
  self.people = {
    ...
    , /**
       ...
       * indicate the authenticated user. <br> The request throws a 400 error if
    ...
    , /**
       ...
       * if `updatePersonFields` is not specified. <br> The request throws a 400
       * error if `person.metadata.sources` is not specified for the contact to
       * be updated. <br> The request throws a 412 error if
