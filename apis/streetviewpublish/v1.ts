...
function Streetviewpublish(options) {
  ...
  self.photo = {
    ...
    , /**
       ...
       * `updateMask` is not present, the update applies to all fields.  <aside
       * class="note"><b>Note:</b> To update Pose.altitude, Pose.latLngPair has
       * to be filled as well. Otherwise, the request will fail.</aside>  This
  ...
  self.photos = {
    ...
    , /**
       ...
       * BatchUpdatePhotosResponse.results. See UpdatePhoto for specific
       ...
       * applies to all fields.  <aside class="note"><b>Note:</b> To update
       * Pose.altitude, Pose.latLngPair has to be filled as well. Otherwise, the
       * request will fail.</aside>
