  ...
  self.accounts = {
    products: {
      ...
      , /**
         ...
         * it is possible to overwrite an existing valid product with an invalid
         * product. To detect this, you should retrieve the product and check it
         * for issues once the updated version is available.  Inserted or
         * updated products first need to be processed before they can be
