      ...
      filteredBids: {
        ...
        creatives: {
          ...
          details: {
             ...
             * @param {string} params.accountId Account ID of the buyer.
             * @param {string} params.filterSetId The ID of the filter set to apply.
             * @param {string=} params.pageToken A token identifying a page of results the server should return. Typically, this is the value of ListCreativeStatusAndCreativeBreakdownByDetailResponse.nextPageToken returned from the previous call to the accounts.filterSets.filteredBids.creatives.details.list method.
             * @param {integer=} params.pageSize Requested page size. The server may return fewer results than requested. If unspecified, the server will pick an appropriate default.
            ...
            list: function (params, options, callback) {
              ...
              const parameters = {
                options: Object.assign({
                  url: (rootUrl + '/v2beta1/accounts/{accountId}/filterSets/{filterSetId}/filteredBids/{creativeStatusId}/creatives/{creativeId}/details').replace(/([^:]\/)\/+/g, '$1'),
                  method: 'GET'
                }, options),
                params: params,
                requiredParams: ['accountId', 'filterSetId', 'creativeStatusId', 'creativeId'],
                pathParams: ['creativeStatusId', 'accountId', 'filterSetId', 'creativeId'],
                context: self
              };
 ...
 */
/**
 * @typedef ListCreativeStatusAndCreativeBreakdownByDetailResponse
 * @memberOf! adexchangebuyer2(v2beta1)
 * @type object
* @property {adexchangebuyer2(v2beta1).FilteredBidDetailRow[]} filteredBidDetailRows List of rows, with counts of bids with a given creative status and
