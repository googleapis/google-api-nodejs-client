...
function Customsearch(options) { // eslint-disable-line
  ...
  self.cse = {
    ...
    siterestrict: {
       ...
       *
       * @desc (Closed Beta API) Returns metadata about the search performed, metadata about the custom search engine used for the search, and the search results only for site-restrict cses.
       *
