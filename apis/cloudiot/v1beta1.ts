...
to Cloud Pub/Sub. &#39;last_error_time&#39; is the timestamp of this field. If
no errors are present, this will have an empty message (whose status code is 0
== OK), otherwise this field is expected to have a not-OK status code.
