  ...
  self.services = {
    ...
    tenancyUnits: {
      ...
      , /**
         ...
         * @desc Delete tenancy unit.  Before the tenancy unit is deleted, there
         * should be no tenant resource in it. Operation<response: Empty>.
      ...
      , /**
         ...
         * resource tag. It will remove project lien with 'TenantManager' origin
         * if that was added. It will then attempt to delete the project. If
         * that operation fails, this method fails. Operation<response: Empty>.
...
&quot;create&quot;, but for backwards compatibility with apiary, it is specified
as insert.
