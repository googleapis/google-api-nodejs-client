...
function Appengine(options) { // eslint-disable-line
  ...
  self.apps = {
    ...
    get: function (params, options, callback) {
      ...
      var parameters = {
        options: utils.extend({
          url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}',
          method: 'GET'
        }, options),
        params: params,
     ...
     * @param {appengine(v1alpha).Application} params.resource Request body data
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
    ...
    create: function (params, options, callback) {
      ...
      var parameters = {
        options: utils.extend({
          url: 'https://appengine.googleapis.com/v1alpha/apps',
          method: 'POST'
        }, options),
        params: params,
        requiredParams: [],
     ...
     * @param {appengine(v1alpha).RepairApplicationRequest} params.resource Request body data
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
    repair: function (params, options, callback) {
      ...
      var parameters = {
        options: utils.extend({
          url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}:repair',
          method: 'POST'
        }, options),
        params: params,
        requiredParams: ['appsId'],
    ...
    services: {
      ...
      delete: function (params, options, callback) {
        ...
        var parameters = {
          options: utils.extend({
            url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services/{servicesId}',
            method: 'DELETE'
          }, options),
          params: params,
      ...
      list: function (params, options, callback) {
        ...
        var parameters = {
          options: utils.extend({
            url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services',
            method: 'GET'
          }, options),
          params: params,
          requiredParams: ['appsId'],
       ...
       * @param {string=} params.updateMask Standard field mask for the set of fields to be updated.
       * @param {string} params.servicesId Part of `name`. See documentation of `appsId`.
       * @param {appengine(v1alpha).Service} params.resource Request body data
       * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
       * @param {callback} callback The callback that handles the response.
       * @return {object} Request object
       */
      ...
      versions: {
        ...
        list: function (params, options, callback) {
          ...
          var parameters = {
            options: utils.extend({
              url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services/{servicesId}/versions',
              method: 'GET'
            }, options),
            params: params,
            requiredParams: ['appsId', 'servicesId'],
        ...
        get: function (params, options, callback) {
          ...
          var parameters = {
            options: utils.extend({
              url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}',
              method: 'GET'
            }, options),
            params: params,
         ...
         *
         * @desc Updates the specified Version resource. You can specify the following fields depending on the App Engine environment and type of scaling that the version resource uses: serving_status (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.serving_status):  For Version resources that use basic scaling, manual scaling, or run in  the App Engine flexible environment. instance_class (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.instance_class):  For Version resources that run in the App Engine standard environment. automatic_scaling.min_idle_instances (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine standard environment. automatic_scaling.max_idle_instances (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1alpha/apps.services.versions#Version.FIELDS.automatic_scaling):  For Version resources that use automatic scaling and run in the App  Engine standard environment.
         *
         ...
         * @param {string} params.versionsId Part of `name`. See documentation of `appsId`.
         * @param {appengine(v1alpha).Version} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
        ...
        instances: {
          ...
          delete: function (params, options, callback) {
            ...
            var parameters = {
              options: utils.extend({
                url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}',
                method: 'DELETE'
              }, options),
              params: params,
          ...
          list: function (params, options, callback) {
            ...
            var parameters = {
              options: utils.extend({
                url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances',
                method: 'GET'
              }, options),
              params: params,
              requiredParams: ['appsId', 'servicesId', 'versionsId'],
           ...
           * @param {string} params.versionsId Part of `name`. See documentation of `appsId`.
           * @param {string} params.servicesId Part of `name`. See documentation of `appsId`.
           * @param {appengine(v1alpha).DebugInstanceRequest} params.resource Request body data
           * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
           * @param {callback} callback The callback that handles the response.
           * @return {object} Request object
           */
          debug: function (params, options, callback) {
            ...
            var parameters = {
              options: utils.extend({
                url: 'https://appengine.googleapis.com/v1alpha/apps/{appsId}/services/{servicesId}/versions/{versionsId}/instances/{instancesId}:debug',
                method: 'POST'
              }, options),
              params: params,
              requiredParams: ['appsId', 'servicesId', 'versionsId', 'instancesId'],
 ...
 * @property {integer} healthyThreshold Number of consecutive successful checks required before receiving traffic.
 * @property {string} checkInterval Interval between health checks.
 * @property {string} timeout Time before the check is considered failed.
 * @property {integer} unhealthyThreshold Number of consecutive failed checks required before removing traffic.
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
* @property {appengine(v1alpha).Library[]} libraries Configuration for third-party Python runtime libraries that are required by the application.Only returned in GET requests if view=FULL is set.
...
* @property {appengine(v1alpha).BasicScaling} basicScaling A service with basic scaling will create an instance when the application receives a request. The instance will be turned down when the app becomes idle. Basic scaling is ideal for work that is intermittent or driven by user activity.
...
* @property {appengine(v1alpha).LivenessCheck} livenessCheck Configures liveness health checking for VM instances. Unhealthy instances are stopped and replaced with new instancesOnly returned in GET requests if view=FULL is set.
* @property {appengine(v1alpha).Network} network Extra network settings. Only applicable for VM runtimes.
...
* @property {appengine(v1alpha).UrlMap[]} handlers An ordered list of URL-matching patterns that should be applied to incoming requests. The first matching URL handles the request and other request handlers are not attempted.Only returned in GET requests if view=FULL is set.
* @property {appengine(v1alpha).AutomaticScaling} automaticScaling Automatic scaling is based on request rate, response latencies, and other application metrics.
...
* @property {appengine(v1alpha).HealthCheck} healthCheck Configures health checking for VM instances. Unhealthy instances are stopped and replaced with new instances. Only applicable for VM runtimes.Only returned in GET requests if view=FULL is set.
* @property {boolean} threadsafe Whether multiple requests can be dispatched to this version at once.
* @property {appengine(v1alpha).ReadinessCheck} readinessCheck Configures readiness health checking for VM instances. Unhealthy instances are not put into the backend traffic rotation.Only returned in GET requests if view=FULL is set.
* @property {appengine(v1alpha).ManualScaling} manualScaling A service with manual scaling runs continuously, allowing you to perform complex initialization and rely on the state of its memory over time.
...
* @property {appengine(v1alpha).ApiConfigHandler} apiConfig Serving configuration for Google Cloud Endpoints (https://cloud.google.com/appengine/docs/python/endpoints/).Only returned in GET requests if view=FULL is set.
* @property {appengine(v1alpha).EndpointsApiService} endpointsApiService Cloud Endpoints configuration.If endpoints_api_service is set, the Cloud Endpoints Extensible Service Proxy will be provided to serve the API implemented by the app.
...
* @property {appengine(v1alpha).Deployment} deployment Code and application artifacts that make up this version.Only returned in GET requests if view=FULL is set.
* @property {string} createTime Time that this version was created.@OutputOnly
* @property {appengine(v1alpha).Resources} resources Machine resources for this version. Only applicable for VM runtimes.
...
* @property {appengine(v1alpha).ErrorHandler[]} errorHandlers Custom static error pages. Limited to 10KB per page.Only returned in GET requests if view=FULL is set.
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).Service[]} services The services belonging to the requested application.
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).Volume[]} volumes User specified volumes.
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).ZipInfo} zip The zip file for this deployment, if this is a zip deployment.
 * @property {appengine(v1alpha).ContainerInfo} container The Docker image for the container that runs the version. Only applicable for instances running in the App Engine flexible environment.
 ...
 * @type object
 * @property {string} nextPageToken Continuation token for fetching the next page of results.
 * @property {appengine(v1alpha).Instance[]} instances The instances belonging to the requested version.
 */
/**
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).Version[]} versions The versions belonging to the requested service.
 * @property {string} nextPageToken Continuation token for fetching the next page of results.
 */
/**
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).DiskUtilization} diskUtilization Target scaling by disk usage.
 ...
 * @property {appengine(v1alpha).RequestUtilization} requestUtilization Target scaling by request utilization.
 ...
 * @property {appengine(v1alpha).NetworkUtilization} networkUtilization Target scaling by network usage.
 ...
 * @property {appengine(v1alpha).CpuUtilization} cpuUtilization Target scaling by CPU usage.
 */
/**
 * @typedef ZipInfo
 * @memberOf! appengine(v1alpha)
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).StaticFilesHandler} staticFiles Returns the contents of a file, such as an image, as the response.
 ...
 * @property {appengine(v1alpha).ScriptHandler} script Executes a script to handle the request that matches this URL pattern.
 ...
 * @property {appengine(v1alpha).ApiEndpointHandler} apiEndpoint Uses API Endpoints to handle requests.
 */
/**
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {appengine(v1alpha).TrafficSplit} split Mapping that defines fractional HTTP traffic diversion to different versions within the service.
 ...
 * @property {appengine(v1alpha).UrlDispatchRule[]} dispatchRules HTTP path dispatch rules for requests to the application that do not explicitly target a service or version. Rules are order-dependent.@OutputOnly
 ...
 * @property {appengine(v1alpha).IdentityAwareProxy} iap 
 ...
 * @memberOf! appengine(v1alpha)
 * @type object
 * @property {integer} healthyThreshold Number of consecutive successful checks required before considering the VM healthy.
 * @property {string} checkInterval Interval between health checks.
 * @property {string} timeout Time before the check is considered failed.
 * @property {string} initialDelay The initial delay before starting to execute the checks.
 * @property {integer} unhealthyThreshold Number of consecutive failed checks required before considering the VM unhealthy.
 * @property {string} path The request path.
