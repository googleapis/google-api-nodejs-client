 ...
 * var adsense = google.adsense('v1.2');
 *
 * @namespace adsense
 * @type {Function}
 * @version v1.2
 ...
 * @property {adsense(v1.2).Account[]} subAccounts Sub accounts of the this account.
 */
/**
 * @typedef Accounts
 * @memberOf! adsense(v1.2)
 ...
 * @property {adsense(v1.2).Account[]} items The accounts returned in this list response.
 ...
 * @type object
 * @property {string} etag ETag of this response for caching purposes.
 * @property {adsense(v1.2).AdClient[]} items The ad clients returned in this list response.
...
* @property {adsense(v1.2).AdStyle} customStyle Custom style information specific to this ad unit.
 ...
 * @type object
 * @property {string} etag ETag of this response for caching purposes.
 * @property {adsense(v1.2).AdUnit[]} items The ad units returned in this list response.
 ...
 * @type object
 * @property {string} etag ETag of this response for caching purposes.
 * @property {adsense(v1.2).CustomChannel[]} items The custom channels returned in this list response.
 ...
 * @memberOf! adsense(v1.2)
 * @type object
 * @property {adsense(v1.2).AdStyle} adStyle The AdStyle itself.
 ...
 * @type object
 * @property {string} etag ETag of this response for caching purposes.
 * @property {adsense(v1.2).SavedAdStyle[]} items The saved ad styles returned in this list response.
 ...
 * @type object
 * @property {string} etag ETag of this response for caching purposes.
 * @property {adsense(v1.2).SavedReport[]} items The saved reports returned in this list response.
 ...
 * @type object
 * @property {string} etag ETag of this response for caching purposes.
 * @property {adsense(v1.2).UrlChannel[]} items The URL channels returned in this list response.
