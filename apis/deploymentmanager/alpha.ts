...
* @property {deploymentmanager(alpha).DeploymentOutputsEntry[]} outputs api-linter: output-only-format=disabled [Output Only] Map of outputs from the last manifest that deployed successfully.
