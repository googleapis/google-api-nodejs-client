 ...
 * @property {deploymentmanager(v2beta).LogConfigDataAccessOptions} dataAccess Data access options.
 */
 ...
 * @memberOf! deploymentmanager(v2beta)
 * @type object
 * @property {deploymentmanager(v2beta).AuthorizationLoggingOptions} authorizationLoggingOptions Information used by the Cloud Audit Logging pipeline.
