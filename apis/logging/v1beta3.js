  ...
  this.projects = {
    ...
    logServices: {
      ...
      indexes: {
         ...
         *
         * @param  {object} params - Parameters for request
         * @param  {string} params.projectsId - Part of `serviceName`. A log service resource of the form `/projects//logServices
        /*`. The service indexes of the log service are returned. Example: `"/projects/myProj/logServices/appengine.googleapis.com"`.
