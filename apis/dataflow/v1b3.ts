              ...
              jobs: {
                ...
                workItems: {
                  ...
                  , /**
                     ...
                     * @desc Reports the status of dataflow WorkItems leased by
                     * a worker.
                     * @alias
                     * dataflow.projects.locations.jobs.workItems.reportStatus
                     * @memberOf! dataflow(v1b3)
...
records. An input that can be read in parallel down to the individual records is
called &quot;perfectly splittable&quot;. An example of non-perfectly
parallelizable input is a block-compressed file format where a block of records
has to be read as a whole, but different blocks can be read in parallel.
...
&quot;And&quot;, and &quot;Or&quot;.  The possible value types are Long, Double,
and Boolean.
...
in this case. If this is SPLITTING_HAPPENED, then &quot;bundles&quot; contains a
 ...
 * @property {string} windmillServiceEndpoint If present, the worker must use this endpoint to communicate with Windmill
Service dispatchers, otherwise the worker must continue to use whatever
endpoint it had been using.
 * @property {string} windmillServicePort If present, the worker must use this port to communicate with Windmill
