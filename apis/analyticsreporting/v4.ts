...
Dimension values that fall in a bucket get transformed to a new dimension value.
For example, if one gives a list of &quot;0, 1, 3, 4, 7&quot;, then we return
...
&quot;Chrome&quot;, etc. The ordering of the groups of columns is determined by
...
respectively, the order of columns would be Chrome, Firefox, IE.
