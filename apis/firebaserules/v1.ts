  ...
  self.projects =
      {
        ...
        releases: {
          ...
          , /**
             ...
             * @desc Update a `Release`.  Only updates to the `ruleset_name` and
        ...
        rulesets:
            {
               ...
               * @desc Create a `Ruleset` from `Source`.  The `Ruleset` is given
               * a unique generated name which is returned to the caller.
               * `Source` containing syntactic or semantics errors will result
               * in an error response indicating the first error encountered.
               * For a detailed view of `Source` issues, use TestRuleset.
              ...
              , /**
                 ...
                 * @desc Delete a `Ruleset` by resource name.  If the `Ruleset`
                 * is referenced by a `Release` the operation will fail.
              ...
              , /**
                 ...
                 * @desc Get a `Ruleset` by name including the full `Source`
                 * contents.
              ...
              , /**
                 ...
                 * @desc List `Ruleset` metadata only and optionally filter the
                 * results by `Ruleset` name.  The full `Source` contents of a
                 * `Ruleset` may be retrieved with GetRuleset.
