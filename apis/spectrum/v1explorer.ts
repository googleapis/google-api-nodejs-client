...
space (not a geodesic curve). Consequently, the length between two adjacent
...
spectrum batch request, but the database may restrict the number of locations it
supports by returning a response with fewer locations than specified in the
