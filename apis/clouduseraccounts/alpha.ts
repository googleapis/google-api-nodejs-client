        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/operations/{operation}')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'DELETE'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/operations')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/groups/{groupName}/addMember')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/groups/{groupName}')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'DELETE'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/groups/{resource}/getIamPolicy')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
    ...
    insert: function(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl +
                    '/clouduseraccounts/alpha/projects/{project}/global/groups')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/groups/{groupName}/removeMember')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/groups/{resource}/setIamPolicy')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/groups/{resource}/testIamPermissions')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/zones/{zone}/authorizedKeysView/{user}')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/zones/{zone}/linuxAccountViews')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/users/{user}/addPublicKey')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/users/{user}')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'DELETE'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/users/{resource}/getIamPolicy')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
    ...
    insert: function(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl +
                    '/clouduseraccounts/alpha/projects/{project}/global/users')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/users/{user}/removePublicKey')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/users/{resource}/setIamPolicy')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        ...
        options: Object.assign(
            {
              url:
                  (rootUrl +
                   '/clouduseraccounts/alpha/projects/{project}/global/users/{resource}/testIamPermissions')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
