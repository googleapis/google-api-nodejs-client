...
function Ml(options) {
  ...
  self.projects = {
    ...
    , /**
       * ml.projects.predict
       * @desc Performs prediction on the data in the request.  **** REMOVE FROM
    ...
    models: {
      ...
      versions: {
        ...
        , /**
           ...
           * @desc Gets basic information about all the versions of a model.  If
           * you expect that a model has a lot of versions, or if you need to
           * handle only a limited number of results at a time, you can request
           * that the list be retrieved in batches (called pages):
        ...
        , /**
           ...
           * make any subsequent changes to the default version setting manually
           * using this method.
...
&lt;a href=&quot;/ml-engine/docs/how-tos/resource-labels&quot;&gt;using
labels&lt;/a&gt;.
...
suppresswarning=&quot;true&quot;&gt;standard&lt;/code&gt; that also includes a
single NVIDIA Tesla K80 GPU. See more about &lt;a
href=&quot;/ml-engine/docs/how-tos/using-gpus&quot;&gt; using GPUs for training
your model&lt;/a&gt;. &lt;/dd&gt; &lt;dt&gt;complex_model_m_gpu&lt;/dt&gt;
  &lt;dd&gt;
  A machine equivalent to
  &lt;code suppresswarning=&quot;true&quot;&gt;complex_model_m&lt;/code&gt; that
also includes four NVIDIA Tesla K80 GPUs. &lt;/dd&gt;
  &lt;dt&gt;complex_model_l_gpu&lt;/dt&gt;
  &lt;dd&gt;
  A machine equivalent to
  &lt;code suppresswarning=&quot;true&quot;&gt;complex_model_l&lt;/code&gt; that
also includes eight NVIDIA Tesla K80 GPUs. &lt;/dd&gt;
  &lt;dt&gt;standard_p100&lt;/dt&gt;
  &lt;dd&gt;
  A machine equivalent to &lt;code
suppresswarning=&quot;true&quot;&gt;standard&lt;/code&gt; that also includes a
single NVIDIA Tesla P100 GPU. The availability of these GPUs is in the Alpha
launch stage. &lt;/dd&gt; &lt;dt&gt;complex_model_m_p100&lt;/dt&gt; &lt;dd&gt;
  A machine equivalent to
  &lt;code suppresswarning=&quot;true&quot;&gt;complex_model_m&lt;/code&gt; that
also includes four NVIDIA Tesla P100 GPUs. The availability of these GPUs is in
