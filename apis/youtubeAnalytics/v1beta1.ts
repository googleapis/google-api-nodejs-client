...
function Youtubeanalytics(options) { // eslint-disable-line
    ...
    delete: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/youtube/analytics/v1beta1/groupItems').replace(/([^:]\/)\/+/g, '$1'),
          method: 'DELETE'
        }, options),
        params: params,
        requiredParams: ['id'],
  ...
  self.groups = {
    ...
    delete: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/youtube/analytics/v1beta1/groups').replace(/([^:]\/)\/+/g, '$1'),
          method: 'DELETE'
        }, options),
        params: params,
        requiredParams: ['id'],
  ...
  self.reports = {
    ...
    query: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/youtube/analytics/v1beta1/reports').replace(/([^:]\/)\/+/g, '$1'),
          method: 'GET'
        }, options),
        params: params,
