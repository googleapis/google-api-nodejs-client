 ...
 * @memberOf! youtubeAnalytics(v1)
 * @type object
 * @property {youtubeAnalytics(v1).BatchReportDefinition[]} items A list of batchReportDefinition resources that match the request criteria.
 ...
 * @memberOf! youtubeAnalytics(v1)
 * @type object
 * @property {youtubeAnalytics(v1).BatchReport[]} items A list of batchReport resources that match the request criteria.
