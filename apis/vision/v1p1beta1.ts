...
* @property {vision(v1p1beta1).Status} error If set, represents the error message for the operation.
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1TextAnnotation} fullTextAnnotation If present, text (OCR) detection or document (OCR) text detection has
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} boundingBox The bounding box for the block.
 ...
 * @memberOf! vision(v1p1beta1)
 * @type object
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} boundingPoly The bounding polygon for the crop region. The coordinates of the bounding
 ...
 * @memberOf! vision(v1p1beta1)
 * @type object
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} boundingPoly Image region to which this entity belongs. Not produced
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1LocationInfo[]} locations The location information for the detected entity. Multiple
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1Property[]} properties Some entities may have optional user-supplied `Property` (name/value)
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} boundingPoly The bounding polygon around the face. The coordinates of the bounding box
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} fdBoundingPoly The `fd_bounding_poly` bounding polygon is tighter than the
...
* @property {string} model Model to use for the feature.
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1ImageSource} source Google Cloud Storage image location. If both `content` and `source`
...
* @property {string} racy Likelihood that the request image contains racy content. Racy content may
 ...
 * @memberOf! vision(v1p1beta1)
 * @type object
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} boundingBox The bounding box for the symbol.
The vertices are in the order of top-left, top-right, bottom-right,
bottom-left. When a rotation of the bounding box is detected the rotation
is represented as around the top-left corner as defined when the text is
read in the &#39;natural&#39; orientation.
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1WebDetectionWebImage[]} fullMatchingImages Fully matching images from the Internet.
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1WebDetectionWebImage[]} partialMatchingImages Partial matching images from the Internet.
...
* @property {string} languageCode The BCP-47 language code for `label`, such as &quot;en-US&quot; or &quot;sr-Latn&quot;.
 ...
 * @memberOf! vision(v1p1beta1)
 * @type object
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1WebDetectionWebImage[]} fullMatchingImages Fully matching images on the page.
Can include resized copies of the query image.
* @property {string} pageTitle Title for the web page, may contain HTML markups.
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1WebDetectionWebImage[]} partialMatchingImages Partial matching images on the page.
Those images are similar enough to share some key-point features. For
 ...
 * @memberOf! vision(v1p1beta1)
 * @type object
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1BoundingPoly} boundingBox The bounding box for the word.
The vertices are in the order of top-left, top-right, bottom-right,
bottom-left. When a rotation of the bounding box is detected the rotation
is represented as around the top-left corner as defined when the text is
read in the &#39;natural&#39; orientation.
...
* @property {vision(v1p1beta1).GoogleCloudVisionV1p1beta1Symbol[]} symbols List of symbols in the word.
