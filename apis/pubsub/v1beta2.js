...
function Pubsub(options) {
  ...
  this.projects = {
    ...
    topics: {
       ...
       * @param  {string} params.resource - REQUIRED: The resource for which policy is being specified. Usually some path like projects/{project}/zones/{zone}/disks/{disk}.
       ...
       *
       * @param  {object} params - Parameters for request
       * @param  {string} params.resource - REQUIRED: The resource for which policy is being requested. Usually some path like projects/{project}.
       * @param  {callback} callback - The callback that handles the response.
       * @return {object} Request object
       */
       ...
       *
       * @param  {object} params - Parameters for request
       * @param  {string} params.resource - REQUIRED: The resource for which policy detail is being requested. Usually some path like projects/{project}.
       * @param  {object} params.resource - Request body data
       * @param  {callback} callback - The callback that handles the response.
       * @return {object} Request object
       */
