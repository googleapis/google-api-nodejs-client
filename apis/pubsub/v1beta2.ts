  ...
  self.projects = {
    subscriptions: {
      ...
      , /**
         ...
         * by the subscriber, or to make the message available for redelivery if
         * the processing was interrupted. Note that this does not modify the
      ...
      , /**
         ...
         * may be used to change a push subscription to a pull one (signified by
