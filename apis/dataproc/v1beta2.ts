          ...
          workflowTemplates:
              {
                ...
                , /**
                   ...
                   * always be
                   * google.cloud.dataproc.v1beta2.WorkflowMetadata.The
                   * google.cloud.dataproc.v1beta2.Operation.result will always
...
with or without a Google account. allAuthenticatedUsers: A special identifier
that represents anyone  who is authenticated with a Google account or a service
account. user:{emailid}: An email address that represents a specific Google
account. For example, alice@gmail.com or joe@example.com.
serviceAccount:{emailid}: An email address that represents a service  account.
For example, my-other-app@appspot.gserviceaccount.com. group:{emailid}: An email
...
http://metadata/computeMetadata/v1beta2/instance/attributes/dataproc-role) if [[
&quot;${ROLE}&quot; == &#39;Master&#39; ]]; then
...
following defaults are also provided: https://www.googleapis.com/auth/bigquery
