...
function Servicemanagement(options) {
  ...
  self.services = {
    ...
    , /**
       ...
       * the service using the configuration at the time the service was
       * deleted. The target service must exist and must have been deleted
...
will have the form of &lt;date&gt;&lt;revision number&gt;, where
&quot;date&quot; is the create date in ISO 8601 format.  &quot;revision
number&quot; is a monotonically increasing positive number that is reset every
day for each service. An example of the generated rollout_id is
&#39;2016-02-16r1&#39;
