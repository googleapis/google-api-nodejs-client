                ...
                nodePools: {
                  ...
                  setManagement(params, options, callback) {
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * @desc Updates the version and/or iamge type of a
                      * specific node pool.
                      * @alias
                      * container.projects.zones.clusters.nodePools.update
                      * @memberOf! container(v1beta1)
 ...
 * @memberOf! container(v1beta1)
 * @type object
 * @property {container(v1beta1).HorizontalPodAutoscaling} horizontalPodAutoscaling Configuration for the horizontal pod autoscaling feature, which increases or decreases the number of replica pods a replication controller has based on the resource usage of the existing pods.
 * @property {container(v1beta1).HttpLoadBalancing} httpLoadBalancing Configuration for the HTTP (L7) load balancing controller addon, which makes it easy to set up HTTP load balancers for services in a cluster.
 * @property {container(v1beta1).KubernetesDashboard} kubernetesDashboard Configuration for the Kubernetes Dashboard.
 * @property {container(v1beta1).NetworkPolicyConfig} networkPolicyConfig Configuration for NetworkPolicy. This only tracks whether the addon is enabled or not on the Master, it does not track whether network policy is enabled for the nodes.
 */
/**
 ...
 * @property {string} zone [Output only] The name of the Google Compute Engine [zone](/compute/docs/zones#available) in which the cluster resides. This field is deprecated, use location instead.
 */
/**
 ...
 * @property {container(v1beta1).NodePoolAutoscaling} desiredNodePoolAutoscaling Autoscaler configuration for the node pool specified in desired_node_pool_id. If there is only one pool in the cluster and desired_node_pool_id is not provided then the change applies to that single node pool.
 ...
 * @memberOf! container(v1beta1)
 * @type object
 * @property {container(v1beta1).Cluster[]} clusters A list of clusters in the project in the specified zone, or across all ones.
 ...
 * @property {container(v1beta1).ClientCertificateConfig} clientCertificateConfig Configuration for client certificate authentication on the cluster.  If no configuration is specified, a client certificate is issued.
 ...
 * @memberOf! container(v1beta1)
 * @type object
 * @property {container(v1beta1).CidrBlock[]} cidrBlocks cidr_blocks define up to 10 external networks that could access Kubernetes master through HTTPS.
 ...
 * @memberOf! container(v1beta1)
 * @type object
 * @property {container(v1beta1).AcceleratorConfig[]} accelerators A list of hardware accelerators to be attached to each node. See https://cloud.google.com/compute/docs/gpus for more information about support for GPUs.
 ...
 * @property {container(v1beta1).NodeTaint[]} taints List of kubernetes taints to be applied to each node.  For more information, including usage and the valid values, see: https://kubernetes.io/docs/concepts/configuration/taint-and-toleration/
 */
/**
 ...
 * @memberOf! container(v1beta1)
 * @type object
 * @property {container(v1beta1).NodePoolAutoscaling} autoscaling Autoscaler configuration for this NodePool. Autoscaler is enabled only if a valid configuration is present.
 ...
 * @property {string} zone The name of the Google Compute Engine [zone](/compute/docs/zones#available) in which the operation is taking place. This field is deprecated, use location instead.
 */
/**
 * @typedef PodSecurityPolicyConfig
 * @memberOf! container(v1beta1)
 * @type object
 * @property {boolean} enabled Enable the PodSecurityPolicy controller for this cluster. If enabled, pods must be valid under a PodSecurityPolicy to be created.
 */
/**
 ...
 * @property {container(v1beta1).MaintenancePolicy} maintenancePolicy The maintenance policy to be set for the cluster. An empty field clears the existing maintenance policy.
 * @property {string} name The name (project, location, cluster id) of the cluster to set maintenance policy. Specified in the format &#39;projects/x/locations/x/clusters/*&#39;.
