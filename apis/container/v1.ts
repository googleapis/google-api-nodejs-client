    ...
    zones: {
      ...
      clusters: {
        ...
        , /**
           ...
           *   };
           *
           *   container.projects.zones.clusters.get(request, function(err,
           * response) { if (err) { console.error(err); return;
           *     }
           *
           *     // TODO: Change code below to process the `response` object:
        ...
        , /**
           ...
           * @desc Lists all clusters owned by a project in either the specified
           * zone or all zones.
           * @example
           * // BEFORE RUNNING:
           * // ---------------
           ...
           *   };
           *
           *   container.projects.zones.clusters.list(request, function(err,
           * response) { if (err) { console.error(err); return;
           *     }
           *
           *     // TODO: Change code below to process the `response` object:
        ...
        , /**
           ...
           * either via password generation or explicitly set the password.
           * @example
           * // BEFORE RUNNING:
           * // ---------------
           * // 1. If not already done, enable the Google Container Engine API
        ...
        nodePools: {
           ...
           *     nodePoolId: 'my-node-pool-id',  // TODO: Update placeholder
           * value.
           *
           *     resource: {
           *       // TODO: Add desired properties to the request body.
 ...
 * @property {container(v1).NetworkPolicyConfig} networkPolicyConfig Configuration for NetworkPolicy. This only tracks whether the addon
...
quota&lt;/a&gt; is sufficient for this number of instances. You must also have
available firewall and routes quota. For requests, this field should only be
used in lieu of a &quot;node_pool&quot; object, since this configuration (along
with the &quot;node_config&quot;) will be used to create a &quot;NodePool&quot;
object with an auto-generated name. Do not use this and a node_pool at the same
time.
...
object with an auto-generated name. Do not use this and a node_pool at the same
time. For responses, this field will be populated with the node configuration of
the first node pool.
 ...
 * @property {object} resourceLabels The resource labels for the cluster to use to annotate any related
 ...
 * @property {container(v1).MasterAuthorizedNetworksConfig} desiredMasterAuthorizedNetworksConfig Master authorized networks is a Beta feature.
 ...
 * @property {container(v1).ClientCertificateConfig} clientCertificateConfig Configuration for client certificate authentication on the cluster.  If no
 ...
 * @memberOf! container(v1)
 * @type object
 * @property {container(v1).CidrBlock[]} cidrBlocks cidr_blocks define up to 10 external networks that could access
 ...
 * @memberOf! container(v1)
 * @type object
 * @property {container(v1).AcceleratorConfig[]} accelerators A list of hardware accelerators to be attached to each node.
...
&lt;code&gt;minCpuPlatform: &amp;quot;Intel Sandy Bridge&amp;quot;&lt;/code&gt;.
 ...
 * @memberOf! container(v1)
 * @type object
 * @property {container(v1).AddonsConfig} addonsConfig The desired configurations for the various addons available to run in the
cluster.
 */
/**
