 ...
 * var dfareporting = google.dfareporting('v1');
 *
...
function Dfareporting(options) { // eslint-disable-line
  ...
  self.dimensionValues = {
    ...
    query: function (params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/dimensionvalues/query',
          method: 'POST'
        },
        params: params,
  ...
  self.files = {
    ...
    list: function (params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/files',
          method: 'GET'
        },
        params: params,
        requiredParams: ['profileId'],
  ...
  self.reports = {
    ...
    delete: function (params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/reports/{reportId}',
          method: 'DELETE'
        },
        params: params,
    ...
    insert: function (params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/reports',
          method: 'POST'
        },
        params: params,
        requiredParams: ['profileId'],
    ...
    run: function (params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/reports/{reportId}/run',
          method: 'POST'
        },
        params: params,
        requiredParams: ['profileId', 'reportId'],
    ...
    files: {
      ...
      get: function (params, callback) {
        var parameters = {
          options: {
            url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/reports/{reportId}/files/{fileId}',
            method: 'GET'
          },
          params: params,
      ...
      list: function (params, callback) {
        var parameters = {
          options: {
            url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}/reports/{reportId}/files',
            method: 'GET'
          },
          params: params,
          requiredParams: ['profileId', 'reportId'],
  ...
  self.userProfiles = {
    ...
    get: function (params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/dfareporting/v1/userprofiles/{profileId}',
          method: 'GET'
        },
        params: params,
        requiredParams: ['profileId'],
