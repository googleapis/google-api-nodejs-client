    ...
    configs: {
      ...
      variables: {
        ...
        , /**
           ...
           * prefix and `recursive` is true, then all variables with that prefix
           * are deleted. You must set a `recursive` to true if you delete
           * variables by prefix.
      ...
      waiters:
          {
             ...
             * long-running Operation resource which can be polled for
             * completion. However, a waiter with the given name will exist (and
             * can be retrieved) prior to the operation completing. If the
             * operation fails, the failed Waiter resource will still exist and
