...
function Genomics(options) {
  ...
  self.annotations = {
    ...
    , /**
       ...
       * the associated annotation set.  The following fields are required:  *
    ...
    , /**
       ...
       *     annotationId: 'my-annotation-id',  // TODO: Update placeholder
       * value.
       *
       *     auth: authClient,
       *   };
    ...
    , /**
       ...
       * are ordered by genomic coordinate (by reference sequence, then
       * position). Annotations with equivalent genomic coordinates are returned
       * in an unspecified order. This order is consistent, such that two
       * queries for the same content (regardless of page size) yield
  ...
  self.annotationsets = {
    ...
    , /**
       ...
       *     annotationSetId: 'my-annotation-set-id',  // TODO: Update
       * placeholder value.
       *
       *     auth: authClient,
       *   };
  ...
  self.datasets = {
    ...
    , /**
       ...
       * reversible (up to one week after the deletion) via the
    ...
    , /**
       ...
       * href="/iam/docs/managing-policies#getting_a_policy">Getting a
       * Policy</a> for more information.  For the definitions of datasets and
       * other genomics resources, see [Fundamentals of Google
       * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
       * @example
       * // BEFORE RUNNING:
       ...
       * Format is
       *     // `datasets/<dataset ID>`.
       *     resource_: 'datasets/my-dataset',  // TODO: Update placeholder
       * value.
       *
       *     resource: {
       *       // TODO: Add desired properties to the request body.
    ...
    , /**
       ...
       * @desc Lists datasets within a project.  For the definitions of datasets
    ...
    , /**
       ...
       * any existing policy.  For the definitions of datasets and other
       * genomics resources, see [Fundamentals of Google
       * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
    ...
    , /**
       ...
       * Permissions</a> for more information.  For the definitions of datasets
       * and other genomics resources, see [Fundamentals of Google
       * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
       * @example
       * // BEFORE RUNNING:
    ...
    , /**
       ...
       * this API.  For the definitions of datasets and other genomics
  ...
  self.readgroupsets = {
    ...
    , /**
       ...
       * authorize(function(authClient) {
       *   var request = {
       *     // Required. The ID of the read group set to export. The caller
       * must have
       *     // READ access to this read group set.
       *     readGroupSetId: 'my-read-group-set-id',  // TODO: Update
       * placeholder value.
       *
       *     resource: {
       *       // TODO: Add desired properties to the request body.
    ...
    , /**
       ...
       * stranded unmapped reads will be reverse complemented, and their
    ...
    , /**
       ...
       * @desc Updates a read group set.  For the definitions of read group sets
       * and other genomics resources, see [Fundamentals of Google
       * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
       * This method supports patch semantics.
       * @example
  ...
  self.variants = {
    ...
    , /**
       ...
       * definitions of variants and other genomics resources, see [Fundamentals
       * of Google
       * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
       ...
       * If no such variant exists, a new one will be created.  When variants
       * are merged, the call information from the new variant is added to the
       ...
       * clarity     {         "variantSetId": "10473108253681171589",
       * "referenceName": "1",         "start": "10582",
       * "referenceBases": "G",         "alternateBases": [             "A"
       * ],         "calls": [             {                 "callSetId":
       * "10473108253681171589-0",                 "callSetName": "CALLSET0",
       * "genotype": [                     0,                     1
       * ],             }         ]     }      // New variant with conflicting
       * call information     {         "variantSetId": "10473108253681171589",
       * "referenceName": "1",         "start": "10582",
       * "referenceBases": "G",         "alternateBases": [             "A"
       * ],         "calls": [             {                 "callSetId":
       * "10473108253681171589-0",                 "callSetName": "CALLSET0",
       * "genotype": [                     1,                     1
       * ],             }         ]     }  The resulting merged variant would
       * overwrite the existing calls with those from the new variant:      {
       * "variantSetId": "10473108253681171589",         "referenceName": "1",
       * "start": "10582",         "referenceBases": "G",
  ...
  self.variantsets = {
    ...
    , /**
       ...
       * @desc Updates a variant set using patch semantics.  For the definitions
    ...
    , /**
       ...
       * @desc Returns a list of all variant sets matching search criteria.  For
...
For example &quot;chr17&quot; becomes &quot;17&quot; and &quot;chrX&quot;
becomes &quot;X&quot;. All mitochondrial chromosomes (&quot;chrM&quot;,
&quot;chrMT&quot;, etc) become &quot;MT&quot;.
...
allowed. Allowed permissions are&amp;#58;
...
enumerates all possible references: &#39;1&#39;, &#39;2&#39;, &#39;X&#39;,
&#39;Y&#39;, &#39;MT&#39;, etc.
 */
/**
