...
function Genomics(options) {
  ...
  self.pipelines = {
    ...
    , /**
       ...
       * determined by description) are appended to TimestampEvents. Should only
 ...
 * @property {string} acceleratorType Optional. The Compute Engine defined accelerator type.
By specifying this parameter, you will download and install the following
