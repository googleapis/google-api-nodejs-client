  ...
  self.accounts = {
      ...
      workspaces:
          {
            ...
            , /**
               ...
               * @desc Creates a Container Version from the entities present in
               * the workspace, deletes the workspace, and sets the base
            ...
            , /**
               ...
               * @desc Quick previews a workspace by creating a fake container
            ...
            , /**
               ...
               * updating all unmodified workspace entities and displaying
               * conflicts for modified entities.
            ...
            built_in_variables: {
              ...
              , /**
                 ...
                 * @desc Reverts changes to a GTM Built-In Variables in a GTM
                 * Workspace.
                 * @alias
                 * tagmanager.accounts.containers.workspaces.built_in_variables.revert
                 * @memberOf! tagmanager(v2)
    ...
    user_permissions: {
      ...
      , /**
         ...
         * @desc Removes a user from the account, revoking access to it and all
         * of its containers.
