  ...
  self.users = {
    ...
    get(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * profile and should only be called within the context of a logged in
        * user.
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {partners(v2).AnalyticsDataPoint} contacts Instances of users contacting the `Company` on the specified date.
 * @property {partners(v2).Date} eventDate Date on which these events occurred.
 * @property {partners(v2).AnalyticsDataPoint} profileViews Instances of users viewing the `Company` profile on the specified date.
 * @property {partners(v2).AnalyticsDataPoint} searchViews Instances of users seeing the `Company` in Google Partners Search results on the specified date.
 */
/**
 * @typedef AnalyticsDataPoint
 * @memberOf! partners(v2)
 * @type object
 * @property {integer} eventCount Number of times the type of event occurred. Meaning depends on context (e.g. profile views, contacts, etc.).
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {integer} contactsCount Aggregated number of times users contacted the `Company` for given date range.
 * @property {integer} profileViewsCount Aggregated number of profile views for the `Company` for given date range.
 * @property {integer} searchViewsCount Aggregated number of times users saw the `Company` in Google Partners Search results for given date range.
 */
/**
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {string[]} additionalWebsites URL of the company&#39;s additional websites used to verify the dynamic badges. These are stored as full URLs as entered by the user, but only the TLD will be used for the actual verification.
 * @property {string[]} autoApprovalEmailDomains Email domains that allow users with a matching email address to get auto-approved for associating with this company.
 ...
 * @property {partners(v2).Location[]} locations The list of all company locations. If set, must include the primary_location in the list.
 ...
 * @property {string} primaryLanguageCode The primary language code of the company, as defined by &lt;a href=&quot;https://tools.ietf.org/html/bcp47&quot;&gt;BCP 47&lt;/a&gt; (IETF BCP 47, &quot;Tags for Identifying Languages&quot;).
 ...
 * @property {string} companyId The ID of the company. There may be no id if this is a pending company.5
 * @property {string} creationTime The timestamp of when affiliation was requested. @OutputOnly
 * @property {string} internalCompanyId The internal company ID. Only available for a whitelisted set of api clients.
 ...
 * @property {string} resolvedTimestamp The timestamp when the user was approved. @OutputOnly
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {partners(v2).Lead} lead Lead that was created depending on the outcome of &lt;a href=&quot;https://www.google.com/recaptcha/&quot;&gt;reCaptcha&lt;/a&gt; validation.
 * @property {string} recaptchaStatus The outcome of &lt;a href=&quot;https://www.google.com/recaptcha/&quot;&gt;reCaptcha&lt;/a&gt; validation.
 ...
 * @property {string} languageCode Language code of the lead&#39;s language preference, as defined by &lt;a href=&quot;https://tools.ietf.org/html/bcp47&quot;&gt;BCP 47&lt;/a&gt; (IETF BCP 47, &quot;Tags for Identifying Languages&quot;).
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {partners(v2).Analytics[]} analytics The list of analytics. Sorted in ascending order of Analytics.event_date.
 * @property {partners(v2).AnalyticsSummary} analyticsSummary Aggregated information across the response&#39;s analytics.
 * @property {string} nextPageToken A token to retrieve next page of results. Pass this value in the `ListAnalyticsRequest.page_token` field in the subsequent call to ListAnalytics to retrieve the next page of results.
 * @property {partners(v2).ResponseMetadata} responseMetadata Current response metadata.
 */
/**
 ...
 * @property {string} nextPageToken A token to retrieve next page of results. Pass this value in the `ListLeadsRequest.page_token` field in the subsequent call to ListLeads to retrieve the next page of results.
 * @property {partners(v2).ResponseMetadata} responseMetadata Current response metadata.
 ...
 * @property {string} languageCode Language code of the localized company info, as defined by &lt;a href=&quot;https://tools.ietf.org/html/bcp47&quot;&gt;BCP 47&lt;/a&gt; (IETF BCP 47, &quot;Tags for Identifying Languages&quot;).
 ...
 * @property {string[]} addressLine The following address lines represent the most specific part of any address.
 * @property {string} administrativeArea Top-level administrative subdivision of this country.
 * @property {string} dependentLocality Dependent locality or sublocality. Used for UK dependent localities, or neighborhoods or boroughs in other locations.
 ...
 * @property {string} sortingCode Use of this code is very country-specific, but will refer to a secondary classification code for sorting mail.
 */
/**
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {boolean} marketComm An opt-in about receiving email from Partners marketing teams. Includes member-only events and special promotional offers for Google products.
 * @property {boolean} performanceSuggestions An opt-in about receiving email with customized AdWords campaign management tips.
 ...
 * @memberOf! partners(v2)
 * @type object
 * @property {partners(v2).AdWordsManagerAccountInfo[]} availableAdwordsManagerAccounts This is the list of AdWords Manager Accounts the user has edit access to. If the user has edit access to multiple accounts, the user can choose the preferred account and we use this when a personal account is needed. Can be empty meaning the user has access to no accounts. @OutputOnly
 * @property {partners(v2).Certification[]} certificationStatus The list of achieved certifications. These are calculated based on exam results and other requirements. @OutputOnly
 * @property {partners(v2).CompanyRelation} company The company that the user is associated with. If not present, the user is not associated with any company.
 * @property {string} companyVerificationEmail The email address used by the user used for company verification. @OutputOnly
 * @property {partners(v2).ExamStatus[]} examStatus The list of exams the user ever taken. For each type of exam, only one entry is listed.
 * @property {string} id The ID of the user.
 * @property {string} internalId The internal user ID. Only available for a whitelisted set of api clients.
 * @property {string} lastAccessTime The most recent time the user interacted with the Partners site. @OutputOnly
 * @property {string[]} primaryEmails The list of emails the user has access to/can select as primary. @OutputOnly
 * @property {partners(v2).UserProfile} profile The profile information of a Partners user, contains all the directly editable user information.
 ...
 * @property {string} adwordsManagerAccount If the user has edit access to multiple accounts, the user can choose the preferred account and it is used when a personal account is needed. Can be empty.
