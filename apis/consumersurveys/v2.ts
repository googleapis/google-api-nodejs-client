  ...
  self.mobileapppanels = {
    ...
    get(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl + '/consumersurveys/v2/mobileAppPanels/{panelId}')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
    ...
    list(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl + '/consumersurveys/v2/mobileAppPanels')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
    ...
    get(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl +
                    '/consumersurveys/v2/surveys/{surveyUrlId}/results')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
  ...
  self.surveys = {
    ...
    delete (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl + '/consumersurveys/v2/surveys/{surveyUrlId}')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'DELETE'
            },
            options),
    ...
    insert(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl + '/consumersurveys/v2/surveys')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
    ...
    start(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl + '/consumersurveys/v2/surveys/{resourceId}/start')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
    ...
    stop(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url: (rootUrl + '/consumersurveys/v2/surveys/{resourceId}/stop')
                       .replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
