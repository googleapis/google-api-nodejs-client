...
function Consumersurveys(options) { // eslint-disable-line
  ...
  self.mobileapppanels = {
    ...
    get: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/mobileAppPanels/{panelId}').replace(/([^:]\/)\/+/g, '$1'),
          method: 'GET'
        }, options),
        params: params,
    ...
    list: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/mobileAppPanels').replace(/([^:]\/)\/+/g, '$1'),
          method: 'GET'
        }, options),
        params: params,
        requiredParams: [],
  ...
  self.results = {
    ...
    get: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/surveys/{surveyUrlId}/results').replace(/([^:]\/)\/+/g, '$1'),
          method: 'GET'
        }, options),
        params: params,
  ...
  self.surveys = {
    ...
    delete: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/surveys/{surveyUrlId}').replace(/([^:]\/)\/+/g, '$1'),
          method: 'DELETE'
        }, options),
        params: params,
        requiredParams: ['surveyUrlId'],
    ...
    insert: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/surveys').replace(/([^:]\/)\/+/g, '$1'),
          method: 'POST'
        }, options),
        params: params,
        requiredParams: [],
    ...
    start: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/surveys/{resourceId}/start').replace(/([^:]\/)\/+/g, '$1'),
          method: 'POST'
        }, options),
        params: params,
    ...
    stop: function (params, options, callback) {
      ...
      const parameters = {
        options: Object.assign({
          url: (rootUrl + '/consumersurveys/v2/surveys/{resourceId}/stop').replace(/([^:]\/)\/+/g, '$1'),
          method: 'POST'
        }, options),
        params: params,
        requiredParams: ['resourceId'],
