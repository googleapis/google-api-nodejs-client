...
The [@google-cloud/service-directory](https://www.npmjs.com/package/@google-cloud/service-directory)
...
```sh
$ cd src/apis/servicedirectory
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/servicedirectory.min.js`. Use it from your HTML file:

```html
<script src="/path/to/servicedirectory.min.js"></script>
<script>
const { servicedirectory, auth } = Servicedirectory;
</script>
```
