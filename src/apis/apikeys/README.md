...
legacy application, please use [@google-cloud/apikeys](https://www.npmjs.com/package/@google-cloud/apikeys) instead.
The [@google-cloud/apikeys](https://www.npmjs.com/package/@google-cloud/apikeys) library is faster, easier to use, and better maintained.
...
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/apikeys/classes/Apikeys.html).
