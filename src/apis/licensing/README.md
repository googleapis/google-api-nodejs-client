...
```sh
$ npm install @googleapis/licensing
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/licensing/classes/Licensing.html).
...
The generated bundle will be written to `dist/licensing.min.js`. Use it from your HTML file:

```html
<script src="/path/to/licensing.min.js"></script>
<script>
const { licensing, auth } = Licensing;
</script>
```
