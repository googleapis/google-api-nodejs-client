...
legacy application, please use [@google-cloud/parametermanager](https://www.npmjs.com/package/@google-cloud/parametermanager) instead.
The [@google-cloud/parametermanager](https://www.npmjs.com/package/@google-cloud/parametermanager) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/parametermanager
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/parametermanager/classes/Parametermanager.html).
