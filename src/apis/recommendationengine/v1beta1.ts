...
export namespace recommendationengine_v1beta1 {
  ...
  export class Resource$Projects$Locations$Catalogs$Catalogitems {
     ...
     */
    getGroupIdItems(
      params: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    getGroupIdItems(
      params?: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems,
      ...
      Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse
    >;
    getGroupIdItems(
      params: Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    getGroupIdItems(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems
        | BodyResponseCallback<
            Schema$GoogleCloudRecommendationengineV1beta1GetCatalogItemsWithItemGroupIdResponse
          >
        | BodyResponseCallback<Readable>,
      ...
      | GaxiosPromise<Readable> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta1/{+parent}/catalogItems:groupIdItems'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
  ...
  export interface Params$Resource$Projects$Locations$Catalogs$Catalogitems$Getgroupiditems
    extends StandardParameters {
    /**
     * Required. Catalog item identifier for prediction results.
     */
