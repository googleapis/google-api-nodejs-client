...
legacy application, please use [@google-cloud/vpc-access](https://www.npmjs.com/package/@google-cloud/vpc-access) instead.
The [@google-cloud/vpc-access](https://www.npmjs.com/package/@google-cloud/vpc-access) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/vpcaccess
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/vpcaccess/classes/Vpcaccess.html).
