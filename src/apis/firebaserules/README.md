...
```sh
$ npm install @googleapis/firebaserules
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/firebaserules/classes/Firebaserules.html).
...
```html
<script src="/path/to/firebaserules.min.js"></script>
<script>
const { firebaserules, auth } = Firebaserules;
</script>
```
