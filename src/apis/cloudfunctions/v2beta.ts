    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}/locations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Functions {
    ...
    abortFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:abortFunctionUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    commitFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:commitFunctionUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    commitFunctionUpgradeAsGen2(
      params: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    commitFunctionUpgradeAsGen2(
      params?: Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2,
    ...
    commitFunctionUpgradeAsGen2(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Functions$Commitfunctionupgradeasgen2;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:commitFunctionUpgradeAsGen2')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    detachFunction(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:detachFunction')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateDownloadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:generateDownloadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateUploadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+parent}/functions:generateUploadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    get(
      params?: Params$Resource$Projects$Locations$Functions$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$Function>>;
    get(
      params: Params$Resource$Projects$Locations$Functions$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Function> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Function>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
    ...
    getIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+resource}:getIamPolicy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    redirectFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:redirectFunctionUpgradeTraffic')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    rollbackFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:rollbackFunctionUpgradeTraffic')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    setIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+resource}:setIamPolicy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    setupFunctionUpgradeConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:setupFunctionUpgradeConfig')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    testIamPermissions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+resource}:testIamPermissions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Runtimes {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+parent}/runtimes')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
