  ...
  export class Resource$Projects$Locations$Functions {
    ...
    abortFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:abortFunctionUpgrade').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    commitFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:commitFunctionUpgrade').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    commitFunctionUpgradeAsGen2(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v2beta/{+name}:commitFunctionUpgradeAsGen2'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    detachFunction(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2beta/{+name}:detachFunction').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    redirectFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v2beta/{+name}:redirectFunctionUpgradeTraffic'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    rollbackFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v2beta/{+name}:rollbackFunctionUpgradeTraffic'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    setupFunctionUpgradeConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v2beta/{+name}:setupFunctionUpgradeConfig'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
