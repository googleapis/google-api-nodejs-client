  ...
  export class Resource$Projects$Locations$Functions {
    ...
    abortFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:abortFunctionUpgrade').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    commitFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:commitFunctionUpgrade').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    commitFunctionUpgradeAsGen2(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:commitFunctionUpgradeAsGen2').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    detachFunction(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:detachFunction').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    setupFunctionUpgradeConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:setupFunctionUpgradeConfig').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
