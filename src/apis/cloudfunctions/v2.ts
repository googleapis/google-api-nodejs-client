  ...
  export class Resource$Projects$Locations$Functions {
    ...
    abortFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:abortFunctionUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    commitFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:commitFunctionUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    commitFunctionUpgradeAsGen2(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:commitFunctionUpgradeAsGen2')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    detachFunction(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:detachFunction')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateDownloadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:generateDownloadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateUploadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/functions:generateUploadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    redirectFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:redirectFunctionUpgradeTraffic')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    rollbackFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:rollbackFunctionUpgradeTraffic')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    setupFunctionUpgradeConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:setupFunctionUpgradeConfig')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Runtimes {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/runtimes')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
