  ...
  export class Resource$Projects$Locations$Functions {
    ...
    abortFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:abortFunctionUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    commitFunctionUpgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:commitFunctionUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    commitFunctionUpgradeAsGen2(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:commitFunctionUpgradeAsGen2')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    detachFunction(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:detachFunction')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateDownloadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:generateDownloadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateUploadUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+parent}/functions:generateUploadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+resource}:getIamPolicy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    redirectFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:redirectFunctionUpgradeTraffic')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    rollbackFunctionUpgradeTraffic(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:rollbackFunctionUpgradeTraffic')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    setIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+resource}:setIamPolicy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    setupFunctionUpgradeConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+name}:setupFunctionUpgradeConfig')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    testIamPermissions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+resource}:testIamPermissions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Runtimes {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2alpha/{+parent}/runtimes')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
