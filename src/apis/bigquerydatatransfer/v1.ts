      ...
      transferConfigs: {
        ...
        list(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * set, even if they are not updated.
            * @alias
            * bigquerydatatransfer.projects.locations.transferConfigs.patch
            * @memberOf! bigquerydatatransfer(v1)
            *
        ...
        patch(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * supports - in the range, one transfer run is created. Note that
    ...
    transferConfigs: {
      ...
      patch(params, options, callback) {
        ...
        return createAPIRequest(parameters, callback);
          ...
          * created per UTC time in the time range.
 ...
 * @property {string} clientId Data source client id which should be used to receive refresh token. When not supplied, no offline credentials are populated for data transfer.
 * @property {string} dataRefreshType Specifies whether the data source supports automatic data refresh for the past few days, and how it&#39;s supported. For some data sources, data might not be complete until a few days later, so it&#39;s useful to refresh data automatically.
 * @property {string} dataSourceId Data source id.
 * @property {integer} defaultDataRefreshWindowDays Default data refresh window on days. Only meaningful when `data_refresh_type` = `SLIDING_WINDOW`.
 * @property {string} defaultSchedule Default data transfer schedule. Examples of valid schedules include: `1st,3rd monday of month 15:30`, `every wed,fri of jan,jun 13:15`, and `first sunday of quarter 00:00`.
 ...
 * @property {boolean} supportsCustomSchedule Specifies whether the data source supports a user defined schedule, or operates on the default schedule. When set to `true`, user can override default schedule.
 * @property {boolean} supportsMultipleTransfers Indicates whether the data source supports multiple transfers to different BigQuery targets.
 * @property {string} transferType Transfer type. Currently supports only batch transfers, which are transfers that use the BigQuery batch APIs (load or query) to ingest the data.
 * @property {integer} updateDeadlineSeconds The number of seconds to wait for an update from the data source before BigQuery marks the transfer as failed.
 */
/**
 ...
 * @property {boolean} recurse If set to true, schema should be taken from the parent with the same parameter_id. Only applicable when parameter type is RECORD.
 ...
 * @property {string} validationDescription Description of the requirements for this field, in case the user input does not fulfill the regex pattern or min/max values.
 ...
 * @property {string} nextPageToken Output only. The next-pagination token. For multiple-page list results, this token can be used as the `ListDataSourcesRequest.page_token` to request the next page of list results.
 */
/**
 ...
 * @memberOf! bigquerydatatransfer(v1)
 * @type object
 * @property {string} nextPageToken Output only. The next-pagination token. For multiple-page list results, this token can be used as the `ListTransferConfigsRequest.page_token` to request the next page of list results.
 ...
 * @memberOf! bigquerydatatransfer(v1)
 * @type object
 * @property {string} nextPageToken Output only. The next-pagination token. For multiple-page list results, this token can be used as the `GetTransferRunLogRequest.page_token` to request the next page of list results.
 ...
 * @memberOf! bigquerydatatransfer(v1)
 * @type object
 * @property {string} nextPageToken Output only. The next-pagination token. For multiple-page list results, this token can be used as the `ListTransferRunsRequest.page_token` to request the next page of list results.
 ...
 * @memberOf! bigquerydatatransfer(v1)
 * @type object
 * @property {string} endTime End time of the range of transfer runs. For example, `&quot;2017-05-30T00:00:00+00:00&quot;`.
 * @property {string} startTime Start time of the range of transfer runs. For example, `&quot;2017-05-25T00:00:00+00:00&quot;`.
 */
/**
 ...
 * @property {boolean} disabled Is this config disabled. When set to true, no runs are scheduled for a given transfer.
 * @property {string} displayName User specified display name for the data transfer.
 * @property {string} name The resource name of the transfer config. Transfer config names have the form `projects/{project_id}/transferConfigs/{config_id}`. Where `config_id` is usually a uuid, even though it is not guaranteed or required. The name is ignored when creating a transfer config.
