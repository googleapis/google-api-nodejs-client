...
legacy application, please use [@google-cloud/deploy](https://www.npmjs.com/package/@google-cloud/deploy) instead.
The [@google-cloud/deploy](https://www.npmjs.com/package/@google-cloud/deploy) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/clouddeploy
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/clouddeploy/classes/Clouddeploy.html).
