...
export namespace securitycenter_v1p1beta1 {
  ...
  export class Resource$Organizations$Assets {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/assets').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    runDiscovery(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/assets:runDiscovery').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    updateSecurityMarks(
      params?: Params$Resource$Organizations$Assets$Updatesecuritymarks,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudSecuritycenterV1p1beta1SecurityMarks>>;
    updateSecurityMarks(
      params: Params$Resource$Organizations$Assets$Updatesecuritymarks,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    updateSecurityMarks(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<
            Schema$GoogleCloudSecuritycenterV1p1beta1SecurityMarks
          >,
  ...
  export class Resource$Organizations$Notificationconfigs {
    ...
    create(
      params?: Params$Resource$Organizations$Notificationconfigs$Create,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$NotificationConfig>>;
    create(
      params: Params$Resource$Organizations$Notificationconfigs$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/notificationConfigs').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      params?: Params$Resource$Organizations$Notificationconfigs$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListNotificationConfigsResponse>>;
    list(
      params: Params$Resource$Organizations$Notificationconfigs$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Organizations$Operations {
    ...
    cancel(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+name}:cancel').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Organizations$Sources {
    ...
    create(
      ...
      callback?:
        | BodyResponseCallback<Schema$Source>
        | BodyResponseCallback<Readable>
    ): void | Promise<GaxiosResponseWithHTTP2<Schema$Source>> | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/sources').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    getIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+resource}:getIamPolicy').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    setIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+resource}:setIamPolicy').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    testIamPermissions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1p1beta1/{+resource}:testIamPermissions'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export class Resource$Organizations$Sources$Findings {
    ...
    create(
      params?: Params$Resource$Organizations$Sources$Findings$Create,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudSecuritycenterV1p1beta1Finding>>;
    create(
      params: Params$Resource$Organizations$Sources$Findings$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    create(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<
            Schema$GoogleCloudSecuritycenterV1p1beta1Finding
          >,
      callback: BodyResponseCallback<
        Schema$GoogleCloudSecuritycenterV1p1beta1Finding
      >
    ...
    create(
      paramsOrCallback?:
        ...
        | BodyResponseCallback<Schema$GoogleCloudSecuritycenterV1p1beta1Finding>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/findings').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudSecuritycenterV1p1beta1Finding>(
          parameters,
          callback as BodyResponseCallback<{} | void>
        );
      } else {
    ...
    setState(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+name}:setState').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
