...
```sh
$ npm install @googleapis/firebasedynamiclinks
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/firebasedynamiclinks/classes/Firebasedynamiclinks.html).
...
```html
<script src="/path/to/firebasedynamiclinks.min.js"></script>
<script>
const { firebasedynamiclinks, auth } = Firebasedynamiclinks;
</script>
```
