...
export namespace androidmanagement_v1 {
   ...
   */
  export interface Schema$CrossDevicePolicies {
    /**
     ...
     */
    nearbyAppStreaming?: string | null;
    /**
  ...
  export interface Schema$EnrollmentToken {
     ...
     */
    googleAuthenticationOptions?: Schema$GoogleAuthenticationOptions;
    /**
   ...
   */
  export interface Schema$GoogleAuthenticationOptions {
    /**
  ...
  export interface Schema$SigninDetail {
     ...
     * Optional. Options related to Google authentication during the enrollment.
     */
    googleAuthenticationOptions?: Schema$SigninDetailGoogleAuthenticationOptions;
    /**
   ...
   */
  export interface Schema$SigninDetailGoogleAuthenticationOptions {
    /**
  ...
  export class Resource$Enterprises {
    ...
    generateEnterpriseUpgradeUrl(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:generateEnterpriseUpgradeUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Enterprises$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListEnterprisesResponse>,
  ...
  export class Resource$Enterprises$Migrationtokens {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/migrationTokens')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Enterprises$Policies {
    ...
    modifyPolicyApplications(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:modifyPolicyApplications')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    removePolicyApplications(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:removePolicyApplications')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Enterprises$Webtokens {
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$WebToken> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$WebToken>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
  ...
  export class Resource$Signupurls {
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$SignupUrl> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$SignupUrl>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
