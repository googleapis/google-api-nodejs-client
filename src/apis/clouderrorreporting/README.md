...
```sh
$ npm install @googleapis/clouderrorreporting
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/clouderrorreporting/classes/Clouderrorreporting.html).
...
```html
<script src="/path/to/clouderrorreporting.min.js"></script>
<script>
const { clouderrorreporting, auth } = Clouderrorreporting;
</script>
```
