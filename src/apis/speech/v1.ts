...
export namespace speech_v1 {
  ...
  export interface Schema$RecognitionConfig {
     ...
     * recognized using the standard version of the specified model.  Enhanced
     * speech models require that you opt-in to data logging using instructions
     * in the [documentation](/speech-to-text/enable-data-logging). If you set
