...
export namespace binaryauthorization_v1 {
  ...
  export class Resource$Projects$Attestors {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/attestors')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    validateAttestationOccurrence(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+attestor}:validateAttestationOccurrence')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Platforms$Gke$Policies {
    ...
    evaluate(
      params: Params$Resource$Projects$Platforms$Gke$Policies$Evaluate,
      options:
        MethodOptions | BodyResponseCallback<Schema$EvaluateGkePolicyResponse>,
