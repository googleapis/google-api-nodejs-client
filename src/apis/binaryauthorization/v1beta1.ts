...
export namespace binaryauthorization_v1beta1 {
  ...
  export class Resource$Projects$Attestors {
    ...
    validateAttestationOccurrence(
      ...
      if (params.attestor !== undefined && params.attestor !== null) {
        validateMultiSegment('attestor', String(params.attestor));
        params.attestor = encodeWithoutSlashes(String(params.attestor));
      }
