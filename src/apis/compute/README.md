...
legacy application, please use [@google-cloud/compute](https://www.npmjs.com/package/@google-cloud/compute) instead.
The [@google-cloud/compute](https://www.npmjs.com/package/@google-cloud/compute) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/compute
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/compute/classes/Compute.html).
...
```html
<script src="/path/to/compute.min.js"></script>
<script>
const { compute, auth } = Compute;
</script>
```
