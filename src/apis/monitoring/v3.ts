...
export namespace monitoring_v3 {
   ...
   */
  export interface Schema$LogMetadata {
    /**
     * The labels extracted from the log.
     */
    extractedLabels?: {[key: string]: string} | null;
  }
  /**
   ...
   */
  export interface Schema$PolicySnapshot {
    /**
  ...
  export class Resource$Projects$Alerts {
     ...
     *
     *   // Do the magic
     *   const res = await monitoring.projects.alerts.get({
     ...
     *
     *   // Do the magic
     *   const res = await monitoring.projects.alerts.list({
