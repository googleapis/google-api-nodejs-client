...
legacy application, please use [@google-cloud/dms](https://www.npmjs.com/package/@google-cloud/dms) instead.
The [@google-cloud/dms](https://www.npmjs.com/package/@google-cloud/dms) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/datamigration
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/datamigration/classes/Datamigration.html).
