...
export namespace saasservicemgmt_v1beta1 {
   ...
   */
  export interface Schema$ListReplicationsInternalResponse {
    /**
     * If present, the next page token can be provided to a subsequent ListReplicationsInternal call to list the next page. If empty, there are no more pages.
     */
    nextPageToken?: string | null;
    /**
     * The resulting replication internals.
     */
    replicationsInternal?: Schema$ReplicationInternal[];
    /**
     * Locations that could not be reached.
     */
    unreachable?: string[] | null;
  ...
  export interface Schema$ReplicationInternal {
     ...
     */
    stats?: {[key: string]: Schema$ReplicationStats} | null;
    /**
   ...
   */
  export interface Schema$ReplicationStats {
    /**
     ...
     */
    finishedResources?: string[] | null;
    /**
     * The resources that are pending replication.
     */
    pendingResources?: string[] | null;
    /**
  ...
  export class Resource$Projects$Locations {
    ...
    replicationsInternal: Resource$Projects$Locations$Replicationsinternal;
    ...
    constructor(context: APIRequestContext) {
      ...
      this.replicationsInternal =
        new Resource$Projects$Locations$Replicationsinternal(this.context);
  ...
  export class Resource$Projects$Locations$Replicationsinternal {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *   // Do the magic
     *   const res =
     *     await saasservicemgmt.projects.locations.replicationsInternal.create({
     *       // Required. The parent of the replication internal.
     *       parent: 'projects/my-project/locations/my-location',
     *       // Required. The ID value for the new replication internal.
     *       replicationInternalId: 'placeholder-value',
     *       // An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     *       requestId: 'placeholder-value',
     *       // If "validate_only" is set to true, the service will try to validate that this request would succeed, but will not actually make changes.
     *       validateOnly: 'placeholder-value',
     ...
     */
    create(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Create,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    create(
      params?: Params$Resource$Projects$Locations$Replicationsinternal$Create,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ReplicationInternal>>;
    create(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    create(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Create,
      options: MethodOptions | BodyResponseCallback<Schema$ReplicationInternal>,
      callback: BodyResponseCallback<Schema$ReplicationInternal>
    ): void;
    create(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Create,
      callback: BodyResponseCallback<Schema$ReplicationInternal>
    ): void;
    create(callback: BodyResponseCallback<Schema$ReplicationInternal>): void;
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Replicationsinternal$Create
        | BodyResponseCallback<Schema$ReplicationInternal>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Replicationsinternal$Create;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/replicationsInternal').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$ReplicationInternal>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ReplicationInternal>(parameters);
      }
    }
     ...
     *   // Do the magic
     *   const res =
     *     await saasservicemgmt.projects.locations.replicationsInternal.delete({
     ...
     *       etag: 'placeholder-value',
     *       // Required. The resource name of the resource within a service.
     *       name: 'projects/my-project/locations/my-location/replicationsInternal/[^/]+',
     *       // An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. The server will guarantee that for at least 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     *       requestId: 'placeholder-value',
     *       // If "validate_only" is set to true, the service will try to validate that this request would succeed, but will not actually make changes.
     *       validateOnly: 'placeholder-value',
     ...
     */
    delete(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Delete,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    delete(
      params?: Params$Resource$Projects$Locations$Replicationsinternal$Delete,
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Replicationsinternal$Delete
        | BodyResponseCallback<Schema$Empty>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Replicationsinternal$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *
     *   // Do the magic
     *   const res = await saasservicemgmt.projects.locations.replicationsInternal.get(
     *     {
     *       // Required. The resource name of the resource within a service.
     *       name: 'projects/my-project/locations/my-location/replicationsInternal/[^/]+',
     *     },
     ...
     */
    get(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Get,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    get(
      params?: Params$Resource$Projects$Locations$Replicationsinternal$Get,
    ...
    get(callback: BodyResponseCallback<Schema$ReplicationInternal>): void;
    get(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Replicationsinternal$Get
        | BodyResponseCallback<Schema$ReplicationInternal>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Replicationsinternal$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *   // Do the magic
     *   const res =
     *     await saasservicemgmt.projects.locations.replicationsInternal.list({
     *       // Filter the list as specified in https://google.aip.dev/160.
     *       filter: 'placeholder-value',
     *       // Order results as specified in https://google.aip.dev/132.
     *       orderBy: 'placeholder-value',
     ...
     */
    list(
      params: Params$Resource$Projects$Locations$Replicationsinternal$List,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    list(
      params?: Params$Resource$Projects$Locations$Replicationsinternal$List,
      ...
      GaxiosResponseWithHTTP2<Schema$ListReplicationsInternalResponse>
    >;
    list(
      params: Params$Resource$Projects$Locations$Replicationsinternal$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$ListReplicationsInternalResponse>,
      callback: BodyResponseCallback<Schema$ListReplicationsInternalResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Replicationsinternal$List,
      callback: BodyResponseCallback<Schema$ListReplicationsInternalResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Replicationsinternal$List
        | BodyResponseCallback<Schema$ListReplicationsInternalResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Replicationsinternal$List;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      if (callback) {
        createAPIRequest<Schema$ListReplicationsInternalResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListReplicationsInternalResponse>(
          parameters
        );
      }
    }
     ...
     *   // Do the magic
     *   const res =
     *     await saasservicemgmt.projects.locations.replicationsInternal.patch({
     *       // The etag known to the client for the expected state of the replication internal. This is used with state-changing methods to prevent accidental overwrites when multiple user agents might be acting in parallel on the same resource. An etag wildcard provide optimistic concurrency based on the expected existence of the replication internal. The Any wildcard (`*`) requires that the resource must already exists, and the Not Any wildcard (`!*`) requires that it must not.
     *       etag: 'placeholder-value',
     *       // Identifier. The resource name (full URI of the resource) following the standard naming scheme: "projects/{project\}/locations/{location\}/replicationInternal/{replication_internal_id\}"
     *       name: 'projects/my-project/locations/my-location/replicationsInternal/[^/]+',
     ...
     */
    patch(
      params: Params$Resource$Projects$Locations$Replicationsinternal$Patch,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    patch(
      params?: Params$Resource$Projects$Locations$Replicationsinternal$Patch,
    ...
    patch(callback: BodyResponseCallback<Schema$ReplicationInternal>): void;
    patch(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Replicationsinternal$Patch
        | BodyResponseCallback<Schema$ReplicationInternal>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Replicationsinternal$Patch;
      let options = (optionsOrCallback || {}) as MethodOptions;
