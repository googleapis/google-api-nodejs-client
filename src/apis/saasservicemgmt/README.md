...
legacy application, please use [@google-cloud/saasservicemgmt](https://www.npmjs.com/package/@google-cloud/saasservicemgmt) instead.
The [@google-cloud/saasservicemgmt](https://www.npmjs.com/package/@google-cloud/saasservicemgmt) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/saasservicemgmt
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/saasservicemgmt/classes/Saasservicemgmt.html).
