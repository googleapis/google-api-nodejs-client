...
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/businessprofileperformance/classes/Businessprofileperformance.html).
