...
legacy application, please use [@google-cloud/eventarc](https://www.npmjs.com/package/@google-cloud/eventarc) instead.
The [@google-cloud/eventarc](https://www.npmjs.com/package/@google-cloud/eventarc) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/eventarc
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/eventarc/classes/Eventarc.html).
