...
legacy application, please use [@google-cloud/agentidentity](https://www.npmjs.com/package/@google-cloud/agentidentity) instead.
The [@google-cloud/agentidentity](https://www.npmjs.com/package/@google-cloud/agentidentity) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/agentidentity
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/agentidentity/classes/Agentidentity.html).
