...
export namespace ces_v1beta {
  ...
  export interface Schema$EvaluationScenario {
     ...
     */
    scenarioExecutionMode?: string | null;
    /**
  ...
  export interface Schema$EvaluationSettings {
     ...
     */
    evaluationRunCachingSettings?: Schema$EvaluationRunCachingSettings;
    /**
  ...
  export interface Schema$GenerateAppResourceRequest {
     ...
     */
    appVersionContext?: Schema$GenerateAppResourceRequestAppVersionContext;
    /**
   ...
   * The app version context specifying the base snapshot and target agent.
   */
  export interface Schema$GenerateAppResourceRequestAppVersionContext {
    /**
  ...
  export interface Schema$LfA2aV1AgentCard {
     ...
     */
    securitySchemes?: {[key: string]: Schema$LfA2aV1SecurityScheme} | null;
    /**
  ...
  export interface Schema$LfA2aV1SecurityRequirement {
     ...
     */
    schemes?: {[key: string]: Schema$LfA2aV1StringList} | null;
  }
  /**
   ...
   */
  export interface Schema$RunEvaluationResultMetricsRequest {}
  /**
   * Response message for EvaluationService.RunEvaluationResultMetrics.
   */
  export interface Schema$RunEvaluationResultMetricsResponse {
    /**
  ...
  export class Resource$Projects$Locations {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+name}/locations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/apps')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    executeTool(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}:executeTool')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateAppResource(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}:generateAppResource')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getExtendedAgentCard(
      params: Params$Resource$Projects$Locations$Apps$Getextendedagentcard,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    getExtendedAgentCard(
      params?: Params$Resource$Projects$Locations$Apps$Getextendedagentcard,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$LfA2aV1AgentCard>>;
    getExtendedAgentCard(
      params: Params$Resource$Projects$Locations$Apps$Getextendedagentcard,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    getExtendedAgentCard(
      params: Params$Resource$Projects$Locations$Apps$Getextendedagentcard,
      options: MethodOptions | BodyResponseCallback<Schema$LfA2aV1AgentCard>,
      callback: BodyResponseCallback<Schema$LfA2aV1AgentCard>
    ): void;
    getExtendedAgentCard(
      params: Params$Resource$Projects$Locations$Apps$Getextendedagentcard,
      callback: BodyResponseCallback<Schema$LfA2aV1AgentCard>
    ...
    getExtendedAgentCard(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Apps$Getextendedagentcard
        | BodyResponseCallback<Schema$LfA2aV1AgentCard>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Apps$Getextendedagentcard;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      if (params.tenant !== undefined && params.tenant !== null) {
        validateMultiSegment('tenant', String(params.tenant));
        params.tenant = encodeWithoutSlashes(String(params.tenant));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+tenant}/extendedAgentCard')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$LfA2aV1AgentCard>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$LfA2aV1AgentCard>(parameters);
      }
    }
    ...
    importApp(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/apps:importApp')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    importEvaluations(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}:importEvaluations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    retrieveToolSchema(
      params: Params$Resource$Projects$Locations$Apps$Retrievetoolschema,
      options:
        MethodOptions | BodyResponseCallback<Schema$RetrieveToolSchemaResponse>,
    ...
    retrieveToolSchema(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}:retrieveToolSchema')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    runEvaluation(
      ...
      if (params.app !== undefined && params.app !== null) {
        validateMultiSegment('app', String(params.app));
        params.app = encodeWithoutSlashes(String(params.app));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+app}:runEvaluation')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    testPersonaVoice(
      params: Params$Resource$Projects$Locations$Apps$Testpersonavoice,
      options:
        MethodOptions | BodyResponseCallback<Schema$TestPersonaVoiceResponse>,
    ...
    testPersonaVoice(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+app}:testPersonaVoice')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Agents {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/agents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Changelogs {
    ...
    list(
      params: Params$Resource$Projects$Locations$Apps$Changelogs$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListChangelogsResponse>,
  ...
  export class Resource$Projects$Locations$Apps$Conversations {
    ...
    batchDelete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/conversations:batchDelete')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateEvaluation(
      ...
      if (params.conversation !== undefined && params.conversation !== null) {
        validateMultiSegment('conversation', String(params.conversation));
        params.conversation = encodeWithoutSlashes(String(params.conversation));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+conversation}:generateEvaluation')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Apps$Conversations$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListConversationsResponse>,
  ...
  export class Resource$Projects$Locations$Apps$Deployments {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.message = new Resource$Projects$Locations$Apps$Deployments$Message(
        this.context
      );
    }
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/deployments')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
     ...
     */
    getExtendedAgentCard(
      params: Params$Resource$Projects$Locations$Apps$Deployments$Getextendedagentcard,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    getExtendedAgentCard(
      params?: Params$Resource$Projects$Locations$Apps$Deployments$Getextendedagentcard,
    ...
    getExtendedAgentCard(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Apps$Deployments$Getextendedagentcard
        | BodyResponseCallback<Schema$LfA2aV1AgentCard>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Apps$Deployments$Getextendedagentcard;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export class Resource$Projects$Locations$Apps$Deployments$Message {
     ...
     */
    send(
      params: Params$Resource$Projects$Locations$Apps$Deployments$Message$Send,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    send(
      params?: Params$Resource$Projects$Locations$Apps$Deployments$Message$Send,
    ...
    send(
      params: Params$Resource$Projects$Locations$Apps$Deployments$Message$Send,
      options:
        MethodOptions | BodyResponseCallback<Schema$LfA2aV1SendMessageResponse>,
    ...
    send(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Apps$Deployments$Message$Send
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Apps$Deployments$Message$Send;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+tenant}/message:send')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Evaluationdatasets {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/evaluationDatasets')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Evaluationexpectations {
    ...
    create(
      params: Params$Resource$Projects$Locations$Apps$Evaluationexpectations$Create,
      options:
        MethodOptions | BodyResponseCallback<Schema$EvaluationExpectation>,
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/evaluationExpectations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Evaluationruns {
    ...
    export(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/evaluationRuns:export')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Apps$Evaluationruns$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListEvaluationRunsResponse>,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/evaluationRuns')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Evaluations {
    ...
    uploadEvaluationAudio(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+name}:uploadEvaluationAudio')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Evaluations$Results {
    ...
    export(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/results:export')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/results')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
     ...
     *   // Do the magic
     *   const res =
     *     await ces.projects.locations.apps.evaluations.results.runEvaluationResultMetrics(
     *       {
     ...
     *         evaluationResultId:
     *           'projects/my-project/locations/my-location/apps/my-app/evaluations/my-evaluation/results/my-result',
     *
     *         // Request body metadata
     *         requestBody: {
     *           // request body parameters
    ...
    runEvaluationResultMetrics(
      params: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Runevaluationresultmetrics,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    runEvaluationResultMetrics(
      params?: Params$Resource$Projects$Locations$Apps$Evaluations$Results$Runevaluationresultmetrics,
    ...
    runEvaluationResultMetrics(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Apps$Evaluations$Results$Runevaluationresultmetrics
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Apps$Evaluations$Results$Runevaluationresultmetrics;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      if (
        params.evaluationResultId !== undefined &&
        params.evaluationResultId !== null
      ) {
        validateMultiSegment(
          'evaluationResultId',
          String(params.evaluationResultId)
        );
        params.evaluationResultId = encodeWithoutSlashes(
          String(params.evaluationResultId)
        );
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/v1beta/{+evaluationResultId}:runEvaluationResultMetrics'
            )
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
        ...
        params,
        requiredParams: ['evaluationResultId'],
        pathParams: ['evaluationResultId'],
        context: this.context,
      };
      if (callback) {
        createAPIRequest<Schema$Operation>(
  ...
  export interface Params$Resource$Projects$Locations$Apps$Evaluations$Results$Runevaluationresultmetrics extends StandardParameters {
    /**
     * Required. The evaluation result to run metrics for. Format: `projects/{project\}/locations/{location\}/apps/{app\}/evaluations/{evaluation\}/results/{evaluation_result_id\}`
     */
     ...
     * Request body metadata
     */
    requestBody?: Schema$RunEvaluationResultMetricsRequest;
  }
  ...
  export class Resource$Projects$Locations$Apps$Examples {
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Example> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Example>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/examples')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Guardrails {
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Guardrail> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Guardrail>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/guardrails')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Apps$Guardrails$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListGuardrailsResponse>,
  ...
  export class Resource$Projects$Locations$Apps$Scheduledevaluationruns {
    ...
    create(
      params: Params$Resource$Projects$Locations$Apps$Scheduledevaluationruns$Create,
      options:
        MethodOptions | BodyResponseCallback<Schema$ScheduledEvaluationRun>,
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/scheduledEvaluationRuns')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Sessions {
    ...
    generateChatToken(
      params: Params$Resource$Projects$Locations$Apps$Sessions$Generatechattoken,
      options:
        MethodOptions | BodyResponseCallback<Schema$GenerateChatTokenResponse>,
    ...
    runSession(
      ...
      if (params.session !== undefined && params.session !== null) {
        validateMultiSegment('session', String(params.session));
        params.session = encodeWithoutSlashes(String(params.session));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+session}:runSession')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    streamRunSession(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+session}:streamRunSession')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Tools {
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Tool> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Tool>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/tools')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Toolsets {
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Toolset> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Toolset>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/toolsets')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Apps$Toolsets$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListToolsetsResponse>,
    ...
    retrieveTools(
      params: Params$Resource$Projects$Locations$Apps$Toolsets$Retrievetools,
      options:
        MethodOptions | BodyResponseCallback<Schema$RetrieveToolsResponse>,
    ...
    retrieveTools(
      ...
      if (params.toolset !== undefined && params.toolset !== null) {
        validateMultiSegment('toolset', String(params.toolset));
        params.toolset = encodeWithoutSlashes(String(params.toolset));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+toolset}:retrieveTools')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Versions {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.message = new Resource$Projects$Locations$Apps$Versions$Message(
        this.context
      );
    }
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/versions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
     ...
     */
    getExtendedAgentCard(
      params: Params$Resource$Projects$Locations$Apps$Versions$Getextendedagentcard,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    getExtendedAgentCard(
      params?: Params$Resource$Projects$Locations$Apps$Versions$Getextendedagentcard,
    ...
    getExtendedAgentCard(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Apps$Versions$Getextendedagentcard
        | BodyResponseCallback<Schema$LfA2aV1AgentCard>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Apps$Versions$Getextendedagentcard;
      let options = (optionsOrCallback || {}) as MethodOptions;
    ...
    list(
      params: Params$Resource$Projects$Locations$Apps$Versions$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListAppVersionsResponse>,
    ...
    restore(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+name}:restore')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apps$Versions$Message {
     ...
     */
    send(
      params: Params$Resource$Projects$Locations$Apps$Versions$Message$Send,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    send(
      params?: Params$Resource$Projects$Locations$Apps$Versions$Message$Send,
    ...
    send(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Apps$Versions$Message$Send
        | BodyResponseCallback<Schema$LfA2aV1SendMessageResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Apps$Versions$Message$Send;
      let options = (optionsOrCallback || {}) as MethodOptions;
