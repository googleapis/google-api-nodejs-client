...
export namespace metastore_v2 {
  ...
  export class Resource$Projects$Locations$Services {
    ...
    alterLocation(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+service}:alterLocation').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    alterTableProperties(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+service}:alterTableProperties').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    exportMetadata(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+service}:exportMetadata').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    get(
      params?: Params$Resource$Projects$Locations$Services$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudMetastoreV2Service>>;
    get(
      params: Params$Resource$Projects$Locations$Services$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudMetastoreV2Service>,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2Service>
    ): void;
    get(
      params: Params$Resource$Projects$Locations$Services$Get,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2Service>
    ...
    get(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudMetastoreV2Service>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudMetastoreV2Service>(
          parameters
        );
      }
    }
    ...
    importMetadata(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:importMetadata').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudMetastoreV2ListServicesResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2ListServicesResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Services$List,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2ListServicesResponse>
    ...
    list(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudMetastoreV2ListServicesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudMetastoreV2ListServicesResponse>(
          parameters
        );
      }
    }
    ...
    moveTableToDatabase(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+service}:moveTableToDatabase').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    queryMetadata(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+service}:queryMetadata').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    restore(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+service}:restore').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Services$Backups {
    ...
    get(
      params?: Params$Resource$Projects$Locations$Services$Backups$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudMetastoreV2Backup>>;
    get(
      params: Params$Resource$Projects$Locations$Services$Backups$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudMetastoreV2Backup>,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2Backup>
    ): void;
    get(
      params: Params$Resource$Projects$Locations$Services$Backups$Get,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2Backup>
    ...
    get(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudMetastoreV2Backup>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudMetastoreV2Backup>(
          parameters
        );
      }
    }
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudMetastoreV2ListBackupsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2ListBackupsResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Services$Backups$List,
      callback: BodyResponseCallback<Schema$GoogleCloudMetastoreV2ListBackupsResponse>
    ...
    list(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudMetastoreV2ListBackupsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudMetastoreV2ListBackupsResponse>(
          parameters
        );
      }
    }
