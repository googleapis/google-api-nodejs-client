...
export namespace vision_v1p1beta1 {
  ...
  export class Resource$Files {
    ...
    annotate(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse>,
    ...
    annotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/files:annotate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudVisionV1p1beta1BatchAnnotateFilesResponse>(
          parameters
        );
      }
    }
    ...
    asyncBatchAnnotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/files:asyncBatchAnnotate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Images {
    ...
    annotate(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse>,
    ...
    annotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/images:annotate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudVisionV1p1beta1BatchAnnotateImagesResponse>(
          parameters
        );
      }
    }
    ...
    asyncBatchAnnotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/images:asyncBatchAnnotate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Files {
    ...
    annotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/files:annotate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    asyncBatchAnnotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1p1beta1/{+parent}/files:asyncBatchAnnotate'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export class Resource$Projects$Images {
    ...
    annotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1p1beta1/{+parent}/images:annotate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    asyncBatchAnnotate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1p1beta1/{+parent}/images:asyncBatchAnnotate'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
