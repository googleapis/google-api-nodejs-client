...
legacy application, please use [@google-cloud/ids](https://www.npmjs.com/package/@google-cloud/ids) instead.
The [@google-cloud/ids](https://www.npmjs.com/package/@google-cloud/ids) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/ids
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/ids/classes/Ids.html).
