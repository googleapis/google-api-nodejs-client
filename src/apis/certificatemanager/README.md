...
legacy application, please use [@google-cloud/certificate-manager](https://www.npmjs.com/package/@google-cloud/certificate-manager) instead.
The [@google-cloud/certificate-manager](https://www.npmjs.com/package/@google-cloud/certificate-manager) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/certificatemanager
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/certificatemanager/classes/Certificatemanager.html).
