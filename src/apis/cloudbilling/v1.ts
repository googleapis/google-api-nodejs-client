  ...
  export class Resource$Billingaccounts$Subaccounts {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/subAccounts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Organizations$Billingaccounts {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/billingAccounts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    move(
      ...
      if (
        params.destinationParent !== undefined &&
        params.destinationParent !== null
      ) {
        validateMultiSegment(
          'destinationParent',
          String(params.destinationParent)
        );
        params.destinationParent = encodeWithoutSlashes(
          String(params.destinationParent)
        );
      }
      if (params.name !== undefined && params.name !== null) {
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+destinationParent}/{+name}:move')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
