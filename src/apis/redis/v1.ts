...
export namespace redis_v1 {
  ...
  export class Resource$Projects$Locations$Aclpolicies {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/aclPolicies')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Backupcollections {
    ...
    get(
      params?: Params$Resource$Projects$Locations$Backupcollections$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$BackupCollection>>;
    get(
      params: Params$Resource$Projects$Locations$Backupcollections$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      params?: Params$Resource$Projects$Locations$Backupcollections$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListBackupCollectionsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Backupcollections$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/backupCollections')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Clusters {
    ...
    addTokenAuthUser(
      ...
      if (params.cluster !== undefined && params.cluster !== null) {
        validateMultiSegment('cluster', String(params.cluster));
        params.cluster = encodeWithoutSlashes(String(params.cluster));
      }
    ...
    rescheduleClusterMaintenance(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:rescheduleClusterMaintenance')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Clusters$Tokenauthusers {
    ...
    addAuthToken(
      ...
      if (params.tokenAuthUser !== undefined && params.tokenAuthUser !== null) {
        validateMultiSegment('tokenAuthUser', String(params.tokenAuthUser));
        params.tokenAuthUser = encodeWithoutSlashes(
          String(params.tokenAuthUser)
        );
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+tokenAuthUser}:addAuthToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/tokenAuthUsers')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Clusters$Tokenauthusers$Authtokens {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/authTokens')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Instances {
    ...
    getAuthString(
      params?: Params$Resource$Projects$Locations$Instances$Getauthstring,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$InstanceAuthString>>;
    getAuthString(
      params: Params$Resource$Projects$Locations$Instances$Getauthstring,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    getAuthString(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}/authString')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    rescheduleMaintenance(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:rescheduleMaintenance')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
