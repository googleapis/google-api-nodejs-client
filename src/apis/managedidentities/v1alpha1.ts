...
export namespace managedidentities_v1alpha1 {
  ...
  export class Resource$Projects$Locations$Global$Domains {
     ...
     * @desc Adds AD trust in a given domain. Operation<response: google.protobuf.Empty>
     * @alias managedidentities.projects.locations.global.domains.attachTrust
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.name The resource domain name, project name and location using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    ...
    attachTrust(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+name}:attachTrust').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     * @desc Creates a Microsoft AD Domain in a given project. Operation<response: google.protobuf.Empty>
     ...
     * @param {string} params.parent Resource project name and location using the form: `projects/{project_id}/locations/global`
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+parent}/domains').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     * @desc Deletes identified domain. Operation<response: google.protobuf.Empty>
     * @alias managedidentities.projects.locations.global.domains.delete
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.name Domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
     ...
     * @desc Removes identified trust. Operation<response: google.protobuf.Empty>
    ...
    detachTrust(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+name}:detachTrust').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     * @desc Gets details of a single Domain.
     ...
     * @desc Lists Domains in a given project.
     ...
     * @desc Updates the metadata and configuration of a specified domain. Operation<response: google.protobuf.Empty>
     ...
     * @desc Updates the dns conditional forwarder. Operation<response: google.protobuf.Empty>
    ...
    reconfigureTrust(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+name}:reconfigureTrust').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     * @desc Resets managed identities admin password identified by managed_identities_admin_name
     * @alias managedidentities.projects.locations.global.domains.resetAdminPassword
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.name The domain resource name using the form: `projects/{project_id}/locations/global/domains/{domain_name}`
    ...
    resetAdminPassword(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+name}:resetAdminPassword').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     * @desc Validate the trust state Operation<response: google.protobuf.Empty>
