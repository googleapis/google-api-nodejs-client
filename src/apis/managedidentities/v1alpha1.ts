  ...
  export class Resource$Projects$Locations$Global$Domains {
    ...
    checkMigrationPermission(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1alpha1/{+domain}:checkMigrationPermission'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    disableMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+domain}:disableMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    enableMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+domain}:enableMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    getLdapssettings(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+name}/ldapssettings').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    restore(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+name}:restore').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Global$Domains$Backups {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+parent}/backups').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Global$Peerings {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+parent}/peerings').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
