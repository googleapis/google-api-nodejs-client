...
export namespace recommender_v1 {
  ...
  export class Resource$Billingaccounts$Locations$Insighttypes {
    ...
    getConfig(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudRecommenderV1InsightTypeConfig>,
      callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1InsightTypeConfig>
    ): void;
    getConfig(
      params: Params$Resource$Billingaccounts$Locations$Insighttypes$Getconfig,
      callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1InsightTypeConfig>
    ...
    getConfig(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudRecommenderV1InsightTypeConfig>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudRecommenderV1InsightTypeConfig>(
          parameters
        );
      }
    }
  ...
  export class Resource$Billingaccounts$Locations$Insighttypes$Insights {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/insights')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    markAccepted(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:markAccepted')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Billingaccounts$Locations$Recommenders {
    ...
    getConfig(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudRecommenderV1RecommenderConfig>,
      callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1RecommenderConfig>
    ): void;
    getConfig(
      params: Params$Resource$Billingaccounts$Locations$Recommenders$Getconfig,
      callback: BodyResponseCallback<Schema$GoogleCloudRecommenderV1RecommenderConfig>
    ...
    getConfig(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudRecommenderV1RecommenderConfig>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudRecommenderV1RecommenderConfig>(
          parameters
        );
      }
    }
  ...
  export class Resource$Billingaccounts$Locations$Recommenders$Recommendations {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/recommendations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    markDismissed(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:markDismissed')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    markFailed(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:markFailed')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    markSucceeded(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:markSucceeded')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
