 ...
 * `/foo/variable1 = &quot;value1&quot;` + `/foo/variable2 = &quot;value2&quot;`
 * + `/bar/variable3 = &quot;value3&quot;`  It would not would not satisify the
 * same condition with the `number` set to 3, however, because there is only 2
...
export interface Schema$ListConfigsResponse {
   ...
   * the number of results is larger than `pageSize`, use the `nextPageToken` as
...
export interface Schema$RuntimeConfig {
   ...
   * valid project ID, and `[CONFIG_NAME]` is an arbitrary name that matches the
...
export interface Schema$Variable {
   ...
   * RuntimeConfig reource and `[VARIABLE_NAME]` follows Unix file system file
   * path naming.  The `[VARIABLE_NAME]` can contain ASCII letters, numbers,
   * slashes and dashes. Slashes are used as path element separators and are not
   * part of the `[VARIABLE_NAME]` itself, so `[VARIABLE_NAME]` must contain at
   * least one non-slash character. Multiple slashes are coalesced into single
   * slash character. Each path segment should match
   * [0-9A-Za-z](?:[_.A-Za-z0-9-]{0,62}[_.A-Za-z0-9])? regular expression. The
   ...
   * 4096 bytes. Empty values are also accepted. For example, `text: &quot;my
   ...
   * 4096 bytes. Empty values are also accepted. The value must be base64
 ...
 * the node&#39;s readiness as part of the startup process.  You then configure
 * a Waiter resource with the success condition set to wait until some number of
...
export interface Schema$Waiter {
   ...
   * `[PROJECT_ID]` must be a valid Google Cloud project ID, the `[CONFIG_NAME]`
   * must be a valid RuntimeConfig resource, the `[WAITER_NAME]` must match RFC
   * 1035 segment specification, and the length of `[WAITER_NAME]` must be less
   * than 64 bytes.  After you create a Waiter resource, you cannot change the
   * resource name.
   */
  name: string;
  /**
...
export class Resource$Projects$Configs {
   ...
   * @desc Creates a new RuntimeConfig resource. The configuration name must be
  ...
  create(params: any, options?: MethodOptions):
      AxiosPromise<Schema$RuntimeConfig>;
  create(
      params: any,
   ...
   * @return {object} Request object
   */
  get(params: any, options?: MethodOptions): AxiosPromise<Schema$RuntimeConfig>;
  get(params: any,
      options: MethodOptions|BodyResponseCallback<Schema$RuntimeConfig>,
      callback?: BodyResponseCallback<Schema$RuntimeConfig>): void;
  get(params: any,
  ...
  list(params: any, options?: MethodOptions):
      AxiosPromise<Schema$ListConfigsResponse>;
  list(
      params: any,
...
export class Resource$Projects$Configs$Variables {
   ...
   * @desc Creates a variable within the given configuration. You cannot create
   ...
   * @desc Deletes a variable or multiple variables.  If you specify a variable
   * name, then that variable is deleted. If you specify a prefix and
   ...
   * @desc Watches a specific variable and waits for a change in the variable's
   ...
   * @return {object} Request object
   */
  watch(params: any, options?: MethodOptions): AxiosPromise<Schema$Variable>;
  watch(
      params: any, options: MethodOptions|BodyResponseCallback<Schema$Variable>,
      callback?: BodyResponseCallback<Schema$Variable>): void;
  watch(
...
export class Resource$Projects$Configs$Waiters {
   ...
   * will still exist and must be deleted prior to subsequent creation attempts.
   ...
   * @return {object} Request object
   */
  get(params: any, options?: MethodOptions): AxiosPromise<Schema$Waiter>;
  get(params: any, options: MethodOptions|BodyResponseCallback<Schema$Waiter>,
   ...
   */
  list(params: any, options?: MethodOptions):
      AxiosPromise<Schema$ListWaitersResponse>;
  list(
      params: any,
