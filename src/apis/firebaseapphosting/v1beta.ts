...
export namespace firebaseapphosting_v1beta {
  ...
  export class Resource$Projects$Locations$Backends {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/backends').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    get(
      ...
      callback?:
        | BodyResponseCallback<Schema$Backend>
        | BodyResponseCallback<Readable>
    ): void | GaxiosPromise<Schema$Backend> | GaxiosPromise<Readable> {
      let params = (paramsOrCallback ||
    ...
    list(
      params?: Params$Resource$Projects$Locations$Backends$List,
      options?: MethodOptions
    ): GaxiosPromise<Schema$ListBackendsResponse>;
    list(
      params: Params$Resource$Projects$Locations$Backends$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Projects$Locations$Backends$Builds {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/builds').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Backends$Domains {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/domains').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Backends$Traffic {
    ...
    get(
      ...
      callback?:
        | BodyResponseCallback<Schema$Traffic>
        | BodyResponseCallback<Readable>
    ): void | GaxiosPromise<Schema$Traffic> | GaxiosPromise<Readable> {
      let params = (paramsOrCallback ||
