...
export namespace parallelstore_v1beta {
  ...
  export class Resource$Projects$Locations {
    ...
    get(
      ...
      const rootUrl =
        options.rootUrl || 'https://parallelstore.googleapis.com/';
      const parameters = {
  ...
  export class Resource$Projects$Locations$Instances {
     ...
     */
    exportData(
      params: Params$Resource$Projects$Locations$Instances$Exportdata,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    exportData(
      params?: Params$Resource$Projects$Locations$Instances$Exportdata,
    ...
    exportData(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Instances$Exportdata
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Instances$Exportdata;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Instances$Exportdata;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+name}:exportData').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     */
    importData(
      params: Params$Resource$Projects$Locations$Instances$Importdata,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    importData(
      params?: Params$Resource$Projects$Locations$Instances$Importdata,
    ...
    importData(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Instances$Importdata
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Instances$Importdata;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Instances$Importdata;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+name}:importData').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
