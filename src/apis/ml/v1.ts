 ...
 * @property {boolean} isTrialStoppedEarly True if the trial is stopped early.
 ...
 * @property {string} errorMessage Output only. The details of a failure or a cancellation.
 * @property {string} framework The ML framework used to train this version of the model. If not specified, defaults to `TENSORFLOW`
