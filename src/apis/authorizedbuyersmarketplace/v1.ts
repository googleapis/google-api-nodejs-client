  ...
  export class Resource$Bidders$Finalizeddeals {
    ...
    setReadyToServe(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+deal}:setReadyToServe')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Buyers$Auctionpackages {
    ...
    subscribeClients(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+auctionPackage}:subscribeClients')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    unsubscribe(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:unsubscribe')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    unsubscribeClients(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+auctionPackage}:unsubscribeClients')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Buyers$Finalizeddeals {
    ...
    addCreative(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+deal}:addCreative')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Buyers$Proposals {
    ...
    addNote(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+proposal}:addNote')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    sendRfp(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+buyer}/proposals:sendRfp')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Buyers$Publisherprofiles {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/publisherProfiles')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
