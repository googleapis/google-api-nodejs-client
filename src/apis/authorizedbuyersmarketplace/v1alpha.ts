...
export namespace authorizedbuyersmarketplace_v1alpha {
  ...
  export class Resource$Buyers$Datasegments {
    ...
    activate(
      params?: Params$Resource$Buyers$Datasegments$Activate,
      options?: MethodOptions
    ): GaxiosPromise<Schema$DataSegment>;
    activate(
      params: Params$Resource$Buyers$Datasegments$Activate,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    activate(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$DataSegment>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
    ...
    list(
      params?: Params$Resource$Buyers$Datasegments$List,
      options?: MethodOptions
    ): GaxiosPromise<Schema$ListDataSegmentsResponse>;
    list(
      params: Params$Resource$Buyers$Datasegments$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$ListDataSegmentsResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
  ...
  export interface Params$Resource$Buyers$Datasegments$List
    extends StandardParameters {
    /**
