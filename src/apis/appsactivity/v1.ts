...
export namespace appsactivity_v1 {
  ...
  export class Resource$Activities {
     ...
     * @param {string=} params.drive.ancestorId Identifies the Drive folder
     *     containing the items for which to return activities.
     * @param {string=} params.drive.fileId Identifies the Drive item to return
     *     activities for.
     * @param {string=} params.groupingStrategy Indicates the strategy to use
     *     when grouping singleEvents items in the associated combinedEvent
     *     object.
     * @param {integer=} params.pageSize The maximum number of events to return
     *     on a page. The response includes a continuation token if there are
     *     more events.
     * @param {string=} params.pageToken A token to retrieve a specific page of
     *     results.
     * @param {string=} params.source The Google service from which to return
     *     activities. Possible values of source are:  - drive.google.com
     * @param {string=} params.userId Indicates the user to return activity for.
     *     Use the special value me to indicate the currently authenticated
     *     user.
