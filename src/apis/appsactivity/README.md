...
```sh
$ npm install @googleapis/appsactivity
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/appsactivity/classes/Appsactivity.html).
...
```html
<script src="/path/to/appsactivity.min.js"></script>
<script>
const { appsactivity, auth } = Appsactivity;
</script>
```
