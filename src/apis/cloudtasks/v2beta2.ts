    ...
    locations: {
      ...
      get(params, options, callback) {
        ...
        return createAPIRequest(parameters, callback);
          ...
          * `locationsPage`: console.log(JSON.stringify(locationsPage[i], null,
          * 2));
          *     }
          *
      ...
      queues: {
        ...
        create(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * same name can't be created for 7 days.  WARNING: Using this method
            ...
            * queue.yaml](/cloud-tasks/docs/queue-yaml) before using this
            * method.
            * @example
            * // BEFORE RUNNING:
            * // ---------------
        ...
        get(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * Authorization requires the following [Google IAM](/iam) permission
        ...
        list(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * not exist and updates the queue if it does exist.  Queues created
            * with this method allow tasks to live for a maximum of 31 days.
            * After a task is 31 days old, the task will be deleted regardless
            * of whether it was dispatched or not.  WARNING: Using this method
            * may have unintended side effects if you are using an App Engine
            * `queue.yaml` or `queue.xml` file to manage your queues. Read
            * [Overview of Queue Management and
            * queue.yaml](/cloud-tasks/docs/queue-yaml) before using this
            ...
            *     // numbers, hyphens, colons, and periods; that is, it must
            * match
            ...
            *     // characters.
            *     // Caller-specified and required in CreateQueueRequest, after
            * which
        ...
        pause(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * created before this method is called are permanently deleted.
        ...
        purge(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * been PAUSED or DISABLED. The state of a queue is stored in the
            * queue's state; after calling this method it will be set to
            * RUNNING.  WARNING: Resuming many high-QPS queues at the same time
            * can lead to target overloading. If you are resuming high-QPS
            * queues, follow the 500/50/5 pattern described in [Managing Cloud
            * Tasks Scaling
        ...
        resume(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * existing policy.  Note: The Cloud Console does not check
            ...
            * following [Google IAM](/iam) permission on the specified resource
        ...
        setIamPolicy(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * permissions, not a NOT_FOUND error.  Note: This operation is
        ...
        tasks: {
          ...
          acknowledge(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * method to cancel a task's lease by setting its schedule_time to
              * now. This will make the task available to be leased to the next
          ...
          cancelLease(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * batching](/storage/docs/json_api/v1/how-tos/batch) or the
              * batching documentation for your client library, for example
              * https://developers.google.com/api-client-library/python/guide/batch.
              * Tasks cannot be updated after creation; there is no UpdateTask
              * command.  * For [App Engine
              * queues](google.cloud.tasks.v2beta2.AppEngineHttpTarget),   the
              * maximum task size is 100KB. * For [pull
              * queues](google.cloud.tasks.v2beta2.PullTarget), this   the
          ...
          create(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * or dispatched. A task cannot be deleted if it has completed
          ...
          get(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * method is invoked by the worker to obtain a lease. The worker
              * must acknowledge the task via AcknowledgeTask after they have
              * performed the work associated with the task.  The payload is
              * intended to store data that the worker needs to perform the work
              * associated with the task. To return the payloads in the
              * response, set response_view to FULL.  A maximum of 10 qps of
              * LeaseTasks requests are allowed per queue. RESOURCE_EXHAUSTED is
              * returned when this limit is exceeded. RESOURCE_EXHAUSTED is also
          ...
          lease(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * response_view controls the subset of information which is
              * returned.
              * @example
              * // BEFORE RUNNING:
              * // ---------------
              ...
              *       // TODO: Change code below to process each resource in
              * `tasksPage`: console.log(JSON.stringify(tasksPage[i], null, 2));
              *     }
              *
              *     if (response.nextPageToken) {
              *       request.pageToken = response.nextPageToken;
          ...
          list(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * use this method to extend the lease by a new duration, starting
              * from now. The new task lease will be returned in the task's
              * schedule_time.
              * @example
              * // BEFORE RUNNING:
              * // ---------------
          ...
          renewLease(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * used for manual debugging. For example, RunTask can be used to
              * retry a failed task after a fix has been made or to manually
              * force a task to be dispatched now.  When this method is called,
              * Cloud Tasks will dispatch the task to its target, even if the
              * queue is PAUSED.  The dispatched task is returned. That is, the
              * task that is returned contains the status after the task is
              * dispatched but before the task is received by its target.  If
              * Cloud Tasks receives a successful response from the task's
              ...
              * plus the retry delay specified in the queue and task's
              * RetryConfig.  RunTask returns NOT_FOUND when it is called on a
              * task that has already succeeded or permanently failed.
              * FAILED_PRECONDITION is returned when RunTask is called on task
              * that is dispatched or already running.  RunTask cannot be called
              * on pull tasks.
              * @example
              * // BEFORE RUNNING:
              * // ---------------
 ...
 * @memberOf! cloudtasks(v2beta2)
 * @type object
 * @property {string} scheduleTime Required.  The task&#39;s current schedule time, available in the schedule_time returned by LeaseTasks response or RenewLease response. This restriction is to ensure that your worker currently holds the lease.
 */
/**
 * @typedef AppEngineHttpRequest
 * @memberOf! cloudtasks(v2beta2)
 * @type object
 * @property {cloudtasks(v2beta2).AppEngineRouting} appEngineRouting Task-level setting for App Engine routing.  If set, app_engine_routing_override is used for all tasks in the queue, no matter what the setting is for the task-level app_engine_routing.
 ...
 * @property {string} service App service.  By default, the task is sent to the service which is the default service when the task is attempted (&quot;default&quot;).  For some queues or tasks which were created using the App Engine Task Queue API, host is not parsable into service, version, and instance. For example, some tasks which were created using the App Engine SDK use a custom domain name; custom domains are not parsed by Cloud Tasks. If host is not parsable, then service, version, and instance are the empty string.
 * @property {string} version App version.  By default, the task is sent to the version which is the default version when the task is attempted (&quot;default&quot;).  For some queues or tasks which were created using the App Engine Task Queue API, host is not parsable into service, version, and instance. For example, some tasks which were created using the App Engine SDK use a custom domain name; custom domains are not parsed by Cloud Tasks. If host is not parsable, then service, version, and instance are the empty string.
 */
/**
 ...
 * @property {cloudtasks(v2beta2).Status} responseStatus Output only. The response from the target for this attempt.  If the task has not been attempted or the task is currently running then the response status is unset.
 ...
 * @property {string} leaseDuration  After the worker has successfully finished the work associated with the task, the worker must call via AcknowledgeTask before the schedule_time. Otherwise the task will be returned to a later LeaseTasks call so that another worker can retry it.  The maximum lease duration is 1 week. `lease_duration` will be truncated to the nearest second.
 ...
 * @memberOf! cloudtasks(v2beta2)
 * @type object
 * @property {string} nextPageToken A token to retrieve next page of results.  To return the next page of results, call ListQueues with this value as the page_token.  If the next_page_token is empty, there are no more results.  The page token is valid for only 2 hours.
 ...
 * @memberOf! cloudtasks(v2beta2)
 * @type object
 * @property {string} nextPageToken A token to retrieve next page of results.  To return the next page of results, call ListTasks with this value as the page_token.  If the next_page_token is empty, there are no more results.
 ...
 * @property {string} tag The task&#39;s tag.  Tags allow similar tasks to be processed in a batch. If you label tasks with a tag, your worker can lease tasks with the same tag using filter. For example, if you want to aggregate the events associated with a specific user once a day, you could tag tasks with the user ID.  The task&#39;s tag can only be set when the task is created.  The tag must be less than 500 characters.  SDK compatibility: Although the SDK allows tags to be either string or [bytes](/appengine/docs/standard/java/javadoc/com/google/appengine/api/taskqueue/TaskOptions.html#tag-byte:A-), only UTF-8 encoded tags can be used in Cloud Tasks. If a tag isn&#39;t UTF-8 encoded, the tag will be empty when the task is returned by Cloud Tasks.
 */
/**
 * @typedef PullTarget
 * @memberOf! cloudtasks(v2beta2)
 ...
 * @property {cloudtasks(v2beta2).RateLimits} rateLimits Rate limits for task dispatches.  rate_limits and retry_config are related because they both control task attempts however they control how tasks are attempted in different ways:  * rate_limits controls the total rate of   dispatches from a queue (i.e. all traffic dispatched from the   queue, regardless of whether the dispatch is from a first   attempt or a retry). * retry_config controls what happens to   particular a task after its first attempt fails. That is,   retry_config controls task retries (the   second attempt, third attempt, etc).
 ...
 * @property {string} maxBackoff A task will be [scheduled](Task.schedule_time) for retry between min_backoff and max_backoff duration after it fails, if the queue&#39;s RetryConfig specifies that the task should be retried.  If unspecified when the queue is created, Cloud Tasks will pick the default.  This field is output only for [pull queues](google.cloud.tasks.v2beta2.PullTarget).   `max_backoff` will be truncated to the nearest second.  This field has the same meaning as [max_backoff_seconds in queue.yaml/xml](/appengine/docs/standard/python/config/queueref#retry_parameters).
 * @property {integer} maxDoublings The time between retries will double `max_doublings` times.  A task&#39;s retry interval starts at min_backoff, then doubles `max_doublings` times, then increases linearly, and finally retries retries at intervals of max_backoff up to max_attempts times.  For example, if min_backoff is 10s, max_backoff is 300s, and `max_doublings` is 3, then the a task will first be retried in 10s. The retry interval will double three times, and then increase linearly by 2^3 * 10s.  Finally, the task will retry at intervals of max_backoff until the task has been attempted max_attempts times. Thus, the requests will retry at 10s, 20s, 40s, 80s, 160s, 240s, 300s, 300s, ....  If unspecified when the queue is created, Cloud Tasks will pick the default.  This field is output only for [pull queues](google.cloud.tasks.v2beta2.PullTarget).   This field has the same meaning as [max_doublings in queue.yaml/xml](/appengine/docs/standard/python/config/queueref#retry_parameters).
 * @property {string} maxRetryDuration If positive, `max_retry_duration` specifies the time limit for retrying a failed task, measured from when the task was first attempted. Once `max_retry_duration` time has passed *and* the task has been attempted max_attempts times, no further attempts will be made and the task will be deleted.  If zero, then the task age is unlimited.  If unspecified when the queue is created, Cloud Tasks will pick the default.  This field is output only for [pull queues](google.cloud.tasks.v2beta2.PullTarget).   `max_retry_duration` will be truncated to the nearest second.  This field has the same meaning as [task_age_limit in queue.yaml/xml](/appengine/docs/standard/python/config/queueref#retry_parameters).
 * @property {string} minBackoff A task will be [scheduled](Task.schedule_time) for retry between min_backoff and max_backoff duration after it fails, if the queue&#39;s RetryConfig specifies that the task should be retried.  If unspecified when the queue is created, Cloud Tasks will pick the default.  This field is output only for [pull queues](google.cloud.tasks.v2beta2.PullTarget).   `min_backoff` will be truncated to the nearest second.  This field has the same meaning as [min_backoff_seconds in queue.yaml/xml](/appengine/docs/standard/python/config/queueref#retry_parameters).
 ...
 * @memberOf! cloudtasks(v2beta2)
 * @type object
 * @property {cloudtasks(v2beta2).AppEngineHttpRequest} appEngineHttpRequest App Engine HTTP request that is sent to the task&#39;s target. Can be set only if app_engine_http_target is set on the queue.  An App Engine task is a task that has AppEngineHttpRequest set.
 ...
 * @property {cloudtasks(v2beta2).AttemptStatus} firstAttemptStatus Output only. The status of the task&#39;s first attempt.  Only dispatch_time will be set. The other AttemptStatus information is not retained by Cloud Tasks.  This field is not calculated for [pull tasks](google.cloud.tasks.v2beta2.PullTaskTarget).
