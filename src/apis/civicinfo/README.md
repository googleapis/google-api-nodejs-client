...
```sh
$ npm install @googleapis/civicinfo
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/civicinfo/classes/Civicinfo.html).
...
```html
<script src="/path/to/civicinfo.min.js"></script>
<script>
const { civicinfo, auth } = Civicinfo;
</script>
```
