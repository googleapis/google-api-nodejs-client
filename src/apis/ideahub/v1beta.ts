...
export namespace ideahub_v1beta {
  ...
  export class Resource$Platforms$Properties$Ideaactivities {
    ...
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleSearchIdeahubV1betaIdeaActivity>>;
    create(
      params: Params$Resource$Platforms$Properties$Ideaactivities$Create,
  ...
  export class Resource$Platforms$Properties$Ideas {
    ...
    list(
      params?: Params$Resource$Platforms$Properties$Ideas$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleSearchIdeahubV1betaListIdeasResponse>>;
    list(
      params: Params$Resource$Platforms$Properties$Ideas$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaListIdeasResponse>,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaListIdeasResponse>
    ): void;
    list(
      params: Params$Resource$Platforms$Properties$Ideas$List,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaListIdeasResponse>
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/ideas').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleSearchIdeahubV1betaListIdeasResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleSearchIdeahubV1betaListIdeasResponse>(
          parameters
        );
      }
    }
  ...
  export class Resource$Platforms$Properties$Ideastates {
    ...
    patch(
      params?: Params$Resource$Platforms$Properties$Ideastates$Patch,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleSearchIdeahubV1betaIdeaState>>;
    patch(
      params: Params$Resource$Platforms$Properties$Ideastates$Patch,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    patch(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaIdeaState>,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaIdeaState>
    ): void;
    patch(
      params: Params$Resource$Platforms$Properties$Ideastates$Patch,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaIdeaState>
    ...
    patch(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleSearchIdeahubV1betaIdeaState>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleSearchIdeahubV1betaIdeaState>(
          parameters
        );
      }
    }
  ...
  export class Resource$Platforms$Properties$Locales {
    ...
    list(
      params?: Params$Resource$Platforms$Properties$Locales$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleSearchIdeahubV1betaListAvailableLocalesResponse>>;
    list(
      params: Params$Resource$Platforms$Properties$Locales$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaListAvailableLocalesResponse>,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaListAvailableLocalesResponse>
    ): void;
    list(
      params: Params$Resource$Platforms$Properties$Locales$List,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaListAvailableLocalesResponse>
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/locales').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleSearchIdeahubV1betaListAvailableLocalesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleSearchIdeahubV1betaListAvailableLocalesResponse>(
          parameters
        );
      }
    }
  ...
  export class Resource$Platforms$Properties$Topicstates {
    ...
    patch(
      params?: Params$Resource$Platforms$Properties$Topicstates$Patch,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleSearchIdeahubV1betaTopicState>>;
    patch(
      params: Params$Resource$Platforms$Properties$Topicstates$Patch,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    patch(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaTopicState>,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaTopicState>
    ): void;
    patch(
      params: Params$Resource$Platforms$Properties$Topicstates$Patch,
      callback: BodyResponseCallback<Schema$GoogleSearchIdeahubV1betaTopicState>
    ...
    patch(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleSearchIdeahubV1betaTopicState>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleSearchIdeahubV1betaTopicState>(
          parameters
        );
      }
    }
