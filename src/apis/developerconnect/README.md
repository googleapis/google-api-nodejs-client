...
legacy application, please use [@google-cloud/developerconnect](https://www.npmjs.com/package/@google-cloud/developerconnect) instead.
The [@google-cloud/developerconnect](https://www.npmjs.com/package/@google-cloud/developerconnect) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/developerconnect
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/developerconnect/classes/Developerconnect.html).
