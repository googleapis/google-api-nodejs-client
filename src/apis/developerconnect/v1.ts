...
export namespace developerconnect_v1 {
  ...
  export class Resource$Projects$Locations$Accountconnectors {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/accountConnectors')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchUserRepositories(
      ...
      if (
        params.accountConnector !== undefined &&
        params.accountConnector !== null
      ) {
        validateMultiSegment(
          'accountConnector',
          String(params.accountConnector)
        );
        params.accountConnector = encodeWithoutSlashes(
          String(params.accountConnector)
        );
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+accountConnector}:fetchUserRepositories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Accountconnectors$Users {
    ...
    deleteSelf(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}/users:deleteSelf')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'DELETE',
            apiVersion: '',
    ...
    fetchAccessToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+accountConnector}/users:fetchAccessToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchSelf(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}/users:fetchSelf')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    finishOAuthFlow(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+accountConnector}/users:finishOAuthFlow')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    startOAuthFlow(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+accountConnector}/users:startOAuthFlow')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Connections {
    ...
    fetchGitHubInstallations(
      ...
      if (params.connection !== undefined && params.connection !== null) {
        validateMultiSegment('connection', String(params.connection));
        params.connection = encodeWithoutSlashes(String(params.connection));
      }
    ...
    fetchLinkableGitRepositories(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+connection}:fetchLinkableGitRepositories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Connections$Gitrepositorylinks {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/gitRepositoryLinks')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchGitRefs(
      ...
      if (
        params.gitRepositoryLink !== undefined &&
        params.gitRepositoryLink !== null
      ) {
        validateMultiSegment(
          'gitRepositoryLink',
          String(params.gitRepositoryLink)
        );
        params.gitRepositoryLink = encodeWithoutSlashes(
          String(params.gitRepositoryLink)
        );
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+gitRepositoryLink}:fetchGitRefs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    fetchReadToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+gitRepositoryLink}:fetchReadToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchReadWriteToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+gitRepositoryLink}:fetchReadWriteToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    processBitbucketCloudWebhook(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:processBitbucketCloudWebhook')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    processGitLabEnterpriseWebhook(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:processGitLabEnterpriseWebhook')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    processGitLabWebhook(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:processGitLabWebhook')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Insightsconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/insightsConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Insightsconfigs$Deploymentevents {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/deploymentEvents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
