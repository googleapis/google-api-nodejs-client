...
```sh
$ npm install @googleapis/firebasehosting
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/firebasehosting/classes/Firebasehosting.html).
...
```html
<script src="/path/to/firebasehosting.min.js"></script>
<script>
const { firebasehosting, auth } = Firebasehosting;
</script>
```
