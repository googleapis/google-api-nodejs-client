...
export namespace oslogin_v1beta {
  ...
  export class Resource$Projects$Locations {
    ...
    signSshPublicKey(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse>
    ): void;
    signSshPublicKey(
      params: Params$Resource$Projects$Locations$Signsshpublickey,
      callback: BodyResponseCallback<Schema$GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse>
    ...
    signSshPublicKey(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}:signSshPublicKey')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudOsloginControlplaneRegionalV1betaSignSshPublicKeyResponse>(
          parameters
        );
      }
    }
  ...
  export class Resource$Users$Projects$Locations {
     ...
     *
     *   // Do the magic
     *   const res = await oslogin.users.projects.locations.signSshPublicKey({
     *     // Required. The parent project and region for the signing request.
     *     parent: 'users/my-user/projects/my-project/locations/my-location',
     *
     *     // Request body metadata
     *     requestBody: {
     *       // request body parameters
    ...
    signSshPublicKey(
      paramsOrCallback?:
        | Params$Resource$Users$Projects$Locations$Signsshpublickey
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Users$Projects$Locations$Signsshpublickey;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export class Resource$Users$Sshpublickeys {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/sshPublicKeys')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
