...
export namespace oslogin_v1alpha {
  ...
  export class Resource$Projects$Locations {
    ...
    signSshPublicKey(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse>
    >;
    signSshPublicKey(
      params: Params$Resource$Projects$Locations$Signsshpublickey,
    ...
    signSshPublicKey(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}:signSshPublicKey')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Users$Sshpublickeys {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/sshPublicKeys')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
