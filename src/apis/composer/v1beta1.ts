  ...
  export class Resource$Projects$Locations$Environments {
    ...
    checkUpgrade(
      ...
      if (params.environment !== undefined && params.environment !== null) {
        validateMultiSegment('environment', String(params.environment));
        params.environment = encodeWithoutSlashes(String(params.environment));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+environment}:checkUpgrade')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    databaseFailover(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+environment}:databaseFailover')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    executeAirflowCommand(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+environment}:executeAirflowCommand')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    loadSnapshot(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+environment}:loadSnapshot')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    pollAirflowCommand(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+environment}:pollAirflowCommand')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    restartWebServer(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:restartWebServer')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    saveSnapshot(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+environment}:saveSnapshot')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Environments$Userworkloadsconfigmaps {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/userWorkloadsConfigMaps')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Environments$Userworkloadssecrets {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/userWorkloadsSecrets')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
