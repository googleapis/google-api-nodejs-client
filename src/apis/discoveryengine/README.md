...
legacy application, please use [@google-cloud/discoveryengine](https://www.npmjs.com/package/@google-cloud/discoveryengine) instead.
The [@google-cloud/discoveryengine](https://www.npmjs.com/package/@google-cloud/discoveryengine) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/discoveryengine
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/discoveryengine/classes/Discoveryengine.html).
