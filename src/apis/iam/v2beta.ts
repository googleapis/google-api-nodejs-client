...
export namespace iam_v2beta {
  ...
  export class Resource$Policies {
    ...
    get(
      params?: Params$Resource$Policies$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleIamV2betaPolicy>>;
    get(
      params: Params$Resource$Policies$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleIamV2betaPolicy>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleIamV2betaPolicy>(parameters);
      }
    }
    ...
    listPolicies(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleIamV2betaListPoliciesResponse>,
      callback: BodyResponseCallback<Schema$GoogleIamV2betaListPoliciesResponse>
    ): void;
    listPolicies(
      params: Params$Resource$Policies$Listpolicies,
      callback: BodyResponseCallback<Schema$GoogleIamV2betaListPoliciesResponse>
    ...
    listPolicies(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleIamV2betaListPoliciesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleIamV2betaListPoliciesResponse>(
          parameters
        );
      }
    }
