...
export namespace checks_v1alpha {
  ...
  export class Resource$Accounts$Apps {
    ...
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChecksAccountV1alphaApp>>;
    get(
      params: Params$Resource$Accounts$Apps$Get,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/apps')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Apps$Reports {
    ...
    get(
      params?: Params$Resource$Accounts$Apps$Reports$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChecksReportV1alphaReport>>;
    get(
      params: Params$Resource$Accounts$Apps$Reports$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Accounts$Repos$Scans {
    ...
    generate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/scans:generate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/scans')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Aisafety {
    ...
    classifyContent(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/aisafety:classifyContent')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Media {
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/reports:analyzeUpload')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1alpha/{+parent}/reports:analyzeUpload')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
