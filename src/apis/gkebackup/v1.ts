...
export namespace gkebackup_v1 {
  ...
  export class Resource$Projects$Locations$Backupchannels {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/backupChannels')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Backupchannels$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListBackupChannelsResponse>,
  ...
  export class Resource$Projects$Locations$Backupchannels$Backupplanbindings {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/backupPlanBindings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Backupplans$Backups {
    ...
    getBackupIndexDownloadUrl(
      ...
      if (params.backup !== undefined && params.backup !== null) {
        validateMultiSegment('backup', String(params.backup));
        params.backup = encodeWithoutSlashes(String(params.backup));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+backup}:getBackupIndexDownloadUrl')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Backupplans$Backups$Volumebackups {
    ...
    list(
      params: Params$Resource$Projects$Locations$Backupplans$Backups$Volumebackups$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListVolumeBackupsResponse>,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/volumeBackups')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Restorechannels {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/restoreChannels')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Restorechannels$Restoreplanbindings {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/restorePlanBindings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Restoreplans {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/restorePlans')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Restoreplans$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListRestorePlansResponse>,
  ...
  export class Resource$Projects$Locations$Restoreplans$Restores {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/restores')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    get(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Restore> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Restore>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
    ...
    list(
      params: Params$Resource$Projects$Locations$Restoreplans$Restores$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListRestoresResponse>,
  ...
  export class Resource$Projects$Locations$Restoreplans$Restores$Volumerestores {
    ...
    list(
      params: Params$Resource$Projects$Locations$Restoreplans$Restores$Volumerestores$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListVolumeRestoresResponse>,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/volumeRestores')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
