...
legacy application, please use [@google-cloud/gke-backup](https://www.npmjs.com/package/@google-cloud/gke-backup) instead.
The [@google-cloud/gke-backup](https://www.npmjs.com/package/@google-cloud/gke-backup) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/gkebackup
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/gkebackup/classes/Gkebackup.html).
