...
```sh
$ cd src/apis/replicapool
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/replicapool.min.js`. Use it from your HTML file:

```html
<script src="/path/to/replicapool.min.js"></script>
<script>
const { replicapool, auth } = Replicapool;
</script>
```
