...
export namespace notebooks_v2 {
  ...
  export class Resource$Projects$Locations$Instances {
    ...
    checkAuthorization(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:checkAuthorization')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    checkUpgradability(
      ...
      if (
        params.notebookInstance !== undefined &&
        params.notebookInstance !== null
      ) {
        validateMultiSegment(
          'notebookInstance',
          String(params.notebookInstance)
        );
        params.notebookInstance = encodeWithoutSlashes(
          String(params.notebookInstance)
        );
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+notebookInstance}:checkUpgradability')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    generateAccessToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:generateAccessToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}/instances:getConfig')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    reportInfoSystem(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:reportInfoSystem')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    resizeDisk(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+notebookInstance}:resizeDisk')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    upgradeSystem(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:upgradeSystem')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export interface Params$Resource$Projects$Locations$Instances$Checkauthorization extends StandardParameters {
    /**
     * Required. The name of the Notebook Instance resource. Format: `projects/{project\}/locations/{location\}/instances/{instance\}`
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Instances$Checkupgradability extends StandardParameters {
    /**
     * Required. Format: `projects/{project_id\}/locations/{location\}/instances/{instance_id\}`
     */
  ...
  export interface Params$Resource$Projects$Locations$Instances$Generateaccesstoken extends StandardParameters {
    /**
     * Required. Format: `projects/{project\}/locations/{location\}/instances/{instance_id\}`
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Instances$Getconfig extends StandardParameters {
    /**
     * Required. Format: `projects/{project_id\}/locations/{location\}`
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Instances$Reportinfosystem extends StandardParameters {
    /**
     * Required. Format: `projects/{project_id\}/locations/{location\}/instances/{instance_id\}`
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Instances$Resizedisk extends StandardParameters {
    /**
     * Required. Format: `projects/{project_id\}/locations/{location\}/instances/{instance_id\}`
     */
    notebookInstance?: string;
  ...
  export interface Params$Resource$Projects$Locations$Instances$Upgradesystem extends StandardParameters {
    /**
     * Required. Format: `projects/{project_id\}/locations/{location\}/instances/{instance_id\}`
     */
    name?: string;
