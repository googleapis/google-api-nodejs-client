...
```sh
$ npm install @googleapis/alertcenter
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/alertcenter/classes/Alertcenter.html).
...
```html
<script src="/path/to/alertcenter.min.js"></script>
<script>
const { alertcenter, auth } = Alertcenter;
</script>
```
