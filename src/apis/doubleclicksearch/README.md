...
```sh
$ npm install @googleapis/doubleclicksearch
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/doubleclicksearch/classes/Doubleclicksearch.html).
...
```html
<script src="/path/to/doubleclicksearch.min.js"></script>
<script>
const { doubleclicksearch, auth } = Doubleclicksearch;
</script>
```
