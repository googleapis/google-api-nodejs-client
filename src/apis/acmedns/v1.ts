...
export namespace acmedns_v1 {
  ...
  export class Resource$Acmechallengesets {
     ...
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/acmedns.googleapis.com
     ...
     *
     *   // Do the magic
     *   const res = await acmedns.acmeChallengeSets.get({
     ...
     *
     *   // Do the magic
     *   const res = await acmedns.acmeChallengeSets.rotateChallenges({
