...
export interface Schema$AutoText {
     ...
     */
        suggestedTextStyleChanges?: { [key: string]: Schema$SuggestedTextStyle; }|null;
        /**
...
export interface Schema$Document {
     ...
     */
        suggestedDocumentStyleChanges?: { [key: string]: Schema$SuggestedDocumentStyle; }|null;
        /**
     * Output only. The suggested changes to the named styles of the document, keyed by suggestion ID.
     */
        suggestedNamedStylesChanges?: { [key: string]: Schema$SuggestedNamedStyles; }|null;
        /**
...
export interface Schema$InlineObject {
     ...
     */
        suggestedInlineObjectPropertiesChanges?: { [key: string]: Schema$SuggestedInlineObjectProperties; }|null;
        /**
...
export interface Schema$List {
     ...
     */
        suggestedListPropertiesChanges?: { [key: string]: Schema$SuggestedListProperties; }|null;
  }
/**
...
export interface Schema$Paragraph {
     ...
     */
        suggestedParagraphStyleChanges?: { [key: string]: Schema$SuggestedParagraphStyle; }|null;
        /**
     * The IDs of the positioned objects that are suggested to be attached to this paragraph, keyed by suggestion ID.
     */
        suggestedPositionedObjectIds?: { [key: string]: Schema$ObjectReferences; }|null;
  }
/**
...
export interface Schema$PositionedObject {
     ...
     */
        suggestedPositionedObjectPropertiesChanges?: { [key: string]: Schema$SuggestedPositionedObjectProperties; }|null;
  }
/**
...
export interface Schema$TableCell {
     ...
     */
        suggestedTableCellStyleChanges?: { [key: string]: Schema$SuggestedTableCellStyle; }|null;
        /**
...
export interface Schema$TableRow {
     ...
     */
        suggestedTableRowStyleChanges?: { [key: string]: Schema$SuggestedTableRowStyle; }|null;
        /**
...
create(paramsOrCallback?: Params$Resource$Documents$Create|BodyResponseCallback<Schema$Document>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$Document>, callback?: BodyResponseCallback<Schema$Document>): void|GaxiosPromise<Schema$Document> {
...
get(paramsOrCallback?: Params$Resource$Documents$Get|BodyResponseCallback<Schema$Document>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$Document>, callback?: BodyResponseCallback<Schema$Document>): void|GaxiosPromise<Schema$Document> {
