  ...
  export class Resource$Projects$Locations$Repositories {
    ...
    checkPrewarmedArtifact(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+repository}:checkPrewarmedArtifact')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    exportArtifact(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+repository}:exportArtifact')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    prewarmArtifact(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+repository}:prewarmArtifact')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    removePrewarmedArtifact(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+repository}:removePrewarmedArtifact')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Aptartifacts {
    ...
    import(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/aptArtifacts:import')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/aptArtifacts:create')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/aptArtifacts:create')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
  ...
  export class Resource$Projects$Locations$Repositories$Attachments {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/attachments')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Files {
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/files:upload')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/files:upload')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
  ...
  export class Resource$Projects$Locations$Repositories$Genericartifacts {
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/genericArtifacts:create')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/genericArtifacts:create')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
  ...
  export class Resource$Projects$Locations$Repositories$Gomodules {
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/goModules:create')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/goModules:create')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
  ...
  export class Resource$Projects$Locations$Repositories$Googetartifacts {
    ...
    import(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/googetArtifacts:import')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/googetArtifacts:create')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/googetArtifacts:create')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
  ...
  export class Resource$Projects$Locations$Repositories$Kfpartifacts {
    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/kfpArtifacts:create')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/kfpArtifacts:create')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
  ...
  export class Resource$Projects$Locations$Repositories$Mavenartifacts {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/mavenArtifacts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Npmpackages {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/npmPackages')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Packages {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/packages')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Packages$Versions {
    ...
    batchDelete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/versions:batchDelete')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Prewarmedartifacts {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/prewarmedArtifacts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Pythonpackages {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/pythonPackages')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Yumartifacts {
    ...
    import(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/yumArtifacts:import')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    upload(
      ...
      const parameters = {
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+parent}/yumArtifacts:create')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['parent'],
        pathParams: ['parent'],
