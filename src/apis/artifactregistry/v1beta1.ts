...
export namespace artifactregistry_v1beta1 {
  ...
  export class Resource$Projects$Locations$Repositories {
    ...
    get(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Schema$Repository>,
      callback?: BodyResponseCallback<Schema$Repository>
    ): void | GaxiosPromise<Schema$Repository> {
      let params = (paramsOrCallback ||
      ...
      if (callback) {
        createAPIRequest<Schema$Repository>(parameters, callback);
      } else {
    ...
    list(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Schema$ListRepositoriesResponse>,
      callback?: BodyResponseCallback<Schema$ListRepositoriesResponse>
    ): void | GaxiosPromise<Schema$ListRepositoriesResponse> {
      let params = (paramsOrCallback ||
      ...
      if (callback) {
        createAPIRequest<Schema$ListRepositoriesResponse>(parameters, callback);
      } else {
  ...
  export class Resource$Projects$Locations$Repositories$Files {
    ...
    list(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Schema$ListFilesResponse>,
      callback?: BodyResponseCallback<Schema$ListFilesResponse>
    ): void | GaxiosPromise<Schema$ListFilesResponse> {
      let params = (paramsOrCallback ||
      ...
      if (callback) {
        createAPIRequest<Schema$ListFilesResponse>(parameters, callback);
      } else {
  ...
  export class Resource$Projects$Locations$Repositories$Packages {
    ...
    get(
      ...
      optionsOrCallback?: MethodOptions | BodyResponseCallback<Schema$Package>,
      callback?: BodyResponseCallback<Schema$Package>
    ): void | GaxiosPromise<Schema$Package> {
      let params = (paramsOrCallback ||
    ...
    list(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Schema$ListPackagesResponse>,
      callback?: BodyResponseCallback<Schema$ListPackagesResponse>
    ): void | GaxiosPromise<Schema$ListPackagesResponse> {
      let params = (paramsOrCallback ||
      ...
      if (callback) {
        createAPIRequest<Schema$ListPackagesResponse>(parameters, callback);
      } else {
