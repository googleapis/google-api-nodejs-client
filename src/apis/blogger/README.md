...
```sh
$ npm install @googleapis/blogger
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/blogger/classes/Blogger.html).
...
```html
<script src="/path/to/blogger.min.js"></script>
<script>
const { blogger, auth } = Blogger;
</script>
```
