...
```sh
$ npm install @googleapis/cloudidentity
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/cloudidentity/classes/Cloudidentity.html).
...
```html
<script src="/path/to/cloudidentity.min.js"></script>
<script>
const { cloudidentity, auth } = Cloudidentity;
</script>
```
