...
legacy application, please use [@google-cloud/advisorynotifications](https://www.npmjs.com/package/@google-cloud/advisorynotifications) instead.
The [@google-cloud/advisorynotifications](https://www.npmjs.com/package/@google-cloud/advisorynotifications) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/advisorynotifications
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/advisorynotifications/classes/Advisorynotifications.html).
