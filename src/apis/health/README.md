...
legacy application, please use [@google-cloud/health](https://www.npmjs.com/package/@google-cloud/health) instead.
The [@google-cloud/health](https://www.npmjs.com/package/@google-cloud/health) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/health
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/health/classes/Health.html).
