...
export namespace health_v4 {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/subscribers')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Subscribers$Subscriptions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/subscriptions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Shl$M {
    ...
    getShlManifest(
      ...
      if (params.externalShlId !== undefined && params.externalShlId !== null) {
        validateSingleSegment('externalShlId', String(params.externalShlId));
        params.externalShlId = encodeWithSlashes(String(params.externalShlId));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/shl/m/{externalShlId}')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Shl$R {
    ...
    get(
      ...
      if (params.resourceToken !== undefined && params.resourceToken !== null) {
        validateSingleSegment('resourceToken', String(params.resourceToken));
        params.resourceToken = encodeWithSlashes(String(params.resourceToken));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/shl/r/{externalShlId}/{resourceToken}')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Users$Datatypes$Datapoints {
    ...
    batchDelete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/dataPoints:batchDelete')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/dataPoints')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    exportExerciseTcx(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+name}:exportExerciseTcx')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    reconcile(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/dataPoints:reconcile')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    rollUp(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/dataPoints:rollUp')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Users$Paireddevices {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/pairedDevices')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
