...
```sh
$ npm install @googleapis/script
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/script/classes/Script.html).
...
The generated bundle will be written to `dist/script.min.js`. Use it from your HTML file:

```html
<script src="/path/to/script.min.js"></script>
<script>
const { script, auth } = Script;
</script>
```
