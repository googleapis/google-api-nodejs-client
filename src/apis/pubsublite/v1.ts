  ...
  export class Resource$Admin$Projects$Locations$Operations {
    ...
    cancel(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+name}:cancel')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+name}/operations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Admin$Projects$Locations$Reservations {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+parent}/reservations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Admin$Projects$Locations$Reservations$Topics {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+name}/topics')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Admin$Projects$Locations$Subscriptions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+parent}/subscriptions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    seek(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+name}:seek')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Admin$Projects$Locations$Topics {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+parent}/topics')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getPartitions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+name}/partitions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Admin$Projects$Locations$Topics$Subscriptions {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/admin/{+name}/subscriptions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Cursor$Projects$Locations$Subscriptions {
    ...
    commitCursor(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/cursor/{+subscription}:commitCursor')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Cursor$Projects$Locations$Subscriptions$Cursors {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/cursor/{+parent}/cursors')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Topicstats$Projects$Locations$Topics {
    ...
    computeHeadCursor(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/topicStats/{+topic}:computeHeadCursor')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    computeMessageStats(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/topicStats/{+topic}:computeMessageStats')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    computeTimeCursor(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/topicStats/{+topic}:computeTimeCursor')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
