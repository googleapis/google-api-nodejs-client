...
legacy application, please use [@google-cloud/bigquery-datapolicies](https://www.npmjs.com/package/@google-cloud/bigquery-datapolicies) instead.
The [@google-cloud/bigquery-datapolicies](https://www.npmjs.com/package/@google-cloud/bigquery-datapolicies) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/bigquerydatapolicy
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/bigquerydatapolicy/classes/Bigquerydatapolicy.html).
