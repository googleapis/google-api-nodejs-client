...
export namespace bigquerydatapolicy_v2 {
  ...
  export class Resource$Projects$Locations$Datapolicies {
     ...
     */
    addGrantees(
      params: Params$Resource$Projects$Locations$Datapolicies$Addgrantees,
    ...
    addGrantees(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Addgrantees
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Datapolicies$Addgrantees;
     ...
     */
    removeGrantees(
      params: Params$Resource$Projects$Locations$Datapolicies$Removegrantees,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    removeGrantees(
      params?: Params$Resource$Projects$Locations$Datapolicies$Removegrantees,
    ...
    removeGrantees(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datapolicies$Removegrantees
        | BodyResponseCallback<Schema$DataPolicy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Datapolicies$Removegrantees;
      let options = (optionsOrCallback || {}) as MethodOptions;
