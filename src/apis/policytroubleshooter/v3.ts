...
export namespace policytroubleshooter_v3 {
  ...
  export interface Schema$GoogleCloudPolicytroubleshooterIamV3AllowBindingExplanation {
    ...
    memberships?: {
      [
        key: string
      ]: Schema$GoogleCloudPolicytroubleshooterIamV3AllowBindingExplanationAnnotatedAllowMembership;
    } | null;
    /**
  ...
  export interface Schema$GoogleCloudPolicytroubleshooterIamV3DenyRuleExplanation {
    ...
    deniedPermissions?: {
      [
        key: string
      ]: Schema$GoogleCloudPolicytroubleshooterIamV3DenyRuleExplanationAnnotatedPermissionMatching;
    } | null;
    /**
    ...
    deniedPrincipals?: {
      [
        key: string
      ]: Schema$GoogleCloudPolicytroubleshooterIamV3DenyRuleExplanationAnnotatedDenyPrincipalMatching;
    } | null;
    /**
  ...
  export class Resource$Iam {
    ...
    troubleshoot(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>
    >;
    troubleshoot(
      params: Params$Resource$Iam$Troubleshoot,
    ...
    troubleshoot(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>
    ): void;
    troubleshoot(
      params: Params$Resource$Iam$Troubleshoot,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>
    ...
    troubleshoot(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v3/iam:troubleshoot').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponse>(
          parameters
        );
      }
    }
