...
legacy application, please use [@google-cloud/service-management](https://www.npmjs.com/package/@google-cloud/service-management) instead.
The [@google-cloud/service-management](https://www.npmjs.com/package/@google-cloud/service-management) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/servicemanagement
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/servicemanagement/classes/Servicemanagement.html).
