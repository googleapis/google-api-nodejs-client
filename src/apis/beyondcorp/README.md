...
legacy application, please use [@google-cloud/appconnections](https://www.npmjs.com/package/@google-cloud/appconnections) instead.
The [@google-cloud/appconnections](https://www.npmjs.com/package/@google-cloud/appconnections) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/beyondcorp
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/beyondcorp/classes/Beyondcorp.html).
