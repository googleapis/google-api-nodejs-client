...
export namespace beyondcorp_v1alpha {
  ...
  export class Resource$Organizations$Locations$Insights {
    ...
    configuredInsight(
      ...
      if (params.insight !== undefined && params.insight !== null) {
        validateMultiSegment('insight', String(params.insight));
        params.insight = encodeWithoutSlashes(String(params.insight));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+insight}:configuredInsight')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/insights')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Organizations$Locations$Subscriptions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/subscriptions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    restart(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:restart')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export interface Params$Resource$Organizations$Locations$Subscriptions$Cancel extends StandardParameters {
    /**
     * Required. Name of the resource.
     */
    name?: string;
  ...
  export interface Params$Resource$Organizations$Locations$Subscriptions$Patch extends StandardParameters {
    /**
     * Identifier. Unique resource name of the Subscription. The name is ignored when creating a subscription.
     */
    name?: string;
  ...
  export interface Params$Resource$Organizations$Locations$Subscriptions$Restart extends StandardParameters {
    /**
     * Required. Name of the resource.
     */
    name?: string;
  ...
  export class Resource$Projects$Locations$Appconnections {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/appConnections')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    resolve(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/appConnections:resolve')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Appconnectors {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/appConnectors')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    reportStatus(
      ...
      if (params.appConnector !== undefined && params.appConnector !== null) {
        validateMultiSegment('appConnector', String(params.appConnector));
        params.appConnector = encodeWithoutSlashes(String(params.appConnector));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+appConnector}:reportStatus')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Appgateways {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/appGateways')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export interface Params$Resource$Projects$Locations$Applicationdomains$Getiampolicy extends StandardParameters {
    /**
     * Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
     */
    'options.requestedPolicyVersion'?: number;
  ...
  export interface Params$Resource$Projects$Locations$Applicationdomains$Setiampolicy extends StandardParameters {
    /**
     * REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     */
    resource?: string;
  ...
  export interface Params$Resource$Projects$Locations$Applicationdomains$Testiampermissions extends StandardParameters {
    /**
     * REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     */
    resource?: string;
  ...
  export class Resource$Projects$Locations$Connections {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/connections')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    resolve(
      params: Params$Resource$Projects$Locations$Connections$Resolve,
      options:
        MethodOptions | BodyResponseCallback<Schema$ResolveConnectionsResponse>,
    ...
    resolve(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/connections:resolve')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Connectors {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/connectors')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    reportStatus(
      ...
      if (params.connector !== undefined && params.connector !== null) {
        validateMultiSegment('connector', String(params.connector));
        params.connector = encodeWithoutSlashes(String(params.connector));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+connector}:reportStatus')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    resolveInstanceConfig(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+connector}:resolveInstanceConfig')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Securitygateways {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/securityGateways')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Securitygateways$Applications {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/applications')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
