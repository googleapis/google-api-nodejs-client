...
```sh
$ npm install @google/cloudprivatecatalog
```
...
```sh
$ cd src/apis/cloudprivatecatalog
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/cloudprivatecatalog.min.js`. Use it from your HTML file:

```html
<script src="/path/to/cloudprivatecatalog.min.js"></script>
<script>
const { cloudprivatecatalog, auth } = Cloudprivatecatalog;
</script>
```
