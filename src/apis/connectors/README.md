...
legacy application, please use [@google-cloud/connectors](https://www.npmjs.com/package/@google-cloud/connectors) instead.
The [@google-cloud/connectors](https://www.npmjs.com/package/@google-cloud/connectors) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/connectors
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/connectors/classes/Connectors.html).
