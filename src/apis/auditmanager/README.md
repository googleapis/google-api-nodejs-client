...
legacy application, please use [@google-cloud/auditmanager](https://www.npmjs.com/package/@google-cloud/auditmanager) instead.
The [@google-cloud/auditmanager](https://www.npmjs.com/package/@google-cloud/auditmanager) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/auditmanager
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/auditmanager/classes/Auditmanager.html).
