...
export namespace videointelligence_v1p2beta1 {
  ...
  export interface Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechTranscriptionConfig {
     ...
     */
    speechContexts?:
        Schema$GoogleCloudVideointelligenceV1p2beta1_SpeechContext[];
  }
  /**
   * Annotations related to one detected OCR text snippet. This will contain the
   * corresponding text, confidence value, and frame level information for each
  ...
  export interface Schema$GoogleCloudVideointelligenceV1p2beta1_VideoContext {
    ...
    shotChangeDetectionConfig?:
        Schema$GoogleCloudVideointelligenceV1p2beta1_ShotChangeDetectionConfig;
    /**
     * Config for SPEECH_TRANSCRIPTION.
     */
     ...
     */
    textDetectionConfig?:
        Schema$GoogleCloudVideointelligenceV1p2beta1_TextDetectionConfig;
  }
  /**
   * Video segment.
   */
