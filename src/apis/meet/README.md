...
legacy application, please use [@google-apps/meet](https://www.npmjs.com/package/@google-apps/meet) instead.
The [@google-apps/meet](https://www.npmjs.com/package/@google-apps/meet) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/meet
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/meet/classes/Meet.html).
