...
legacy application, please use [@google-cloud/hypercomputecluster](https://www.npmjs.com/package/@google-cloud/hypercomputecluster) instead.
The [@google-cloud/hypercomputecluster](https://www.npmjs.com/package/@google-cloud/hypercomputecluster) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/hypercomputecluster
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/hypercomputecluster/classes/Hypercomputecluster.html).
