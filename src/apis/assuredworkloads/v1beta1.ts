...
export namespace assuredworkloads_v1beta1 {
   ...
   */
  export interface Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest {
    /**
   ...
   */
  export interface Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse {
    /**
   ...
   */
  export interface Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsRequest {
    /**
   ...
   */
  export interface Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse {
    /**
  ...
  export interface Schema$GoogleCloudAssuredworkloadsV1beta1Workload {
     ...
     */
    workloadOptions?: Schema$GoogleCloudAssuredworkloadsV1beta1WorkloadWorkloadOptions;
  }
  /**
   ...
   */
  export interface Schema$GoogleCloudAssuredworkloadsV1beta1WorkloadWorkloadOptions {
    /**
  ...
  export class Resource$Assuredworkloads {
    ...
    archiveResourceEvents(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>
    >;
    archiveResourceEvents(
      params: Params$Resource$Assuredworkloads$Archiveresourceevents,
    ...
    archiveResourceEvents(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>
    ): void;
    archiveResourceEvents(
      params: Params$Resource$Assuredworkloads$Archiveresourceevents,
      callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>
    ...
    archiveResourceEvents(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsResponse>(
          parameters
        );
      }
    }
    ...
    revertArchivedResourceEvents(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>
    >;
    revertArchivedResourceEvents(
      params: Params$Resource$Assuredworkloads$Revertarchivedresourceevents,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    revertArchivedResourceEvents(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>
    ): void;
    revertArchivedResourceEvents(
      params: Params$Resource$Assuredworkloads$Revertarchivedresourceevents,
      callback: BodyResponseCallback<Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>
    ...
    revertArchivedResourceEvents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta1/assuredworkloads:revertArchivedResourceEvents'
            )
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudAssuredworkloadsV1beta1RevertArchivedResourceEventsResponse>(
          parameters
        );
      }
    }
  ...
  export interface Params$Resource$Assuredworkloads$Archiveresourceevents extends StandardParameters {
     ...
     * Request body metadata
     */
    requestBody?: Schema$GoogleCloudAssuredworkloadsV1beta1ArchiveResourceEventsRequest;
  }
  ...
  export class Resource$Folders$Locations$Dbfindingsummaries {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/dbFindingSummaries')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Folders$Locations$Dbframeworkcompliancereports {
    ...
    aggregate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:aggregate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    fetch(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:fetch')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Folders$Locations$Dbframeworkcompliancereports$Dbcontrolcompliancesummaries {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/dbControlComplianceSummaries')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Folders$Locations$Dbframeworkcompliancesummaries {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/dbFrameworkComplianceSummaries')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Organizations$Locations$Workloads {
    ...
    analyzeWorkloadMove(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+target}:analyzeWorkloadMove')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
     ...
     *       //   "complianceStatus": {},
     *       //   "complianceUpdatesEnabled": false,
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/workloads')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    enableComplianceUpdates(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:enableComplianceUpdates')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'PUT',
            apiVersion: '',
    ...
    restrictAllowedResources(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:restrictAllowedResources')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Organizations$Locations$Workloads$Updates {
    ...
    apply(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:apply')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/updates')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Organizations$Locations$Workloads$Violations {
    ...
    acknowledge(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:acknowledge')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
