    ...
    archiveResourceEvents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/assuredworkloads:archiveResourceEvents'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    revertArchivedResourceEvents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/assuredworkloads:revertArchivedResourceEvents'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
  ...
  export class Resource$Folders$Locations$Dbfindingsummaries {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/dbFindingSummaries').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Folders$Locations$Dbframeworkcompliancereports {
    ...
    aggregate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:aggregate').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/{+parent}/dbControlComplianceSummaries'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/{+parent}/dbFrameworkComplianceSummaries'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
