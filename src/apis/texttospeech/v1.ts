...
export namespace texttospeech_v1 {
  ...
  export class Resource$Projects$Locations$Datasets {
    ...
    import(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datasets$Import
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$Projects$Locations$Datasets$Import;
        options = {};
      }
  ...
  export interface Params$Resource$Projects$Locations$Datasets$Import
