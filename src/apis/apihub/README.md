...
legacy application, please use [@google-cloud/apihub](https://www.npmjs.com/package/@google-cloud/apihub) instead.
The [@google-cloud/apihub](https://www.npmjs.com/package/@google-cloud/apihub) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/apihub
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/apihub/classes/Apihub.html).
