...
export namespace apphub_v1 {
  ...
  export class Resource$Projects$Locations {
    ...
    detachServiceProjectAttachment(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/{+name}:detachServiceProjectAttachment'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    getBoundary(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Boundary> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Boundary>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
    ...
    lookupServiceProjectAttachment(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/{+name}:lookupServiceProjectAttachment'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
  ...
  export class Resource$Projects$Locations$Applications {
    ...
    list(
      params: Params$Resource$Projects$Locations$Applications$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListApplicationsResponse>,
  ...
  export class Resource$Projects$Locations$Discoveredservices {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/discoveredServices').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    lookup(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/discoveredServices:lookup').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Discoveredworkloads {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/discoveredWorkloads').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    lookup(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/discoveredWorkloads:lookup').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Extendedmetadataschemas {
    ...
    get(
      params: Params$Resource$Projects$Locations$Extendedmetadataschemas$Get,
      options:
        MethodOptions | BodyResponseCallback<Schema$ExtendedMetadataSchema>,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/extendedMetadataSchemas').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Serviceprojectattachments {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/serviceProjectAttachments').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    get(
      params: Params$Resource$Projects$Locations$Serviceprojectattachments$Get,
      options:
        MethodOptions | BodyResponseCallback<Schema$ServiceProjectAttachment>,
