...
legacy application, please use [@google-cloud/apphub](https://www.npmjs.com/package/@google-cloud/apphub) instead.
The [@google-cloud/apphub](https://www.npmjs.com/package/@google-cloud/apphub) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/apphub
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/apphub/classes/Apphub.html).
