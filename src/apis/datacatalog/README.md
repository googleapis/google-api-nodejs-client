...
legacy application, please use [@google-cloud/datacatalog](https://www.npmjs.com/package/@google-cloud/datacatalog) instead.
The [@google-cloud/datacatalog](https://www.npmjs.com/package/@google-cloud/datacatalog) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/datacatalog
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/datacatalog/classes/Datacatalog.html).
