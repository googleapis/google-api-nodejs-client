 ...
 * @memberOf! gmail(v1)
 * @type object
 * @property {gmail(v1).LabelColor} color The Color to assign to the label. Only available for labels with type User. Will not be set if the label doesn&#39;t have both a text_color and background_color configured.
