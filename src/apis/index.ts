...
abusiveexperiencereport<T = abusiveexperiencereport_v1.Abusiveexperiencereport>(options: ServiceOptions|string) {
  return this.getAPI<T>('abusiveexperiencereport', options);
}
acceleratedmobilepageurl<T = acceleratedmobilepageurl_v1.Acceleratedmobilepageurl>(options: ServiceOptions|string) {
  return this.getAPI<T>('acceleratedmobilepageurl', options);
}
adexchangebuyer<T = adexchangebuyer_v1_2.Adexchangebuyer|adexchangebuyer_v1_3.Adexchangebuyer|adexchangebuyer_v1_4.Adexchangebuyer>(options: ServiceOptions|string) {
  return this.getAPI<T>('adexchangebuyer', options);
}
adexchangebuyer2<T = adexchangebuyer2_v2beta1.Adexchangebuyer2>(options: ServiceOptions|string) {
  return this.getAPI<T>('adexchangebuyer2', options);
}
adexchangeseller<T = adexchangeseller_v1_1.Adexchangeseller|adexchangeseller_v1.Adexchangeseller|adexchangeseller_v2_0.Adexchangeseller>(options: ServiceOptions|string) {
  return this.getAPI<T>('adexchangeseller', options);
}
adexperiencereport<T = adexperiencereport_v1.Adexperiencereport>(options: ServiceOptions|string) {
  return this.getAPI<T>('adexperiencereport', options);
}
admin<T = admin_datatransfer_v1.Admin|admin_directory_v1.Admin|admin_reports_v1.Admin>(options: ServiceOptions|string) {
...
adsensehost<T = adsensehost_v4_1.Adsensehost>(options: ServiceOptions|string) {
  return this.getAPI<T>('adsensehost', options);
}
analytics<T = analytics_v2_4.Analytics|analytics_v3.Analytics>(options: ServiceOptions|string) {
  return this.getAPI<T>('analytics', options);
}
analyticsreporting<T = analyticsreporting_v4.Analyticsreporting>(options: ServiceOptions|string) {
  return this.getAPI<T>('analyticsreporting', options);
}
androiddeviceprovisioning<T = androiddeviceprovisioning_v1.Androiddeviceprovisioning>(options: ServiceOptions|string) {
  return this.getAPI<T>('androiddeviceprovisioning', options);
}
androidenterprise<T = androidenterprise_v1.Androidenterprise>(options: ServiceOptions|string) {
  return this.getAPI<T>('androidenterprise', options);
}
androidmanagement<T = androidmanagement_v1.Androidmanagement>(options: ServiceOptions|string) {
  return this.getAPI<T>('androidmanagement', options);
}
androidpublisher<T = androidpublisher_v1_1.Androidpublisher|androidpublisher_v1.Androidpublisher|androidpublisher_v2.Androidpublisher>(options: ServiceOptions|string) {
  return this.getAPI<T>('androidpublisher', options);
}
appengine<T = appengine_v1.Appengine|appengine_v1alpha.Appengine|appengine_v1beta.Appengine|appengine_v1beta4.Appengine|appengine_v1beta5.Appengine>(options: ServiceOptions|string) {
  return this.getAPI<T>('appengine', options);
}
appsactivity<T = appsactivity_v1.Appsactivity>(options: ServiceOptions|string) {
...
bigquerydatatransfer<T = bigquerydatatransfer_v1.Bigquerydatatransfer>(options: ServiceOptions|string) {
  return this.getAPI<T>('bigquerydatatransfer', options);
}
blogger<T = blogger_v2.Blogger|blogger_v3.Blogger>(options: ServiceOptions|string) {
...
cloudbilling<T = cloudbilling_v1.Cloudbilling>(options: ServiceOptions|string) {
...
clouddebugger<T = clouddebugger_v2.Clouddebugger>(options: ServiceOptions|string) {
  return this.getAPI<T>('clouddebugger', options);
}
clouderrorreporting<T = clouderrorreporting_v1beta1.Clouderrorreporting>(options: ServiceOptions|string) {
  return this.getAPI<T>('clouderrorreporting', options);
}
cloudfunctions<T = cloudfunctions_v1.Cloudfunctions|cloudfunctions_v1beta2.Cloudfunctions>(options: ServiceOptions|string) {
...
cloudresourcemanager<T = cloudresourcemanager_v1.Cloudresourcemanager|cloudresourcemanager_v1beta1.Cloudresourcemanager|cloudresourcemanager_v2.Cloudresourcemanager|cloudresourcemanager_v2beta1.Cloudresourcemanager>(options: ServiceOptions|string) {
  return this.getAPI<T>('cloudresourcemanager', options);
}
cloudshell<T = cloudshell_v1.Cloudshell|cloudshell_v1alpha1.Cloudshell>(options: ServiceOptions|string) {
  return this.getAPI<T>('cloudshell', options);
}
cloudtasks<T = cloudtasks_v2beta2.Cloudtasks>(options: ServiceOptions|string) {
  return this.getAPI<T>('cloudtasks', options);
}
cloudtrace<T = cloudtrace_v1.Cloudtrace|cloudtrace_v2.Cloudtrace>(options: ServiceOptions|string) {
  return this.getAPI<T>('cloudtrace', options);
}
compute<T = compute_alpha.Compute|compute_beta.Compute|compute_v1.Compute>(options: ServiceOptions|string) {
  return this.getAPI<T>('compute', options);
}
container<T = container_v1.Container|container_v1beta1.Container>(options: ServiceOptions|string) {
  return this.getAPI<T>('container', options);
}
content<T = content_v2.Content|content_v2sandbox.Content>(options: ServiceOptions|string) {
  return this.getAPI<T>('content', options);
}
customsearch<T = customsearch_v1.Customsearch>(options: ServiceOptions|string) {
...
dataproc<T = dataproc_v1.Dataproc|dataproc_v1beta2.Dataproc>(options: ServiceOptions|string) {
  return this.getAPI<T>('dataproc', options);
}
datastore<T = datastore_v1.Datastore|datastore_v1beta1.Datastore|datastore_v1beta3.Datastore>(options: ServiceOptions|string) {
  return this.getAPI<T>('datastore', options);
}
deploymentmanager<T = deploymentmanager_alpha.Deploymentmanager|deploymentmanager_v2.Deploymentmanager|deploymentmanager_v2beta.Deploymentmanager>(options: ServiceOptions|string) {
  return this.getAPI<T>('deploymentmanager', options);
}
dfareporting<T = dfareporting_v2_8.Dfareporting|dfareporting_v3_0.Dfareporting>(options: ServiceOptions|string) {
  return this.getAPI<T>('dfareporting', options);
}
dialogflow<T = dialogflow_v2.Dialogflow|dialogflow_v2beta1.Dialogflow>(options: ServiceOptions|string) {
  return this.getAPI<T>('dialogflow', options);
}
digitalassetlinks<T = digitalassetlinks_v1.Digitalassetlinks>(options: ServiceOptions|string) {
...
dlp<T = dlp_v2.Dlp|dlp_v2beta1.Dlp|dlp_v2beta2.Dlp>(options: ServiceOptions|string) {
  return this.getAPI<T>('dlp', options);
}
dns<T = dns_v1.Dns|dns_v1beta2.Dns|dns_v2beta1.Dns>(options: ServiceOptions|string) {
  return this.getAPI<T>('dns', options);
}
doubleclickbidmanager<T = doubleclickbidmanager_v1.Doubleclickbidmanager>(options: ServiceOptions|string) {
  return this.getAPI<T>('doubleclickbidmanager', options);
}
doubleclicksearch<T = doubleclicksearch_v2.Doubleclicksearch>(options: ServiceOptions|string) {
...
firebasedynamiclinks<T = firebasedynamiclinks_v1.Firebasedynamiclinks>(options: ServiceOptions|string) {
  return this.getAPI<T>('firebasedynamiclinks', options);
}
firebaserules<T = firebaserules_v1.Firebaserules>(options: ServiceOptions|string) {
...
fusiontables<T = fusiontables_v1.Fusiontables|fusiontables_v2.Fusiontables>(options: ServiceOptions|string) {
...
gamesConfiguration<T = gamesConfiguration_v1configuration.Gamesconfiguration>(options: ServiceOptions|string) {
  return this.getAPI<T>('gamesConfiguration', options);
}
gamesManagement<T = gamesManagement_v1management.Gamesmanagement>(options: ServiceOptions|string) {
  return this.getAPI<T>('gamesManagement', options);
}
genomics<T = genomics_v1.Genomics|genomics_v1alpha2.Genomics|genomics_v2alpha1.Genomics>(options: ServiceOptions|string) {
...
groupsmigration<T = groupsmigration_v1.Groupsmigration>(options: ServiceOptions|string) {
  return this.getAPI<T>('groupsmigration', options);
}
groupssettings<T = groupssettings_v1.Groupssettings>(options: ServiceOptions|string) {
...
identitytoolkit<T = identitytoolkit_v3.Identitytoolkit>(options: ServiceOptions|string) {
...
language<T = language_v1.Language|language_v1beta1.Language|language_v1beta2.Language>(options: ServiceOptions|string) {
...
logging<T = logging_v2.Logging|logging_v2beta1.Logging>(options: ServiceOptions|string) {
  return this.getAPI<T>('logging', options);
}
manufacturers<T = manufacturers_v1.Manufacturers>(options: ServiceOptions|string) {
...
oauth2<T = oauth2_v1.Oauth2|oauth2_v2.Oauth2>(options: ServiceOptions|string) {
  return this.getAPI<T>('oauth2', options);
}
oslogin<T = oslogin_v1.Oslogin|oslogin_v1alpha.Oslogin|oslogin_v1beta.Oslogin>(options: ServiceOptions|string) {
  return this.getAPI<T>('oslogin', options);
}
pagespeedonline<T = pagespeedonline_v1.Pagespeedonline|pagespeedonline_v2.Pagespeedonline|pagespeedonline_v4.Pagespeedonline>(options: ServiceOptions|string) {
...
playcustomapp<T = playcustomapp_v1.Playcustomapp>(options: ServiceOptions|string) {
...
prediction<T = prediction_v1_2.Prediction|prediction_v1_3.Prediction|prediction_v1_4.Prediction|prediction_v1_5.Prediction|prediction_v1_6.Prediction>(options: ServiceOptions|string) {
  return this.getAPI<T>('prediction', options);
}
proximitybeacon<T = proximitybeacon_v1beta1.Proximitybeacon>(options: ServiceOptions|string) {
  return this.getAPI<T>('proximitybeacon', options);
}
pubsub<T = pubsub_v1.Pubsub|pubsub_v1beta1a.Pubsub|pubsub_v1beta2.Pubsub>(options: ServiceOptions|string) {
  return this.getAPI<T>('pubsub', options);
}
replicapool<T = replicapool_v1beta1.Replicapool|replicapool_v1beta2.Replicapool>(options: ServiceOptions|string) {
  return this.getAPI<T>('replicapool', options);
}
replicapoolupdater<T = replicapoolupdater_v1beta1.Replicapoolupdater>(options: ServiceOptions|string) {
...
resourceviews<T = resourceviews_v1beta1.Resourceviews|resourceviews_v1beta2.Resourceviews>(options: ServiceOptions|string) {
  return this.getAPI<T>('resourceviews', options);
}
runtimeconfig<T = runtimeconfig_v1.Runtimeconfig|runtimeconfig_v1beta1.Runtimeconfig>(options: ServiceOptions|string) {
  return this.getAPI<T>('runtimeconfig', options);
}
safebrowsing<T = safebrowsing_v4.Safebrowsing>(options: ServiceOptions|string) {
...
searchconsole<T = searchconsole_v1.Searchconsole>(options: ServiceOptions|string) {
  return this.getAPI<T>('searchconsole', options);
}
serviceconsumermanagement<T = serviceconsumermanagement_v1.Serviceconsumermanagement>(options: ServiceOptions|string) {
  return this.getAPI<T>('serviceconsumermanagement', options);
}
servicecontrol<T = servicecontrol_v1.Servicecontrol>(options: ServiceOptions|string) {
  return this.getAPI<T>('servicecontrol', options);
}
servicemanagement<T = servicemanagement_v1.Servicemanagement>(options: ServiceOptions|string) {
  return this.getAPI<T>('servicemanagement', options);
}
serviceusage<T = serviceusage_v1beta1.Serviceusage>(options: ServiceOptions|string) {
...
siteVerification<T = siteVerification_v1.Siteverification>(options: ServiceOptions|string) {
...
speech<T = speech_v1.Speech|speech_v1beta1.Speech>(options: ServiceOptions|string) {
  return this.getAPI<T>('speech', options);
}
sqladmin<T = sqladmin_v1beta3.Sqladmin|sqladmin_v1beta4.Sqladmin>(options: ServiceOptions|string) {
  return this.getAPI<T>('sqladmin', options);
}
storage<T = storage_v1.Storage|storage_v1beta1.Storage|storage_v1beta2.Storage>(options: ServiceOptions|string) {
  return this.getAPI<T>('storage', options);
}
storagetransfer<T = storagetransfer_v1.Storagetransfer>(options: ServiceOptions|string) {
  return this.getAPI<T>('storagetransfer', options);
}
streetviewpublish<T = streetviewpublish_v1.Streetviewpublish>(options: ServiceOptions|string) {
...
tagmanager<T = tagmanager_v1.Tagmanager|tagmanager_v2.Tagmanager>(options: ServiceOptions|string) {
  return this.getAPI<T>('tagmanager', options);
}
taskqueue<T = taskqueue_v1beta1.Taskqueue|taskqueue_v1beta2.Taskqueue>(options: ServiceOptions|string) {
...
texttospeech<T = texttospeech_v1beta1.Texttospeech>(options: ServiceOptions|string) {
  return this.getAPI<T>('texttospeech', options);
}
toolresults<T = toolresults_v1beta3.Toolresults>(options: ServiceOptions|string) {
...
urlshortener<T = urlshortener_v1.Urlshortener>(options: ServiceOptions|string) {
...
videointelligence<T = videointelligence_v1beta1.Videointelligence>(options: ServiceOptions|string) {
  return this.getAPI<T>('videointelligence', options);
}
vision<T = vision_v1.Vision|vision_v1p1beta1.Vision|vision_v1p2beta1.Vision>(options: ServiceOptions|string) {
...
youtubeAnalytics<T = youtubeAnalytics_v1.Youtubeanalytics|youtubeAnalytics_v1beta1.Youtubeanalytics>(options: ServiceOptions|string) {
  return this.getAPI<T>('youtubeAnalytics', options);
}
youtubereporting<T = youtubereporting_v1.Youtubereporting>(options: ServiceOptions|string) {
