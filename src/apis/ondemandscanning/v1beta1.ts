...
export namespace ondemandscanning_v1beta1 {
  ...
  export class Resource$Projects$Locations$Scans {
    ...
    analyzePackages(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/scans:analyzePackages')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Scans$Vulnerabilities {
    ...
    list(
      params?: Params$Resource$Projects$Locations$Scans$Vulnerabilities$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListVulnerabilitiesResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Scans$Vulnerabilities$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/vulnerabilities')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
