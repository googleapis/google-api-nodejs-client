...
```sh
$ npm install @google/proximitybeacon
```
...
```sh
$ cd src/apis/proximitybeacon
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/proximitybeacon.min.js`. Use it from your HTML file:

```html
<script src="/path/to/proximitybeacon.min.js"></script>
<script>
const { proximitybeacon, auth } = Proximitybeacon;
</script>
```
