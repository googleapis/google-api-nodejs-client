...
export namespace networkservices_v1beta1 {
  ...
  export interface Schema$AgentGateway {
     ...
     */
    agentGatewayCard?: Schema$AgentGatewayAgentGatewayOutputCard;
    /**
     * Output only. The timestamp when the resource was created.
     */
    createTime?: string | null;
     ...
     */
    googleManaged?: Schema$AgentGatewayGoogleManaged;
    /**
     * Optional. Set of label tags associated with the AgentGateway resource.
     */
    labels?: {[key: string]: string} | null;
    /**
     * Identifier. Name of the AgentGateway resource. It matches pattern `projects/x/locations/x/agentGateways/`.
     */
    name?: string | null;
    /**
     ...
     */
    selfManaged?: Schema$AgentGatewaySelfManaged;
    /**
     * Output only. The timestamp when the resource was updated.
     */
    updateTime?: string | null;
   ...
   */
  export interface Schema$AgentGatewayAgentGatewayOutputCard {
    /**
   ...
   */
  export interface Schema$AgentGatewayNetworkConfigEgress {
    /**
   ...
   */
  export interface Schema$AgentGatewaySelfManaged {
    /**
   ...
   */
  export interface Schema$CdnEdgeExtension {
    /**
     * Output only. The timestamp when the resource was created.
     */
    createTime?: string | null;
     ...
     */
    target?: Schema$CdnEdgeExtensionTarget;
    /**
     * Output only. The timestamp when the resource was updated.
     */
    updateTime?: string | null;
   ...
   */
  export interface Schema$CdnEdgeExtensionTarget {
    /**
  ...
  export interface Schema$ListAgentGatewaysResponse {
     ...
     */
    agentGateways?: Schema$AgentGateway[];
    /**
     * If there might be more results than those appearing in this response, then `next_page_token` is included. To get the next set of results, call this method again using the value of `next_page_token` as `page_token`.
     */
    nextPageToken?: string | null;
   ...
   */
  export interface Schema$ListCdnEdgeExtensionsResponse {
    /**
     * The list of `CdnEdgeExtension` resources.
     */
    cdnEdgeExtensions?: Schema$CdnEdgeExtension[];
    /**
     * A token identifying a page of results that the server returns.
     */
    nextPageToken?: string | null;
   ...
   */
  export interface Schema$ListLbEdgeExtensionsResponse {
    /**
     * The list of `LbEdgeExtension` resources.
     */
    lbEdgeExtensions?: Schema$LbEdgeExtension[];
    /**
     * A token identifying a page of results that the server returns.
     */
    nextPageToken?: string | null;
  ...
  export class Resource$Projects$Locations {
    ...
    cdnEdgeExtensions: Resource$Projects$Locations$Cdnedgeextensions;
    ...
    constructor(context: APIRequestContext) {
      ...
      this.cdnEdgeExtensions =
        new Resource$Projects$Locations$Cdnedgeextensions(this.context);
      ...
      this.lbEdgeExtensions = new Resource$Projects$Locations$Lbedgeextensions(
        this.context
      );
  ...
  export class Resource$Projects$Locations$Agentgateways {
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.agentGateways.create({
     *     // Required. Short name of the AgentGateway resource to be created.
     *     agentGatewayId: 'placeholder-value',
     *     // Required. The parent resource of the AgentGateway. Must be in the format `projects/x/locations/x`.
     *     parent: 'projects/my-project/locations/my-location',
     *
     *     // Request body metadata
     *     requestBody: {
     ...
     */
    create(
      params: Params$Resource$Projects$Locations$Agentgateways$Create,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    create(
      params?: Params$Resource$Projects$Locations$Agentgateways$Create,
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Agentgateways$Create
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Agentgateways$Create;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Agentgateways$Create;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/agentGateways').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.agentGateways.delete({
     *     // Optional. The etag of the AgentGateway to delete.
     *     etag: 'placeholder-value',
     *     // Required. A name of the AgentGateway to delete. Must be in the format `projects/x/locations/x/agentGateways/x`.
     *     name: 'projects/my-project/locations/my-location/agentGateways/my-agentGateway',
     *   });
     *   console.log(res.data);
     *
     *   // Example response
     ...
     */
    delete(
      params: Params$Resource$Projects$Locations$Agentgateways$Delete,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    delete(
      params?: Params$Resource$Projects$Locations$Agentgateways$Delete,
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Agentgateways$Delete
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Agentgateways$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Agentgateways$Delete;
        options = {};
      }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.agentGateways.get({
     *     // Required. A name of the AgentGateway to get. Must be in the format `projects/x/locations/x/agentGateways/x`.
     *     name: 'projects/my-project/locations/my-location/agentGateways/my-agentGateway',
     *   });
     *   console.log(res.data);
     *
     ...
     */
    get(
      params: Params$Resource$Projects$Locations$Agentgateways$Get,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    get(
      params?: Params$Resource$Projects$Locations$Agentgateways$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$AgentGateway>>;
    get(
      params: Params$Resource$Projects$Locations$Agentgateways$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      params: Params$Resource$Projects$Locations$Agentgateways$Get,
      options: MethodOptions | BodyResponseCallback<Schema$AgentGateway>,
      callback: BodyResponseCallback<Schema$AgentGateway>
    ): void;
    get(
      params: Params$Resource$Projects$Locations$Agentgateways$Get,
      callback: BodyResponseCallback<Schema$AgentGateway>
    ): void;
    get(callback: BodyResponseCallback<Schema$AgentGateway>): void;
    get(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Agentgateways$Get
        | BodyResponseCallback<Schema$AgentGateway>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Agentgateways$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Agentgateways$Get;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$AgentGateway>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$AgentGateway>(parameters);
      }
    }
     ...
     *     pageToken: 'placeholder-value',
     *     // Required. The project and location from which the AgentGateways should be listed, specified in the format `projects/x/locations/x`.
     *     parent: 'projects/my-project/locations/my-location',
     *     // Optional. If true, allow partial responses for multi-regional Aggregated List requests. Otherwise if one of the locations is down or unreachable, the Aggregated List request will fail.
     *     returnPartialSuccess: 'placeholder-value',
     *   });
    ...
    list(
      params?: Params$Resource$Projects$Locations$Agentgateways$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListAgentGatewaysResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Agentgateways$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Agentgateways$List
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Agentgateways$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Agentgateways$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ListAgentGatewaysResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListAgentGatewaysResponse>(parameters);
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.agentGateways.patch({
     *     // Identifier. Name of the AgentGateway resource. It matches pattern `projects/x/locations/x/agentGateways/`.
     *     name: 'projects/my-project/locations/my-location/agentGateways/my-agentGateway',
     ...
     */
    patch(
      params: Params$Resource$Projects$Locations$Agentgateways$Patch,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    patch(
      params?: Params$Resource$Projects$Locations$Agentgateways$Patch,
    ...
    patch(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Agentgateways$Patch
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Agentgateways$Patch;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Agentgateways$Patch;
        options = {};
      }
  ...
  export interface Params$Resource$Projects$Locations$Agentgateways$Create extends StandardParameters {
    /**
     * Required. Short name of the AgentGateway resource to be created.
     */
     ...
     * Request body metadata
     */
    requestBody?: Schema$AgentGateway;
  }
  export interface Params$Resource$Projects$Locations$Agentgateways$Delete extends StandardParameters {
    /**
     * Optional. The etag of the AgentGateway to delete.
     */
    etag?: string;
  ...
  export interface Params$Resource$Projects$Locations$Agentgateways$Get extends StandardParameters {
    /**
     * Required. A name of the AgentGateway to get. Must be in the format `projects/x/locations/x/agentGateways/x`.
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Agentgateways$Patch extends StandardParameters {
    /**
     * Identifier. Name of the AgentGateway resource. It matches pattern `projects/x/locations/x/agentGateways/`.
     */
    name?: string;
  ...
  export class Resource$Projects$Locations$Cdnedgeextensions {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.cdnEdgeExtensions.create(
     *     {
     *       // Required. User-provided ID of the `CdnEdgeExtension` resource to be created.
     *       cdnEdgeExtensionId: 'placeholder-value',
     ...
     */
    create(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Create,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    create(
      params?: Params$Resource$Projects$Locations$Cdnedgeextensions$Create,
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Cdnedgeextensions$Create
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Cdnedgeextensions$Create;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/cdnEdgeExtensions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.cdnEdgeExtensions.delete(
     *     {
     ...
     *       name: 'projects/my-project/locations/my-location/cdnEdgeExtensions/my-cdnEdgeExtension',
     *       // Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server can ignore the request if it has already been completed. The server guarantees that for 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server ignores the second request This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     *       requestId: 'placeholder-value',
     *     },
     *   );
     ...
     */
    delete(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Delete,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    delete(
      params?: Params$Resource$Projects$Locations$Cdnedgeextensions$Delete,
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Cdnedgeextensions$Delete
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Cdnedgeextensions$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.cdnEdgeExtensions.get({
     ...
     */
    get(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Get,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    get(
      params?: Params$Resource$Projects$Locations$Cdnedgeextensions$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$CdnEdgeExtension>>;
    get(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Get,
      options: MethodOptions | BodyResponseCallback<Schema$CdnEdgeExtension>,
      callback: BodyResponseCallback<Schema$CdnEdgeExtension>
    ): void;
    get(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Get,
      callback: BodyResponseCallback<Schema$CdnEdgeExtension>
    ): void;
    get(callback: BodyResponseCallback<Schema$CdnEdgeExtension>): void;
    get(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Cdnedgeextensions$Get
        | BodyResponseCallback<Schema$CdnEdgeExtension>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Cdnedgeextensions$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Cdnedgeextensions$Get;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$CdnEdgeExtension>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$CdnEdgeExtension>(parameters);
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.cdnEdgeExtensions.list({
     *     // Optional. Filtering results.
     *     filter: 'placeholder-value',
     *     // Optional. Hint about how to order the results.
     *     orderBy: 'placeholder-value',
     ...
     */
    list(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$List,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    list(
      params?: Params$Resource$Projects$Locations$Cdnedgeextensions$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListCdnEdgeExtensionsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$ListCdnEdgeExtensionsResponse>,
      callback: BodyResponseCallback<Schema$ListCdnEdgeExtensionsResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$List,
      callback: BodyResponseCallback<Schema$ListCdnEdgeExtensionsResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Cdnedgeextensions$List
        | BodyResponseCallback<Schema$ListCdnEdgeExtensionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Cdnedgeextensions$List;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      if (callback) {
        createAPIRequest<Schema$ListCdnEdgeExtensionsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListCdnEdgeExtensionsResponse>(
          parameters
        );
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.cdnEdgeExtensions.patch({
     *     // Required. Identifier. Name of the `CdnEdgeExtension` resource in the following format: `projects/{project\}/locations/{location\}/cdnEdgeExtensions/{cdn_edge_extension\}`.
     *     name: 'projects/my-project/locations/my-location/cdnEdgeExtensions/my-cdnEdgeExtension',
     *     // Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server can ignore the request if it has already been completed. The server guarantees that for 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server ignores the second request This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     *     requestId: 'placeholder-value',
     ...
     */
    patch(
      params: Params$Resource$Projects$Locations$Cdnedgeextensions$Patch,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    patch(
      params?: Params$Resource$Projects$Locations$Cdnedgeextensions$Patch,
    ...
    patch(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Cdnedgeextensions$Patch
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Cdnedgeextensions$Patch;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export interface Params$Resource$Projects$Locations$Cdnedgeextensions$Create extends StandardParameters {
    /**
     * Required. User-provided ID of the `CdnEdgeExtension` resource to be created.
     */
  ...
  export interface Params$Resource$Projects$Locations$Cdnedgeextensions$Delete extends StandardParameters {
    /**
     * Required. The name of the `CdnEdgeExtension` resource to delete. Must be in the format `projects/{project\}/locations/{location\}/cdnEdgeExtensions/{cdn_edge_extension\}`.
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Cdnedgeextensions$Get extends StandardParameters {
    /**
     * Required. A name of the `CdnEdgeExtension` resource to get. Must be in the format `projects/{project\}/locations/{location\}/cdnEdgeExtensions/{cdn_edge_extension\}`.
     */
    name?: string;
  }
  export interface Params$Resource$Projects$Locations$Cdnedgeextensions$List extends StandardParameters {
    /**
     * Optional. Filtering results.
     */
    filter?: string;
  ...
  export interface Params$Resource$Projects$Locations$Cdnedgeextensions$Patch extends StandardParameters {
    /**
     * Required. Identifier. Name of the `CdnEdgeExtension` resource in the following format: `projects/{project\}/locations/{location\}/cdnEdgeExtensions/{cdn_edge_extension\}`.
     */
    name?: string;
  ...
  export class Resource$Projects$Locations$Extensionbindings {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/extensionBindings').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Gateways$Routeviews {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/routeViews').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Lbedgeextensions {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.lbEdgeExtensions.create({
     *     // Required. User-provided ID of the `LbEdgeExtension` resource to be created.
     *     lbEdgeExtensionId: 'placeholder-value',
     ...
     */
    create(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Create,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    create(
      params?: Params$Resource$Projects$Locations$Lbedgeextensions$Create,
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Lbedgeextensions$Create
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Lbedgeextensions$Create;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/lbEdgeExtensions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.lbEdgeExtensions.delete({
     ...
     *     name: 'projects/my-project/locations/my-location/lbEdgeExtensions/my-lbEdgeExtension',
     *     // Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server can ignore the request if it has already been completed. The server guarantees that for 60 minutes after the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server ignores the second request This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     *     requestId: 'placeholder-value',
     *   });
     *   console.log(res.data);
     ...
     */
    delete(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Delete,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    delete(
      params?: Params$Resource$Projects$Locations$Lbedgeextensions$Delete,
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Lbedgeextensions$Delete
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Lbedgeextensions$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.lbEdgeExtensions.get({
     ...
     */
    get(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Get,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    get(
      params?: Params$Resource$Projects$Locations$Lbedgeextensions$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$LbEdgeExtension>>;
    get(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Get,
      options: MethodOptions | BodyResponseCallback<Schema$LbEdgeExtension>,
      callback: BodyResponseCallback<Schema$LbEdgeExtension>
    ): void;
    get(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Get,
      callback: BodyResponseCallback<Schema$LbEdgeExtension>
    ): void;
    get(callback: BodyResponseCallback<Schema$LbEdgeExtension>): void;
    get(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Lbedgeextensions$Get
        | BodyResponseCallback<Schema$LbEdgeExtension>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Lbedgeextensions$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Lbedgeextensions$Get;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$LbEdgeExtension>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$LbEdgeExtension>(parameters);
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.lbEdgeExtensions.list({
     *     // Optional. Filtering results.
     *     filter: 'placeholder-value',
     *     // Optional. Hint about how to order the results.
     *     orderBy: 'placeholder-value',
     ...
     */
    list(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$List,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    list(
      params?: Params$Resource$Projects$Locations$Lbedgeextensions$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListLbEdgeExtensionsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$ListLbEdgeExtensionsResponse>,
      callback: BodyResponseCallback<Schema$ListLbEdgeExtensionsResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$List,
      callback: BodyResponseCallback<Schema$ListLbEdgeExtensionsResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Lbedgeextensions$List
        | BodyResponseCallback<Schema$ListLbEdgeExtensionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Lbedgeextensions$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Lbedgeextensions$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ListLbEdgeExtensionsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListLbEdgeExtensionsResponse>(
          parameters
        );
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await networkservices.projects.locations.lbEdgeExtensions.patch({
     *     // Required. Identifier. Name of the `LbEdgeExtension` resource in the following format: `projects/{project\}/locations/{location\}/lbEdgeExtensions/{lb_edge_extension\}`.
     *     name: 'projects/my-project/locations/my-location/lbEdgeExtensions/my-lbEdgeExtension',
     *     // Optional. An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server can ignore the request if it has already been completed. The server guarantees that for 60 minutes since the first request. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server ignores the second request This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported (00000000-0000-0000-0000-000000000000).
     *     requestId: 'placeholder-value',
     ...
     */
    patch(
      params: Params$Resource$Projects$Locations$Lbedgeextensions$Patch,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    patch(
      params?: Params$Resource$Projects$Locations$Lbedgeextensions$Patch,
    ...
    patch(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Lbedgeextensions$Patch
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Lbedgeextensions$Patch;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export interface Params$Resource$Projects$Locations$Lbtcpextensions$Create extends StandardParameters {
    /**
     * Required. User-provided ID of the `LbTcpExtension` resource to be created.
     */
  ...
  export interface Params$Resource$Projects$Locations$Lbtcpextensions$Delete extends StandardParameters {
    /**
     * Required. The name of the `LbTcpExtension` resource to delete. Must be in the format `projects/{project\}/locations/{location\}/LbTcpExtensions/{lb_tcp_extension\}`.
     */
    name?: string;
  ...
  export interface Params$Resource$Projects$Locations$Lbtcpextensions$Get extends StandardParameters {
    /**
     * Required. A name of the `LbTcpExtension` resource to get. Must be in the format `projects/{project\}/locations/{location\}/LbTcpExtensions/{lb_tcp_extension\}`.
     */
    name?: string;
  }
  export interface Params$Resource$Projects$Locations$Lbtcpextensions$List extends StandardParameters {
    /**
     * Optional. Filtering results.
     */
    filter?: string;
  ...
  export interface Params$Resource$Projects$Locations$Lbtcpextensions$Patch extends StandardParameters {
    /**
     * Required. Identifier. Name of the `LbTcpExtension` resource in the following format: `projects/{project\}/locations/{location\}/LbTcpExtension/{lb_tcp_extension\}`
     */
    name?: string;
  ...
  export class Resource$Projects$Locations$Producerextensions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/producerExtensions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
