...
legacy application, please use [@google-cloud/networkservices](https://www.npmjs.com/package/@google-cloud/networkservices) instead.
The [@google-cloud/networkservices](https://www.npmjs.com/package/@google-cloud/networkservices) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/networkservices
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/networkservices/classes/Networkservices.html).
