...
legacy application, please use [@google-cloud/datastream](https://www.npmjs.com/package/@google-cloud/datastream) instead.
The [@google-cloud/datastream](https://www.npmjs.com/package/@google-cloud/datastream) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/datastream
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/datastream/classes/Datastream.html).
