...
export namespace documentai_v1beta3 {
  ...
  export class Resource$Projects$Locations {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}/locations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Operations {
    ...
    cancel(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}:cancel')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Processors {
    ...
    batchProcess(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}:batchProcess')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/processors')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    disable(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}:disable')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    enable(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}:enable')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    process(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}:process')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    setDefaultProcessorVersion(
      ...
      if (params.processor !== undefined && params.processor !== null) {
        validateMultiSegment('processor', String(params.processor));
        params.processor = encodeWithoutSlashes(String(params.processor));
      }
  ...
  export class Resource$Projects$Locations$Processors$Dataset {
    ...
    batchDeleteDocuments(
      ...
      if (params.dataset !== undefined && params.dataset !== null) {
        validateMultiSegment('dataset', String(params.dataset));
        params.dataset = encodeWithoutSlashes(String(params.dataset));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+dataset}:batchDeleteDocuments')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getDocument(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+dataset}:getDocument')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    importDocuments(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+dataset}:importDocuments')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    listDocuments(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+dataset}:listDocuments')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Processors$Humanreviewconfig {
    ...
    reviewDocument(
      ...
      if (
        params.humanReviewConfig !== undefined &&
        params.humanReviewConfig !== null
      ) {
        validateMultiSegment(
          'humanReviewConfig',
          String(params.humanReviewConfig)
        );
        params.humanReviewConfig = encodeWithoutSlashes(
          String(params.humanReviewConfig)
        );
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+humanReviewConfig}:reviewDocument')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Processors$Processorversions {
    ...
    evaluateProcessorVersion(
      ...
      if (
        params.processorVersion !== undefined &&
        params.processorVersion !== null
      ) {
        validateMultiSegment(
          'processorVersion',
          String(params.processorVersion)
        );
        params.processorVersion = encodeWithoutSlashes(
          String(params.processorVersion)
        );
      }
    ...
    train(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/processorVersions:train')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    undeploy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+name}:undeploy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Processors$Processorversions$Evaluations {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/evaluations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Processortypes {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/processorTypes')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Schemas {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/schemas')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Schemas$Schemaversions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/schemaVersions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta3/{+parent}/schemaVersions:generate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
