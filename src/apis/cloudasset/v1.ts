  ...
  export class Resource$Effectiveiampolicies {
    ...
    batchGet(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}/effectiveIamPolicies:batchGet')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Savedqueries {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/savedQueries')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$V1 {
    ...
    analyzeIamPolicy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:analyzeIamPolicy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    analyzeIamPolicyLongrunning(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:analyzeIamPolicyLongrunning')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    analyzeOrgPolicies(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:analyzeOrgPolicies')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    analyzeOrgPolicyGovernedAssets(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:analyzeOrgPolicyGovernedAssets')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    analyzeOrgPolicyGovernedContainers(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:analyzeOrgPolicyGovernedContainers')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    queryAssets(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}:queryAssets')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    searchAllIamPolicies(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:searchAllIamPolicies')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    searchAllResources(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+scope}:searchAllResources')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
