...
legacy application, please use [@google-cloud/locationfinder](https://www.npmjs.com/package/@google-cloud/locationfinder) instead.
The [@google-cloud/locationfinder](https://www.npmjs.com/package/@google-cloud/locationfinder) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/cloudlocationfinder
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/cloudlocationfinder/classes/Cloudlocationfinder.html).
