...
legacy application, please use [@google-cloud/recaptcha-enterprise](https://www.npmjs.com/package/@google-cloud/recaptcha-enterprise) instead.
The [@google-cloud/recaptcha-enterprise](https://www.npmjs.com/package/@google-cloud/recaptcha-enterprise) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/recaptchaenterprise
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/recaptchaenterprise/classes/Recaptchaenterprise.html).
