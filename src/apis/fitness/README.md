...
```sh
$ npm install @googleapis/fitness
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/fitness/classes/Fitness.html).
...
```html
<script src="/path/to/fitness.min.js"></script>
<script>
const { fitness, auth } = Fitness;
</script>
```
