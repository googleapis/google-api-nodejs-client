...
export namespace policysimulator_v1beta {
   ...
   */
  export interface Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse {
    /**
     ...
     */
    orgPolicyViolationsPreviews?: Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview[];
  }
  /**
   * ListOrgPolicyViolationsResponse is the response message for OrgPolicyViolationsPreviewService.ListOrgPolicyViolations
   */
  export interface Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse {
    /**
     * A token that you can use to retrieve the next page of results. If this field is omitted, there are no subsequent pages.
     */
    nextPageToken?: string | null;
     ...
     */
    orgPolicyViolations?: Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolation[];
  }
  /**
   * The proposed changes to OrgPolicy.
   */
   ...
   */
  export interface Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolation {
    /**
     ...
     */
    resource?: Schema$GoogleCloudPolicysimulatorV1betaResourceContext;
  }
  /**
   * OrgPolicyViolationsPreview is a resource providing a preview of the violations that will exist if an OrgPolicy change is made. The list of violations are modeled as child resources and retrieved via a ListOrgPolicyViolations API call. There are potentially more OrgPolicyViolations than could fit in an embedded field. Thus, the use of a child resource instead of a field.
   */
   ...
   */
  export interface Schema$GoogleCloudPolicysimulatorV1betaResourceContext {
    /**
    ...
    orgPolicyViolationsPreviews(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta/{+parent}/orgPolicyViolationsPreviews'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export interface Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews
     ...
     * Request body metadata
     */
    requestBody?: Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview;
  }
  ...
  export class Resource$Organizations$Locations$Orgpolicyviolationspreviews {
    ...
    get(
      params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Get,
      options?: MethodOptions
    ): GaxiosPromise<Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>;
    get(
      params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>
    ): void;
    get(
      params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Get,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>
    ...
    get(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>(
          parameters
        );
      }
    }
    ...
    list(
      params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$List,
      options?: MethodOptions
    ): GaxiosPromise<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>;
    list(
      params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>
    ): void;
    list(
      params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$List,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>
    ...
    list(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse>(
          parameters
        );
      }
    }
  ...
  export class Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations {
    ...
    list(
      params?: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations$List,
      options?: MethodOptions
    ): GaxiosPromise<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>;
    list(
      params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>
    ): void;
    list(
      params: Params$Resource$Organizations$Locations$Orgpolicyviolationspreviews$Orgpolicyviolations$List,
      callback: BodyResponseCallback<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}/orgPolicyViolations').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>(
          parameters
        );
      }
    }
