...
export namespace areainsights_v1 {
  ...
  export class Resource$V1 {
    ...
    ): Promise<GaxiosResponseWithHTTP2<Schema$ComputeInsightsResponse>>;
    computeInsights(
      params: Params$Resource$V1$Computeinsights,
    ...
    computeInsights(
      paramsOrCallback?:
        | Params$Resource$V1$Computeinsights
        | BodyResponseCallback<Schema$ComputeInsightsResponse>
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$V1$Computeinsights;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$V1$Computeinsights;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1:computeInsights').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$ComputeInsightsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ComputeInsightsResponse>(parameters);
      }
    }
  }
