...
export function containeranalysis(version: 'v1alpha1'):
    containeranalysis_v1alpha1.Containeranalysis;
export function containeranalysis(options: containeranalysis_v1alpha1.Options):
    containeranalysis_v1alpha1.Containeranalysis;
export function containeranalysis(version: 'v1beta1'):
    containeranalysis_v1beta1.Containeranalysis;
export function containeranalysis(options: containeranalysis_v1beta1.Options):
    containeranalysis_v1beta1.Containeranalysis;
export function containeranalysis<
    T = containeranalysis_v1alpha1.Containeranalysis |
        containeranalysis_v1beta1.Containeranalysis>(
    this: GoogleConfigurable,
    versionOrOptions: 'v1alpha1'|
    containeranalysis_v1alpha1.Options|'v1beta1'|
