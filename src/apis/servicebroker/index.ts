...
export function servicebroker(options: servicebroker_v1.Options):
    servicebroker_v1.Servicebroker;
export function servicebroker(version: 'v1alpha1'):
    servicebroker_v1alpha1.Servicebroker;
export function servicebroker(options: servicebroker_v1alpha1.Options):
    servicebroker_v1alpha1.Servicebroker;
export function servicebroker(version: 'v1beta1'):
    servicebroker_v1beta1.Servicebroker;
export function servicebroker(options: servicebroker_v1beta1.Options):
    servicebroker_v1beta1.Servicebroker;
