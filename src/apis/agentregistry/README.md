...
legacy application, please use [@google-cloud/agentregistry](https://www.npmjs.com/package/@google-cloud/agentregistry) instead.
The [@google-cloud/agentregistry](https://www.npmjs.com/package/@google-cloud/agentregistry) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/agentregistry
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/agentregistry/classes/Agentregistry.html).
