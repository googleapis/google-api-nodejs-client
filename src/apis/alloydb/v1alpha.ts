  ...
  export class Resource$Projects$Locations$Backups {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/backups').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Clusters {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/clusters').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    promote(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:promote').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    restore(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/clusters:restore').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    switchover(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:switchover').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    upgrade(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:upgrade').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'PATCH',
  ...
  export class Resource$Projects$Locations$Clusters$Instances {
    ...
    failover(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:failover').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    getConnectionInfo(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/connectionInfo').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    injectFault(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:injectFault').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
