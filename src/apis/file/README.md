...
legacy application, please use [@google-cloud/filestore](https://www.npmjs.com/package/@google-cloud/filestore) instead.
The [@google-cloud/filestore](https://www.npmjs.com/package/@google-cloud/filestore) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/file
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/file/classes/File.html).
