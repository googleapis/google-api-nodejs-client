...
export namespace file_v1beta1 {
   ...
   */
  export interface Schema$AcquireShareRequest {
    /**
   ...
   */
  export interface Schema$AcquireShareResponse {
    /**
   ...
   */
  export interface Schema$ReleaseShareRequest {
    /**
   ...
   */
  export interface Schema$ReleaseShareResponse {}
  /**
  ...
  export class Resource$Projects$Locations$Instances {
    ...
    pauseReplica(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:pauseReplica')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    promoteReplica(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:promoteReplica')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    resumeReplica(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+name}:resumeReplica')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Instances$Shares {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/shares')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    get(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$Share> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$Share>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
  ...
  export class Resource$Projects$Locations$Sharepools {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *
     *   // Do the magic
     *   const res = await file.projects.locations.sharePools.acquireShare({
     *     // Required. The parent share pool path, in the format `projects/{project\}/locations/{location\}/sharePools/{share_pool\}`.
     *     parent: 'projects/my-project/locations/my-location/sharePools/my-sharePool',
     *
     *     // Request body metadata
     *     requestBody: {
     *       // request body parameters
     ...
     */
    acquireShare(
      params: Params$Resource$Projects$Locations$Sharepools$Acquireshare,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    acquireShare(
      params?: Params$Resource$Projects$Locations$Sharepools$Acquireshare,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$AcquireShareResponse>>;
    acquireShare(
      params: Params$Resource$Projects$Locations$Sharepools$Acquireshare,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    acquireShare(
      params: Params$Resource$Projects$Locations$Sharepools$Acquireshare,
      options:
        MethodOptions | BodyResponseCallback<Schema$AcquireShareResponse>,
      callback: BodyResponseCallback<Schema$AcquireShareResponse>
    ): void;
    acquireShare(
      params: Params$Resource$Projects$Locations$Sharepools$Acquireshare,
      callback: BodyResponseCallback<Schema$AcquireShareResponse>
    ...
    acquireShare(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Sharepools$Acquireshare
        | BodyResponseCallback<Schema$AcquireShareResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Sharepools$Acquireshare;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}:acquireShare')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$AcquireShareResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$AcquireShareResponse>(parameters);
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await file.projects.locations.sharePools.releaseShare({
     *     // Required. The parent share pool path, in the format `projects/{project\}/locations/{location\}/sharePools/{share_pool\}`.
     *     parent: 'projects/my-project/locations/my-location/sharePools/my-sharePool',
     *
     *     // Request body metadata
     ...
     */
    releaseShare(
      params: Params$Resource$Projects$Locations$Sharepools$Releaseshare,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    releaseShare(
      params?: Params$Resource$Projects$Locations$Sharepools$Releaseshare,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ReleaseShareResponse>>;
    releaseShare(
      params: Params$Resource$Projects$Locations$Sharepools$Releaseshare,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    releaseShare(
      params: Params$Resource$Projects$Locations$Sharepools$Releaseshare,
      options:
        MethodOptions | BodyResponseCallback<Schema$ReleaseShareResponse>,
      callback: BodyResponseCallback<Schema$ReleaseShareResponse>
    ): void;
    releaseShare(
      params: Params$Resource$Projects$Locations$Sharepools$Releaseshare,
      callback: BodyResponseCallback<Schema$ReleaseShareResponse>
    ...
    releaseShare(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Sharepools$Releaseshare
        | BodyResponseCallback<Schema$ReleaseShareResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Sharepools$Releaseshare;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}:releaseShare')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$ReleaseShareResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ReleaseShareResponse>(parameters);
      }
    }
  }

  export interface Params$Resource$Projects$Locations$Sharepools$Acquireshare extends StandardParameters {
    /**
     * Required. The parent share pool path, in the format `projects/{project\}/locations/{location\}/sharePools/{share_pool\}`.
     */
    parent?: string;
     ...
     * Request body metadata
     */
    requestBody?: Schema$AcquireShareRequest;
  }
  export interface Params$Resource$Projects$Locations$Sharepools$Releaseshare extends StandardParameters {
    /**
     * Required. The parent share pool path, in the format `projects/{project\}/locations/{location\}/sharePools/{share_pool\}`.
     */
    parent?: string;
