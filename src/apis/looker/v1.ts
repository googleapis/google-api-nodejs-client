...
export namespace looker_v1 {
  ...
  export class Resource$Projects$Locations$Instances$Backups {
     ...
     */
    getIamPolicy(
      params: Params$Resource$Projects$Locations$Instances$Backups$Getiampolicy,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    getIamPolicy(
      params?: Params$Resource$Projects$Locations$Instances$Backups$Getiampolicy,
    ...
    getIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Instances$Backups$Getiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Instances$Backups$Getiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     */
    setIamPolicy(
      params: Params$Resource$Projects$Locations$Instances$Backups$Setiampolicy,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    setIamPolicy(
      params?: Params$Resource$Projects$Locations$Instances$Backups$Setiampolicy,
    ...
    setIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Instances$Backups$Setiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Instances$Backups$Setiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     */
    testIamPermissions(
      params: Params$Resource$Projects$Locations$Instances$Backups$Testiampermissions,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    testIamPermissions(
      params?: Params$Resource$Projects$Locations$Instances$Backups$Testiampermissions,
    ...
    testIamPermissions(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Instances$Backups$Testiampermissions
        | BodyResponseCallback<Schema$TestIamPermissionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | GaxiosPromise<Readable> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Instances$Backups$Testiampermissions;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export interface Params$Resource$Projects$Locations$Instances$Backups$Getiampolicy
    extends StandardParameters {
    /**
     * Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
     */
  ...
  export interface Params$Resource$Projects$Locations$Instances$Backups$Setiampolicy
    extends StandardParameters {
    /**
     * REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     */
  ...
  export interface Params$Resource$Projects$Locations$Instances$Backups$Testiampermissions
    extends StandardParameters {
    /**
     * REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     */
