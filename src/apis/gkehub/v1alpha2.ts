...
export namespace gkehub_v1alpha2 {
  ...
  export class Resource$Projects$Locations$Global {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.memberships = new Resource$Projects$Locations$Global$Memberships(
        this.context
      );
    }
  }
  ...
  export class Resource$Projects$Locations$Global$Memberships {
     ...
     */
    initializeHub(
      params: Params$Resource$Projects$Locations$Global$Memberships$Initializehub,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    initializeHub(
      params?: Params$Resource$Projects$Locations$Global$Memberships$Initializehub,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$InitializeHubResponse>>;
    initializeHub(
      params: Params$Resource$Projects$Locations$Global$Memberships$Initializehub,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    initializeHub(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$InitializeHubResponse>,
      callback: BodyResponseCallback<Schema$InitializeHubResponse>
    ): void;
    initializeHub(
      params: Params$Resource$Projects$Locations$Global$Memberships$Initializehub,
      callback: BodyResponseCallback<Schema$InitializeHubResponse>
    ...
    initializeHub(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Global$Memberships$Initializehub
        | BodyResponseCallback<Schema$InitializeHubResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha2/{+project}:initializeHub').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$InitializeHubResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$InitializeHubResponse>(parameters);
      }
    }
  }

  export interface Params$Resource$Projects$Locations$Global$Memberships$Initializehub
    extends StandardParameters {
    /**
  ...
  export class Resource$Projects$Locations$Memberships {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha2/{+parent}/memberships').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    generateConnectManifest(
      params?: Params$Resource$Projects$Locations$Memberships$Generateconnectmanifest,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GenerateConnectManifestResponse>>;
    generateConnectManifest(
      params: Params$Resource$Projects$Locations$Memberships$Generateconnectmanifest,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    generateConnectManifest(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1alpha2/{+name}:generateConnectManifest'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
    ...
    get(
      ...
      callback?:
        | BodyResponseCallback<Schema$Membership>
        | BodyResponseCallback<Readable>
    ): void | Promise<GaxiosResponseWithHTTP2<Schema$Membership>> | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
