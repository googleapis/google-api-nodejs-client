...
delete(paramsOrCallback?: Params$Resource$Agentusers$Delete|BodyResponseCallback<Schema$Empty>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$Empty>, callback?: BodyResponseCallback<Schema$Empty>): void|GaxiosPromise<Schema$Empty> {
  let params = (paramsOrCallback || {}) as Params$Resource$Agentusers$Delete;
...
query(paramsOrCallback?: Params$Resource$Devices$Query|BodyResponseCallback<Schema$QueryResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$QueryResponse>, callback?: BodyResponseCallback<Schema$QueryResponse>): void|GaxiosPromise<Schema$QueryResponse> {
...
reportStateAndNotification(paramsOrCallback?: Params$Resource$Devices$Reportstateandnotification|BodyResponseCallback<Schema$ReportStateAndNotificationResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$ReportStateAndNotificationResponse>, callback?: BodyResponseCallback<Schema$ReportStateAndNotificationResponse>): void|GaxiosPromise<Schema$ReportStateAndNotificationResponse> {
  let params = (paramsOrCallback || {}) as Params$Resource$Devices$Reportstateandnotification;
  let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  const parameters = {
    ...
    if (callback) {
    createAPIRequest<Schema$ReportStateAndNotificationResponse>(parameters, callback);
  } else {
    return createAPIRequest<Schema$ReportStateAndNotificationResponse>(parameters);
  }
}
...
requestSync(paramsOrCallback?: Params$Resource$Devices$Requestsync|BodyResponseCallback<Schema$RequestSyncDevicesResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$RequestSyncDevicesResponse>, callback?: BodyResponseCallback<Schema$RequestSyncDevicesResponse>): void|GaxiosPromise<Schema$RequestSyncDevicesResponse> {
  let params = (paramsOrCallback || {}) as Params$Resource$Devices$Requestsync;
  let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  const parameters = {
    ...
    if (callback) {
    createAPIRequest<Schema$RequestSyncDevicesResponse>(parameters, callback);
  } else {
...
sync(paramsOrCallback?: Params$Resource$Devices$Sync|BodyResponseCallback<Schema$SyncResponse>, optionsOrCallback?: MethodOptions|BodyResponseCallback<Schema$SyncResponse>, callback?: BodyResponseCallback<Schema$SyncResponse>): void|GaxiosPromise<Schema$SyncResponse> {
