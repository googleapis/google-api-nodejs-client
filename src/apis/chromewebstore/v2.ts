...
export namespace chromewebstore_v2 {
  ...
  export class Resource$Media {
    ...
    upload(
      params: Params$Resource$Media$Upload,
      options:
        MethodOptions | BodyResponseCallback<Schema$UploadItemPackageResponse>,
    ...
    upload(
      ...
      const parameters = {
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v2/{+name}:upload')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['name'],
        pathParams: ['name'],
  ...
  export class Resource$Publishers$Items {
    ...
    cancelSubmission(
      params: Params$Resource$Publishers$Items$Cancelsubmission,
      options:
        MethodOptions | BodyResponseCallback<Schema$CancelSubmissionResponse>,
    ...
    cancelSubmission(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:cancelSubmission')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchStatus(
      params: Params$Resource$Publishers$Items$Fetchstatus,
      options:
        MethodOptions | BodyResponseCallback<Schema$FetchItemStatusResponse>,
    ...
    fetchStatus(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:fetchStatus')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    setPublishedDeployPercentage(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+name}:setPublishedDeployPercentage')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
