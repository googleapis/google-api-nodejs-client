...
```sh
$ npm install @googleapis/androidenterprise
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/androidenterprise/classes/Androidenterprise.html).
...
```html
<script src="/path/to/androidenterprise.min.js"></script>
<script>
const { androidenterprise, auth } = Androidenterprise;
</script>
```
