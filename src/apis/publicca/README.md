...
legacy application, please use [@google-cloud/publicca](https://www.npmjs.com/package/@google-cloud/publicca) instead.
The [@google-cloud/publicca](https://www.npmjs.com/package/@google-cloud/publicca) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/publicca
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/publicca/classes/Publicca.html).
