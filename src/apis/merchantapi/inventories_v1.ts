    ...
    delete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/inventories/v1/{+name}').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'DELETE',
    ...
    insert(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/inventories/v1/{+parent}/localInventories:insert'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/inventories/v1/{+parent}/localInventories'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/inventories/v1/{+parent}/regionalInventories'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
