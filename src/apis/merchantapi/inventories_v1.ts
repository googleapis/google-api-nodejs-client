...
export namespace merchantapi_inventories_v1 {
   ...
   */
  export interface Schema$InventoryLoyaltyProgram {
    /**
     ...
     */
    memberPriceEffectiveInterval?: Schema$Interval;
    /**
  ...
  export interface Schema$LocalInventoryAttributes {
     ...
     */
    loyaltyPrograms?: Schema$InventoryLoyaltyProgram[];
    /**
  ...
  export class Resource$Accounts$Products$Localinventories {
    ...
    delete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/inventories/v1/{+name}')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'DELETE',
            apiVersion: '',
    ...
    insert(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/inventories/v1/{+parent}/localInventories:insert')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/inventories/v1/{+parent}/localInventories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Products$Regionalinventories {
    ...
    insert(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/inventories/v1/{+parent}/regionalInventories:insert'
            )
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/inventories/v1/{+parent}/regionalInventories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
