...
export namespace merchantapi_conversions_v1 {
  ...
  export class Resource$Accounts$Conversionsources {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/conversions/v1/{+parent}/conversionSources'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    delete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/conversions/v1/{+name}').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'DELETE',
    ...
    undelete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/conversions/v1/{+name}:undelete').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
