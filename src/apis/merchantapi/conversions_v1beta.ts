...
export namespace merchantapi_conversions_v1beta {
  ...
  export class Resource$Accounts {
    ...
    constructor(context: APIRequestContext) {
      ...
      this.conversionSources = new Resource$Accounts$Conversionsources(
        this.context
      );
    }
  }
  ...
  export class Resource$Accounts$Conversionsources {
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Accounts$Conversionsources$Create
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$Accounts$Conversionsources$Create;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/conversions/v1beta/{+parent}/conversionSources'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
    ...
    delete(
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Conversionsources$Delete;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/conversions/v1beta/{+name}').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'DELETE',
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Accounts$Conversionsources$Get
        | BodyResponseCallback<Schema$ConversionSource>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Conversionsources$Get;
        options = {};
      }
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Accounts$Conversionsources$List
        | BodyResponseCallback<Schema$ListConversionSourcesResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Conversionsources$List;
        options = {};
      }
    ...
    patch(
      paramsOrCallback?:
        | Params$Resource$Accounts$Conversionsources$Patch
        | BodyResponseCallback<Schema$ConversionSource>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Conversionsources$Patch;
        options = {};
      }
    ...
    undelete(
      paramsOrCallback?:
        | Params$Resource$Accounts$Conversionsources$Undelete
        | BodyResponseCallback<Schema$ConversionSource>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Conversionsources$Undelete;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/conversions/v1beta/{+name}:undelete').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export interface Params$Resource$Accounts$Conversionsources$Create
  ...
  export interface Params$Resource$Accounts$Conversionsources$Delete
    extends StandardParameters {
    /**
     * Required. The name of the conversion source to be deleted. Format: `accounts/{account\}/conversionSources/{conversion_source\}`
     */
  ...
  export interface Params$Resource$Accounts$Conversionsources$List
    extends StandardParameters {
    /**
     * Optional. The maximum number of conversion sources to return in a page. If no `page_size` is specified, `100` is used as the default value. The maximum value is `200`. Values above `200` will be coerced to `200`. Regardless of pagination, at most `200` conversion sources are returned in total.
     */
  ...
  export interface Params$Resource$Accounts$Conversionsources$Patch
    extends StandardParameters {
    /**
     * Output only. Identifier. Generated by the Content API upon creation of a new `ConversionSource`. Format: `[a-z]{4\}:.+` The four characters before the colon represent the type of conversion source. Content after the colon represents the ID of the conversion source within that type. The ID of two different conversion sources might be the same across different types. The following type prefixes are supported: * `galk`: For GoogleAnalyticsLink sources. * `mcdn`: For MerchantCenterDestination sources.
     */
  ...
  export interface Params$Resource$Accounts$Conversionsources$Undelete
    extends StandardParameters {
    /**
     * Required. The name of the conversion source to be undeleted. Format: `accounts/{account\}/conversionSources/{conversion_source\}`
     */
