...
legacy application, please use [@google-shopping/accounts](https://www.npmjs.com/package/@google-shopping/accounts) instead.
The [@google-shopping/accounts](https://www.npmjs.com/package/@google-shopping/accounts) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/merchantapi
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/merchantapi/classes/Merchantapi.html).
