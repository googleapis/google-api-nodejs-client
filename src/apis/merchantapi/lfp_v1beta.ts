    ...
    insert(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/lfp/v1beta/{+parent}/lfpInventories:insert')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Lfpsales {
    ...
    insert(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/lfp/v1beta/{+parent}/lfpSales:insert')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Lfpstores {
    ...
    insert(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/lfp/v1beta/{+parent}/lfpStores:insert')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/lfp/v1beta/{+parent}/lfpStores')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
