...
export namespace merchantapi_issueresolution_v1 {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/issueresolution/v1/{+parent}/aggregateProductStatuses'
            )
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
  ...
  export class Resource$Issueresolution {
    ...
    renderaccountissues(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/issueresolution/v1/{+name}:renderaccountissues')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    renderproductissues(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/issueresolution/v1/{+name}:renderproductissues')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    triggeraction(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/issueresolution/v1/{+name}:triggeraction')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
