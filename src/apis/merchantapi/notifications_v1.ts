...
export namespace merchantapi_notifications_v1 {
  ...
  export class Resource$Accounts$Notificationsubscriptions {
    ...
    create(
      params: Params$Resource$Accounts$Notificationsubscriptions$Create,
      options:
        MethodOptions | BodyResponseCallback<Schema$NotificationSubscription>,
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/notifications/v1/{+parent}/notificationsubscriptions'
            )
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
    ...
    delete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/notifications/v1/{+name}')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'DELETE',
            apiVersion: '',
