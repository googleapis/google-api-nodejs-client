...
export namespace merchantapi_accounts_v1beta {
  ...
  export class Resource$Accounts {
    ...
    createAndConfigure(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/accounts:createAndConfigure')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
     ...
     */
    createTestAccount(
      params: Params$Resource$Accounts$Createtestaccount,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    createTestAccount(
      params?: Params$Resource$Accounts$Createtestaccount,
    ...
    createTestAccount(
      paramsOrCallback?:
        | Params$Resource$Accounts$Createtestaccount
        | BodyResponseCallback<Schema$Account>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Accounts$Createtestaccount;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Accounts$Createtestaccount;
        options = {};
      }
    ...
    delete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'DELETE',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/accounts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    listSubaccounts(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+provider}:listSubaccounts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Developerregistration {
    ...
    getAccountForGcpRegistration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/accounts/v1beta/accounts:getAccountForGcpRegistration'
            )
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
    ...
    registerGcp(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:registerGcp')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    unregisterGcp(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:unregisterGcp')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Gbpaccounts {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/gbpAccounts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Homepage {
    ...
    claim(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:claim')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    unclaim(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:unclaim')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Issues {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/issues')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Omnichannelsettings {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/omnichannelSettings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Omnichannelsettings$Lfpproviders {
    ...
    find(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/lfpProviders:find')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    linkLfpProvider(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:linkLfpProvider')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Onlinereturnpolicies {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/onlineReturnPolicies')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Programs {
    ...
    disable(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:disable')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    enable(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:enable')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/programs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Programs$Checkoutsettings {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/checkoutSettings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Regions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/regions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Relationships {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/relationships')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Accounts$Services {
    ...
    approve(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:approve')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/services')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    propose(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/services:propose')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    reject(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:reject')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Users {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+parent}/users')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Users$Me {
    ...
    verifySelf(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+account}/users/me:verifySelf')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'PATCH',
            apiVersion: '',
  ...
  export class Resource$Termsofservice {
    ...
    accept(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/{+name}:accept')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    retrieveLatest(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/accounts/v1beta/termsOfService:retrieveLatest')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
