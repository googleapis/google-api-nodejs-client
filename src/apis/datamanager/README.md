...
legacy application, please use [@google-ads/datamanager](https://www.npmjs.com/package/@google-ads/datamanager) instead.
The [@google-ads/datamanager](https://www.npmjs.com/package/@google-ads/datamanager) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/datamanager
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/datamanager/classes/Datamanager.html).
