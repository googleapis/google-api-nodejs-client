...
legacy application, please use [@google-cloud/resource-settings](https://www.npmjs.com/package/@google-cloud/resource-settings) instead.
The [@google-cloud/resource-settings](https://www.npmjs.com/package/@google-cloud/resource-settings) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/resourcesettings
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/resourcesettings/classes/Resourcesettings.html).
