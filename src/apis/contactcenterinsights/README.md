...
legacy application, please use [@google-cloud/contact-center-insights](https://www.npmjs.com/package/@google-cloud/contact-center-insights) instead.
The [@google-cloud/contact-center-insights](https://www.npmjs.com/package/@google-cloud/contact-center-insights) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/contactcenterinsights
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/contactcenterinsights/classes/Contactcenterinsights.html).
