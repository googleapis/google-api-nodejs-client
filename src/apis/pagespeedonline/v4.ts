...
export namespace pagespeedonline_v4 {
  ...
  export class Resource$Pagespeedapi {
     ...
     * @param {boolean=} params.snapshots Indicates if binary data containing
     *     snapshot images should be included
     * @param {string=} params.strategy The analysis strategy (desktop or
     *     mobile) to use, and desktop is the default
