...
legacy application, please use [@google-cloud/vmwareengine](https://www.npmjs.com/package/@google-cloud/vmwareengine) instead.
The [@google-cloud/vmwareengine](https://www.npmjs.com/package/@google-cloud/vmwareengine) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/vmwareengine
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/vmwareengine/classes/Vmwareengine.html).
