...
export namespace pubsub_v1beta1a {
  ...
  export class Resource$Subscriptions {
    ...
    pullBatch(
      params?: Params$Resource$Subscriptions$Pullbatch,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$PullBatchResponse>>;
    pullBatch(
      params: Params$Resource$Subscriptions$Pullbatch,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Topics {
    ...
    publishBatch(
      params?: Params$Resource$Topics$Publishbatch,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$PublishBatchResponse>>;
    publishBatch(
      params: Params$Resource$Topics$Publishbatch,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    publishBatch(
      params: Params$Resource$Topics$Publishbatch,
      options:
        MethodOptions | BodyResponseCallback<Schema$PublishBatchResponse>,
