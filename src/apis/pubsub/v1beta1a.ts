  ...
  self.subscriptions = {
    ...
    modifyAckDeadline(
      ...
      return createAPIRequest(parameters, callback!);
        ...
        * to an endpoint by clearing the <code>PushConfig</code> field in the
        * request. Messages will be accumulated for delivery even if no push
    ...
    modifyPushConfig(
      ...
      return createAPIRequest(parameters, callback!);
        ...
        * returns FAILED_PRECONDITION. The system is free to return an
  ...
  self.topics = {
    ...
    delete (
      ...
      return createAPIRequest(parameters, callback!);
        ...
        * topic. If other attributes are added in the future, they will be
        * returned here.
 ...
 * @memberOf! pubsub(v1beta1a)
 * @type object
 * @property {string} nextPageToken If not empty, indicates that there are more subscriptions that match the request and this value should be passed to the next &lt;code&gt;ListSubscriptionsRequest&lt;/code&gt; to continue.
 ...
 * @memberOf! pubsub(v1beta1a)
 * @type object
 * @property {string} nextPageToken If not empty, indicates that there are more topics that match the request, and this value should be passed to the next &lt;code&gt;ListTopicsRequest&lt;/code&gt; to continue.
 ...
 * @memberOf! pubsub(v1beta1a)
 * @type object
 * @property {pubsub(v1beta1a).PushConfig} pushConfig An empty &lt;code&gt;push_config&lt;/code&gt; indicates that the Pub/Sub system should pause pushing messages from the given subscription.
