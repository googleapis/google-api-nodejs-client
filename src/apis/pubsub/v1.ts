...
export namespace pubsub_v1 {
  ...
  export class Resource$Projects$Schemas {
    ...
    validateMessage(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/schemas:validateMessage')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Snapshots {
    ...
    delete(
      ...
      if (params.snapshot !== undefined && params.snapshot !== null) {
        validateMultiSegment('snapshot', String(params.snapshot));
        params.snapshot = encodeWithoutSlashes(String(params.snapshot));
      }
  ...
  export class Resource$Projects$Subscriptions {
    ...
    detach(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+subscription}:detach')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
