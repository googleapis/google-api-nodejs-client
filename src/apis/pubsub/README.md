...
legacy application, please use [@google-cloud/pubsub-api](https://www.npmjs.com/package/@google-cloud/pubsub-api) instead.
The [@google-cloud/pubsub-api](https://www.npmjs.com/package/@google-cloud/pubsub-api) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/pubsub
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/pubsub/classes/Pubsub.html).
