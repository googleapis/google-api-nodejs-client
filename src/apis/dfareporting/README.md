...
```sh
$ npm install @googleapis/dfareporting
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/dfareporting/classes/Dfareporting.html).
...
```html
<script src="/path/to/dfareporting.min.js"></script>
<script>
const { dfareporting, auth } = Dfareporting;
</script>
```
