...
legacy application, please use [@google-cloud/dataflow](https://www.npmjs.com/package/@google-cloud/dataflow) instead.
The [@google-cloud/dataflow](https://www.npmjs.com/package/@google-cloud/dataflow) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/dataflow
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/dataflow/classes/Dataflow.html).
