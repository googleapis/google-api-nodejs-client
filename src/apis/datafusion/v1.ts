...
export namespace datafusion_v1 {
  ...
  export interface Schema$LoggingConfig {
     ...
     */
    enableInstanceV2Logs?: boolean | null;
    /**
  ...
  export class Resource$Projects$Locations$Instances$Dnspeerings {
    ...
    create(
      params?: Params$Resource$Projects$Locations$Instances$Dnspeerings$Create,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$DnsPeering>>;
    create(
      params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    create(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$DnsPeering> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$DnsPeering>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/dnsPeerings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params?: Params$Resource$Projects$Locations$Instances$Dnspeerings$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListDnsPeeringsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Instances$Dnspeerings$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      params: Params$Resource$Projects$Locations$Instances$Dnspeerings$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListDnsPeeringsResponse>,
  ...
  export class Resource$Projects$Locations$Versions {
    ...
    list(
      params?: Params$Resource$Projects$Locations$Versions$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListAvailableVersionsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Versions$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$ListAvailableVersionsResponse>,
      callback: BodyResponseCallback<Schema$ListAvailableVersionsResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Versions$List,
      callback: BodyResponseCallback<Schema$ListAvailableVersionsResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Versions$List
        | BodyResponseCallback<Schema$ListAvailableVersionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Versions$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Versions$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ListAvailableVersionsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListAvailableVersionsResponse>(
          parameters
        );
      }
    }
