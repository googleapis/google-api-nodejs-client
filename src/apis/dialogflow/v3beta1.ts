  ...
  export class Resource$Projects$Locations$Agents$Testcases {
    ...
    run(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/v3beta1/projects/{projectsId}/locations/{locationsId}/agents/{agentsId}/testCases:run'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        params,
        requiredParams: ['projectsId', 'locationsId', 'agentsId'],
        pathParams: ['agentsId', 'locationsId', 'projectsId'],
        context: this.context,
      };
      if (callback) {
        createAPIRequest<Schema$GoogleLongrunningOperation>(
