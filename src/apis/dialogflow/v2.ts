...
export namespace dialogflow_v2 {
  ...
  export class Resource$Projects$Agent$Environments {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.intents = new Resource$Projects$Agent$Environments$Intents(
        this.context
      );
  ...
  export class Resource$Projects$Agent$Environments$Intents {
     ...
     */
    list(
      params: Params$Resource$Projects$Agent$Environments$Intents$List,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    list(
      params?: Params$Resource$Projects$Agent$Environments$Intents$List,
    ...
    list(
      ...
      | GaxiosPromise<Readable> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Agent$Environments$Intents$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Agent$Environments$Intents$List;
        options = {};
      }
