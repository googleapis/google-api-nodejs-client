  ...
  export class Resource$Users$Environments {
    ...
    addPublicKey(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+environment}:addPublicKey')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    generateAccessToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+environment}:generateAccessToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    removePublicKey(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+environment}:removePublicKey')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
