  ...
  self.folders = {
    ...
    get(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * field should be the Folder's resource name, e.g. "folders/1234". The
    ...
    list(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * Upon success the Operation.response field will be populated with the
        * moved Folder. Upon failure, a FolderOperationError categorizing the
        * failure cause will be returned - if the failure occurs synchronously
        ...
        * returned via the the Operation.error field. In addition, the
    ...
    patch(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * access to which meet the specified filter criteria.  This will only
    ...
    search(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * existing policy. The `resource` field should be the Folder's resource
        * name, e.g. "folders/1234". The caller must have
