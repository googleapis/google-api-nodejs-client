...
legacy application, please use [@google-cloud/resource-manager](https://www.npmjs.com/package/@google-cloud/resource-manager) instead.
The [@google-cloud/resource-manager](https://www.npmjs.com/package/@google-cloud/resource-manager) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/cloudresourcemanager
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/cloudresourcemanager/classes/Cloudresourcemanager.html).
