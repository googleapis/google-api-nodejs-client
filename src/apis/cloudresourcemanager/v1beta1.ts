  ...
  self.organizations = {
    ...
    get(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * // BEFORE RUNNING:
        * // ---------------
        * // 1. If not already done, enable the Google Cloud Resource Manager
        * API
        * //    and check the quota for your project at
        * // https://console.developers.google.com/apis/api/cloudresourcemanager
        * // 2. This sample uses Application Default Credentials for
        ...
        * this field. resource_: 'organizations/my-organization',  // TODO:
        * Update placeholder value.
        *
        *     resource: {
        ...
        *   };
        *
        *   cloudResourceManager.organizations.getIamPolicy(request,
    ...
    list(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        *   };
        *
        *   cloudResourceManager.organizations.setIamPolicy(request,
        * function(err, response) { if (err) { console.error(err); return;
        *     }
        *
        *     // TODO: Change code below to process the `response` object:
    ...
    setIamPolicy(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * Organization. The `resource` field should be the organization's
  ...
  self.projects = {
    ...
    create(params, options, callback) {
      ...
      const parameters = {
        options: Object.assign(
            {
              url:
                  (rootUrl + '/v1beta1/projects').replace(/([^:]\/)\/+/g, '$1'),
              method: 'POST'
            },
            options),
        params,
      ...
      return createAPIRequest(parameters, callback);
        ...
        * lifecycle state of ACTIVE.  This method changes the Project's
    ...
    getAncestry(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        *     // REQUIRED: The resource for which the policy is being requested.
        *     // See the operation documentation for the appropriate value for
        * this field. resource_: 'my-resource',  // TODO: Update placeholder
        * value.
        *
        *     resource: {
        *       // TODO: Add desired properties to the request body.
    ...
    list(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * (ToS) will be rejected.  + If the project is not part of an
    ...
    testIamPermissions(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * (for example, `my-project-123`). You can only use this method for a
        * Project that has a lifecycle state of DELETE_REQUESTED. After deletion
        * starts, the Project cannot be restored.  The caller must have modify
        * permissions for this Project.
        * @example
        * // BEFORE RUNNING:
        * // ---------------
    ...
    undelete(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        *   };
        *
        *   cloudResourceManager.projects.update(request, function(err,
        * response) { if (err) { console.error(err); return;
        *     }
        *
        *     // TODO: Change code below to process the `response` object:
 ...
 * @memberOf! cloudresourcemanager(v1beta1)
 * @type object
 * @property {cloudresourcemanager(v1beta1).AuditLogConfig[]} auditLogConfigs The configuration for logging of each type of permission. Next ID: 4
 ...
 * @memberOf! cloudresourcemanager(v1beta1)
 * @type object
 * @property {cloudresourcemanager(v1beta1).Ancestor[]} ancestor Ancestors are ordered from bottom to top of the resource hierarchy. The first ancestor is the project itself, followed by the project&#39;s parent, etc.
 */
/**
 ...
 * @memberOf! cloudresourcemanager(v1beta1)
 * @type object
 * @property {string} nextPageToken A pagination token to be used to retrieve the next page of results. If the result is too large to fit within the page size specified in the request, this field will be set with a token that can be used to fetch the next page of results. If this field is empty, it indicates that this response contains the last page of results.
 ...
 * @property {cloudresourcemanager(v1beta1).Project[]} projects The list of Projects that matched the list filter. This list can be paginated.
 */
/**
 ...
 * @property {string} type Required field representing the resource type this id is for. At present, the valid types are &quot;project&quot;, &quot;folder&quot;, and &quot;organization&quot;.
 */
/**
 * @typedef SetIamPolicyRequest
 * @memberOf! cloudresourcemanager(v1beta1)
 * @type object
 * @property {cloudresourcemanager(v1beta1).Policy} policy REQUIRED: The complete policy to be applied to the `resource`. The size of the policy is limited to a few 10s of KB. An empty policy is a valid policy but certain Cloud Platform services (such as Projects) might reject them.
