...
legacy application, please use [@google-cloud/iap](https://www.npmjs.com/package/@google-cloud/iap) instead.
The [@google-cloud/iap](https://www.npmjs.com/package/@google-cloud/iap) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/iap
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/iap/classes/Iap.html).
