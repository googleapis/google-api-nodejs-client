...
```sh
$ cd src/apis/plusDomains
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/plusDomains.min.js`. Use it from your HTML file:

```html
<script src="/path/to/plusDomains.min.js"></script>
<script>
const { plusDomains, auth } = Plusdomains;
</script>
```
