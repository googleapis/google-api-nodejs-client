  ...
  self.projects = {
    ...
    getSettings(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * Reader access for owners/editors/viewers of customer project See
        * Google Cloud Storage documentation for more details.  If there is
        * already a default bucket set and the project can access the bucket,
      ...
      executions: {
        ...
        create(params, options, callback) {
          ...
          return createAPIRequest(parameters, callback);
            ...
            * authorized to write to project - INVALID_ARGUMENT - if the request
        ...
        steps: {
          ...
          create(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * authorized to read project - INVALID_ARGUMENT - if the request
              * is malformed - NOT_FOUND - if the Step does not exist
          ...
          getPerfMetricsSummary(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * by creation_time in descending order. The step_id key will be
              * used to order the steps with the same creation_time.  May return
              * any of the following canonical error codes:  - PERMISSION_DENIED
              * - if the user is not authorized to read project -
              * INVALID_ARGUMENT - if the request is malformed -
              * FAILED_PRECONDITION - if an argument in the request happens to
              * be invalid; e.g. if an attempt is made to list the children of a
              * nonexistent Step - NOT_FOUND - if the containing Execution does
              * not exist
          ...
          list(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * illegal (e.g try to upload a duplicate xml file), if the updated
              * step is too large (more than 10Mib) - NOT_FOUND - if the
          ...
          patch(params, options, callback) {
            ...
            return createAPIRequest(parameters, callback);
              ...
              * the following canonical error codes:  - PERMISSION_DENIED - if
              * the user is not authorized to write project - INVALID_ARGUMENT -
              * if the request is malformed - FAILED_PRECONDITION - if the
              * requested state transition is illegal, e.g try to upload a
          ...
          perfSampleSeries: {
            ...
            get(params, options, callback) {
              ...
              return createAPIRequest(parameters, callback);
                ...
                * The resulting PerfSampleSeries are sorted by ids.  May return
                * any of the following canonical error codes: - NOT_FOUND - The
            ...
            samples:
                {
                  ...
                  batchCreate(params, options, callback) {
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * maximum size allowed 5000 - The response token indicates
                      * the last returned PerfSample timestamp - When the
                      * results size exceeds the page size, submit a subsequent
                      * request including the page token to return the rest of
                      * the samples up to the page limit  May return any of the
                      * following canonical error codes: - OUT_OF_RANGE - The
                      * specified request page_token is out of valid range -
 ...
 * @property {string[]} testTargets Each target must be fully qualified with the package name or class name, in one of these formats: - &quot;package package_name&quot; - &quot;class package_name.class_name&quot; - &quot;class package_name.class_name#method_name&quot;  If empty, all targets in the module will be run.
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {string} typeUrl A URL/resource name that uniquely identifies the type of the serialized protocol buffer message. The last segment of the URL&#39;s path must represent the fully qualified name of the type (as in `path/google.protobuf.Duration`). The name should be in a canonical form (e.g., leading &quot;.&quot; is not accepted).  In practice, teams usually precompile into the binary all types that they expect it to use in the context of Any. However, for URLs which use the scheme `http`, `https`, or no scheme, one can optionally set up a type server that maps type URLs to message definitions as follows:  * If no scheme is provided, `https` is assumed. * An HTTP GET on the URL must yield a [google.protobuf.Type][] value in binary format, or produce an error. * Applications are allowed to cache lookup results based on the URL, or have them precompiled into a binary to avoid any lookup. Therefore, binary compatibility needs to be preserved on changes to types. (Use versioned type names to manage breaking changes.)  Note: this functionality is not currently available in the official protobuf release, and it is not used for type URLs beginning with type.googleapis.com.  Schemes other than `http`, `https` (or the empty scheme) might be used with implementation specific semantics.
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).Timestamp} completionTime The time when the Execution status transitioned to COMPLETE.  This value will be set automatically when state transitions to COMPLETE.  - In response: set if the execution state is COMPLETE. - In create/update request: never set
 * @property {toolresults(v1beta3).Timestamp} creationTime The time when the Execution was created.  This value will be set automatically when CreateExecution is called.  - In response: always set - In create/update request: never set
 * @property {string} executionId A unique identifier within a History for this Execution.  Returns INVALID_ARGUMENT if this field is set or overwritten by the caller.  - In response always set - In create/update request: never set
 * @property {toolresults(v1beta3).Outcome} outcome Classify the result, for example into SUCCESS or FAILURE  - In response: present if set by create/update request - In create/update request: optional
 * @property {toolresults(v1beta3).Specification} specification Lightweight information about execution request.  - In response: present if set by create - In create: optional - In update: optional
 * @property {string} state The initial state is IN_PROGRESS.  The only legal state transitions is from IN_PROGRESS to COMPLETE.  A PRECONDITION_FAILED will be returned if an invalid transition is requested.  The state can only be set to COMPLETE once. A FAILED_PRECONDITION will be returned if the state is set to COMPLETE multiple times.  If the state is set to COMPLETE, all the in-progress steps within the execution will be set as COMPLETE. If the outcome of the step is not set, the outcome will be set to INCONCLUSIVE.  - In response always set - In create/update request: optional
 * @property {string} testExecutionMatrixId TestExecution Matrix ID that the TestExecutionService uses.  - In response: present if set by create - In create: optional - In update: never set
 */
/**
 ...
 * @property {toolresults(v1beta3).ToolOutputReference} sourceImage A reference to the full-size, original image.  This is the same as the tool_outputs entry for the image under its Step.  Always set.
 * @property {string} stepId The step to which the image is attached.  Always set.
 ...
 * @property {boolean} infrastructureFailure If the test runner could not determine success or failure because the test depends on a component other than the system under test which failed.  For example, a mobile test requires provisioning a device where the test executes, and that provisioning can fail.
 */
/**
 * @typedef ListExecutionsResponse
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).Execution[]} executions Executions.  Always set.
 * @property {string} nextPageToken A continuation token to resume the query at the next item.  Will only be set if there are more Executions to fetch.
 */
/**
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {string} nextPageToken A continuation token to resume the query at the next item.  If set, indicates that there are more steps to read, by calling list again with this value in the page_token field.
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {string} nextPageToken A continuation token to resume the query at the next item.  If set, indicates that there are more thumbnails to read, by calling list again with this value in the page_token field.
 * @property {toolresults(v1beta3).Image[]} thumbnails A list of image data.  Images are returned in a deterministic order; they are ordered by these factors, in order of importance: * First, by their associated test case. Images without a test case are considered greater than images with one. * Second, by their creation time. Images without a creation time are greater than images with one. * Third, by the order in which they were added to the step (by calls to CreateStep or UpdateStep).
 */
/**
 * @typedef MemoryInfo
 * @memberOf! toolresults(v1beta3)
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).FailureDetail} failureDetail More information about a FAILURE outcome.  Returns INVALID_ARGUMENT if this field is set but the summary is not FAILURE.  Optional
 * @property {toolresults(v1beta3).InconclusiveDetail} inconclusiveDetail More information about an INCONCLUSIVE outcome.  Returns INVALID_ARGUMENT if this field is set but the summary is not INCONCLUSIVE.  Optional
 * @property {toolresults(v1beta3).SkippedDetail} skippedDetail More information about a SKIPPED outcome.  Returns INVALID_ARGUMENT if this field is set but the summary is not SKIPPED.  Optional
 * @property {toolresults(v1beta3).SuccessDetail} successDetail More information about a SUCCESS outcome.  Returns INVALID_ARGUMENT if this field is set but the summary is not SUCCESS.  Optional
 * @property {string} summary The simplest way to interpret a result.  Required
 */
/**
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {string} defaultBucket The name of the Google Cloud Storage bucket to which results are written.  By default, this is unset.  In update request: optional In response: optional
 * @property {string} name The name of the project&#39;s settings.  Always of the form: projects/{project-id}/settings  In update request: never set In response: always set
 */
/**
 * @typedef PublishXunitXmlFilesRequest
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).FileReference[]} xunitXmlFiles URI of the Xunit XML files to publish.  The maximum size of the file this reference is pointing to is 50MB.  Required.
 */
/**
 * @typedef Screen
 * @memberOf! toolresults(v1beta3)
 ...
 * @property {string} exception The stack trace message.  Required
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).Timestamp} completionTime The time when the step status was set to complete.  This value will be set automatically when state transitions to COMPLETE.  - In response: set if the execution state is COMPLETE. - In create/update request: never set
 * @property {toolresults(v1beta3).Timestamp} creationTime The time when the step was created.  - In response: always set - In create/update request: never set
 * @property {string} description A description of this tool For example: mvn clean package -D skipTests=true  - In response: present if set by create/update request - In create/update request: optional
 * @property {toolresults(v1beta3).Duration} deviceUsageDuration How much the device resource is used to perform the test.  This is the device usage used for billing purpose, which is different from the run_duration, for example, infrastructure failure won&#39;t be charged for device usage.  PRECONDITION_FAILED will be returned if one attempts to set a device_usage on a step which already has this field set.  - In response: present if previously set. - In create request: optional - In update request: optional
 * @property {toolresults(v1beta3).StepDimensionValueEntry[]} dimensionValue If the execution containing this step has any dimension_definition set, then this field allows the child to specify the values of the dimensions.  The keys must exactly match the dimension_definition of the execution.  For example, if the execution has `dimension_definition = [&#39;attempt&#39;, &#39;device&#39;]` then a step must define values for those dimensions, eg. `dimension_value = [&#39;attempt&#39;: &#39;1&#39;, &#39;device&#39;: &#39;Nexus 6&#39;]`  If a step does not participate in one dimension of the matrix, the value for that dimension should be empty string. For example, if one of the tests is executed by a runner which does not support retries, the step could have `dimension_value = [&#39;attempt&#39;: &#39;&#39;, &#39;device&#39;: &#39;Nexus 6&#39;]`  If the step does not participate in any dimensions of the matrix, it may leave dimension_value unset.  A PRECONDITION_FAILED will be returned if any of the keys do not exist in the dimension_definition of the execution.  A PRECONDITION_FAILED will be returned if another step in this execution already has the same name and dimension_value, but differs on other data fields, for example, step field is different.  A PRECONDITION_FAILED will be returned if dimension_value is set, and there is a dimension_definition in the execution which is not specified as one of the keys.  - In response: present if set by create - In create request: optional - In update request: never set
 * @property {boolean} hasImages Whether any of the outputs of this step are images whose thumbnails can be fetched with ListThumbnails.  - In response: always set - In create/update request: never set
 * @property {toolresults(v1beta3).StepLabelsEntry[]} labels Arbitrary user-supplied key/value pairs that are associated with the step.  Users are responsible for managing the key namespace such that keys don&#39;t accidentally collide.  An INVALID_ARGUMENT will be returned if the number of labels exceeds 100 or if the length of any of the keys or values exceeds 100 characters.  - In response: always set - In create request: optional - In update request: optional; any new key/value pair will be added to the map, and any new value for an existing key will update that key&#39;s value
 * @property {string} name A short human-readable name to display in the UI. Maximum of 100 characters. For example: Clean build  A PRECONDITION_FAILED will be returned upon creating a new step if it shares its name and dimension_value with an existing step. If two steps represent a similar action, but have different dimension values, they should share the same name. For instance, if the same set of tests is run on two different platforms, the two steps should have the same name.  - In response: always set - In create request: always set - In update request: never set
 * @property {toolresults(v1beta3).Outcome} outcome Classification of the result, for example into SUCCESS or FAILURE  - In response: present if set by create/update request - In create/update request: optional
 * @property {toolresults(v1beta3).Duration} runDuration How long it took for this step to run.  If unset, this is set to the difference between creation_time and completion_time when the step is set to the COMPLETE state. In some cases, it is appropriate to set this value separately: For instance, if a step is created, but the operation it represents is queued for a few minutes before it executes, it would be appropriate not to include the time spent queued in its run_duration.  PRECONDITION_FAILED will be returned if one attempts to set a run_duration on a step which already has this field set.  - In response: present if previously set; always present on COMPLETE step - In create request: optional - In update request: optional
 * @property {string} state The initial state is IN_PROGRESS. The only legal state transitions are * IN_PROGRESS -&gt; COMPLETE  A PRECONDITION_FAILED will be returned if an invalid transition is requested.  It is valid to create Step with a state set to COMPLETE. The state can only be set to COMPLETE once. A PRECONDITION_FAILED will be returned if the state is set to COMPLETE multiple times.  - In response: always set - In create/update request: optional
 * @property {string} stepId A unique identifier within a Execution for this Step.  Returns INVALID_ARGUMENT if this field is set or overwritten by the caller.  - In response: always set - In create/update request: never set
 ...
 * @property {string} name The name of the test case.  Required.
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).TestIssue[]} testIssues Issues observed during the test execution.  For example, if the mobile app under test crashed during the test, the error message and the stack trace content can be recorded here to assist debugging.  - In response: present if set by create or update - In create/update request: optional
 * @property {toolresults(v1beta3).TestSuiteOverview[]} testSuiteOverviews List of test suite overview contents. This could be parsed from xUnit XML log by server, or uploaded directly by user. This references should only be called when test suites are fully parsed or uploaded.  The maximum allowed number of test suite overviews per step is 1000.  - In response: always set - In create request: optional - In update request: never (use publishXunitXmlFiles custom method instead)
 * @property {toolresults(v1beta3).TestTiming} testTiming The timing break down of the test execution.  - In response: present if set by create or update - In create/update request: optional
 * @property {toolresults(v1beta3).ToolExecution} toolExecution Represents the execution of the test runner.  The exit code of this tool will be used to determine if the test passed.  - In response: always set - In create/update request: optional
 */
/**
 * @typedef TestIssue
 * @memberOf! toolresults(v1beta3)
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {integer} errorCount Number of test cases in error, typically set by the service by parsing the xml_source.  - In create/response: always set - In update request: never
 * @property {integer} failureCount Number of failed test cases, typically set by the service by parsing the xml_source. May also be set by the user.  - In create/response: always set - In update request: never
 * @property {string} name The name of the test suite.  - In create/response: always set - In update request: never
 * @property {integer} skippedCount Number of test cases not run, typically set by the service by parsing the xml_source.  - In create/response: always set - In update request: never
 * @property {integer} totalCount Number of test cases, typically set by the service by parsing the xml_source.  - In create/response: always set - In update request: never
 * @property {toolresults(v1beta3).FileReference} xmlSource If this test suite was parsed from XML, this is the URI where the original XML file is stored.  Note: Multiple test suites can share the same xml_source  Returns INVALID_ARGUMENT if the uri format is not supported.  - In create/response: optional - In update request: never
 */
/**
 * @typedef TestTiming
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).Duration} testProcessDuration How long it took to run the test process.  - In response: present if previously set. - In create/update request: optional
 */
/**
 * @typedef Thumbnail
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {string} contentType The thumbnail&#39;s content type, i.e. &quot;image/png&quot;.  Always set.
 * @property {string} data The thumbnail file itself.  That is, the bytes here are precisely the bytes that make up the thumbnail file; they can be served as an image as-is (with the appropriate content type.)  Always set.
 * @property {integer} heightPx The height of the thumbnail, in pixels.  Always set.
 * @property {integer} widthPx The width of the thumbnail, in pixels.  Always set.
 */
/**
 * @typedef Timestamp
 * @memberOf! toolresults(v1beta3)
 ...
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {string[]} commandLineArguments The full tokenized command line including the program name (equivalent to argv in a C program).  - In response: present if set by create request - In create request: optional - In update request: never set
 * @property {toolresults(v1beta3).ToolExitCode} exitCode Tool execution exit code. This field will be set once the tool has exited.  - In response: present if set by create/update request - In create request: optional - In update request: optional, a FAILED_PRECONDITION error will be returned if an exit_code is already set.
 ...
 * @property {toolresults(v1beta3).ToolOutputReference[]} toolOutputs References to opaque files of any format output by the tool execution.  The maximum allowed number of tool outputs per step is 1000.  - In response: present if set by create/update request - In create request: optional - In update request: optional, any value provided will be appended to the existing list
 */
/**
 * @typedef ToolExecutionStep
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).ToolExecution} toolExecution A Tool execution.  - In response: present if set by create/update request - In create/update request: optional
 */
/**
 * @typedef ToolExitCode
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {integer} number Tool execution exit code. A value of 0 means that the execution was successful.  - In response: always set - In create/update request: always set
 */
/**
 * @typedef ToolOutputReference
 * @memberOf! toolresults(v1beta3)
 * @type object
 * @property {toolresults(v1beta3).Timestamp} creationTime The creation time of the file.  - In response: present if set by create/update request - In create/update request: optional
 * @property {toolresults(v1beta3).FileReference} output A FileReference to an output file.  - In response: always set - In create/update request: always set
 * @property {toolresults(v1beta3).TestCaseReference} testCase The test case to which this output file belongs.  - In response: present if set by create/update request - In create/update request: optional
 */
