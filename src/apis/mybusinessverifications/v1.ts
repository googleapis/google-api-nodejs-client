...
export namespace mybusinessverifications_v1 {
  ...
  export class Resource$Locations {
    ...
    fetchVerificationOptions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+location}:fetchVerificationOptions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getVoiceOfMerchantState(
      params: Params$Resource$Locations$Getvoiceofmerchantstate,
      options:
        MethodOptions | BodyResponseCallback<Schema$VoiceOfMerchantState>,
    ...
    getVoiceOfMerchantState(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}/VoiceOfMerchantState')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    verify(
      params: Params$Resource$Locations$Verify,
      options:
        MethodOptions | BodyResponseCallback<Schema$VerifyLocationResponse>,
  ...
  export class Resource$Locations$Verifications {
    ...
    list(
      params: Params$Resource$Locations$Verifications$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListVerificationsResponse>,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/verifications')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Verificationtokens {
    ...
    generate(
      ...
      GaxiosResponseWithHTTP2<Schema$GenerateInstantVerificationTokenResponse>
    >;
    generate(
      params: Params$Resource$Verificationtokens$Generate,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    generate(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>,
      callback: BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>
    ): void;
    generate(
      params: Params$Resource$Verificationtokens$Generate,
      callback: BodyResponseCallback<Schema$GenerateInstantVerificationTokenResponse>
    ...
    generate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/verificationTokens:generate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$GenerateInstantVerificationTokenResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GenerateInstantVerificationTokenResponse>(
          parameters
        );
      }
    }
