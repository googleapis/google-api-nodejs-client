...
export namespace workloadmanager_v1 {
  ...
  export class Resource$Projects$Locations {
    ...
    sapSystems: Resource$Projects$Locations$Sapsystems;
    constructor(context: APIRequestContext) {
      this.context = context;
      ...
      this.sapSystems = new Resource$Projects$Locations$Sapsystems(
        this.context
      );
    }
  ...
  export class Resource$Projects$Locations$Sapsystems {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     */
    delete(
      params: Params$Resource$Projects$Locations$Sapsystems$Delete,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    delete(
      params?: Params$Resource$Projects$Locations$Sapsystems$Delete,
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Sapsystems$Delete
        | BodyResponseCallback<Schema$Empty>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Sapsystems$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Sapsystems$Delete;
        options = {};
      }
  ...
  export interface Params$Resource$Projects$Locations$Sapsystems$Delete
    extends StandardParameters {
    /**
