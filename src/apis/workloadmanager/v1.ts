...
export namespace workloadmanager_v1 {
  ...
  export class Resource$Projects$Locations$Discoveredprofiles {
    ...
    get(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$WorkloadProfile>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
    ...
    list(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$ListDiscoveredProfilesResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
  ...
  export class Resource$Projects$Locations$Discoveredprofiles$Healthes {
    ...
    get(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$WorkloadProfileHealth>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
  ...
  export class Resource$Projects$Locations$Evaluations {
    ...
    get(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$Evaluation>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
    ...
    list(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$ListEvaluationsResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
  ...
  export class Resource$Projects$Locations$Evaluations$Executions$Results {
    ...
    list(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$ListExecutionResultsResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
  ...
  export class Resource$Projects$Locations$Evaluations$Executions$Scannedresources {
    ...
    list(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$ListScannedResourcesResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
  ...
  export class Resource$Projects$Locations$Insights {
    ...
    writeInsight(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$WriteInsightResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
