...
```sh
$ npm install @googleapis/classroom
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/classroom/classes/Classroom.html).
...
```html
<script src="/path/to/classroom.min.js"></script>
<script>
