  ...
  self.annotations = {
    ...
    get(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * position). Annotations with equivalent genomic coordinates are
        ...
        * `annotationsPage`: console.log(JSON.stringify(annotationsPage[i],
        * null, 2));
        *     }
        *
  ...
  self.datasets = {
    ...
    patch(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * Replaces any existing policy.  For the definitions of datasets and
        * other genomics resources, see [Fundamentals of Google
        * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
    ...
    setIamPolicy(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        *   };
        *
        *   genomics.datasets.testIamPermissions(request, function(err,
  ...
  self.readgroupsets = {
    ...
    get(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * information.  For the definitions of read group sets and other
        * genomics resources, see [Fundamentals of Google
        * Genomics](https://cloud.google.com/genomics/fundamentals-of-google-genomics)
    ...
    import(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * authorize(function(authClient) {
        *   var request = {
        *     // The ID of the read group set to be updated. The caller must
        * have WRITE
        *     // permissions to the dataset associated with this read group set.
        *     readGroupSetId: 'my-read-group-set-id',  // TODO: Update
        * placeholder value.
  ...
  self.variants = {
    ...
    import(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        * added to the existing variant. Variant info fields are merged as
        ...
        * introduce mistakes in existing variants and difficult to back out of
        * them.  For example, suppose you were trying to merge a new variant
        * with an existing one and both variants contain calls that belong to
        * callsets with the same callset ID.      // Existing variant -
        ...
        * "CALLSET0",                 "genotype": [                     0,
        * 1                 ],             }         ]     }      // New variant
        * with conflicting call information     {         "variantSetId":
        * "10473108253681171589",         "referenceName": "1",         "start":
        * "10582",         "referenceBases": "G",         "alternateBases": [
        * "A"         ],         "calls": [             {
        * "callSetId": "10473108253681171589-0",                 "callSetName":
        * "CALLSET0",                 "genotype": [                     1,
        * 1                 ],             }         ]     }  The resulting
        * merged variant would overwrite the existing calls with those from the
        * new variant:      {         "variantSetId": "10473108253681171589",
        * "referenceName": "1",         "start": "10582",
        * "referenceBases": "G",         "alternateBases": [             "A"
        * ],         "calls": [             {                 "callSetId":
        * "10473108253681171589-0",                 "callSetName": "CALLSET0",
        * "genotype": [                     1,                     1
        * ],             }         ]     }  This may be the desired outcome, but
        * it is up to the user to determine if if that is indeed the case.
        * @example
        * // BEFORE RUNNING:
        * // ---------------
        * // 1. If not already done, enable the Genomics API
  ...
  self.variantsets = {
    ...
    patch(params, options, callback) {
      ...
      return createAPIRequest(parameters, callback);
        ...
        *       // TODO: Change code below to process each resource in
        * `variantSetsPage`: console.log(JSON.stringify(variantSetsPage[i],
        * null, 2));
        *     }
        *
        *     if (response.nextPageToken) {
 ...
 * @property {object} info A map of additional read alignment information. This must be of the form map&lt;string, string[]&gt; (string key mapping to a list of string values).
 ...
 * @property {object} info A map of additional call set information. This must be of the form map&lt;string, string[]&gt; (string key mapping to a list of string values).
 ...
 * @memberOf! genomics(v1)
 * @type object
 * @property {genomics(v1).Binding[]} bindings Associates a list of `members` to a `role`. `bindings` with no members will result in an error.
 ...
 * @property {object} info A map of additional read group information. This must be of the form map&lt;string, string[]&gt; (string key mapping to a list of string values).
 ...
 * @property {object} info A map of additional variant information. This must be of the form map&lt;string, string[]&gt; (string key mapping to a list of string values).
 ...
 * @property {object} info A map of additional variant call information. This must be of the form map&lt;string, string[]&gt; (string key mapping to a list of string values).
 ...
 * @property {object} info Remaining structured metadata key-value pairs. This must be of the form map&lt;string, string[]&gt; (string key mapping to a list of string values).
