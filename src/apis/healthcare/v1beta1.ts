...
export namespace healthcare_v1beta1 {
  ...
  export class Resource$Projects$Locations$Datasets$Fhirstores$Fhir {
    ...
    BinaryCreate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/fhir/Binary').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     */
    EncounterEverything(
      params: Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Encountereverything,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    EncounterEverything(
      params?: Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Encountereverything,
    ...
    EncounterEverything(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Encountereverything
        | BodyResponseCallback<Schema$HttpBody>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Encountereverything;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export interface Params$Resource$Projects$Locations$Datasets$Fhirstores$Fhir$Encountereverything
    extends StandardParameters {
    /**
