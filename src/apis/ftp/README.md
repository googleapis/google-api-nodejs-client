...
legacy application, please use [@google-cloud/ftp](https://www.npmjs.com/package/@google-cloud/ftp) instead.
The [@google-cloud/ftp](https://www.npmjs.com/package/@google-cloud/ftp) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/ftp
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/ftp/classes/Ftp.html).
