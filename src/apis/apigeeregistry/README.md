...
legacy application, please use [@google-cloud/apigee-registry](https://www.npmjs.com/package/@google-cloud/apigee-registry) instead.
The [@google-cloud/apigee-registry](https://www.npmjs.com/package/@google-cloud/apigee-registry) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/apigeeregistry
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/apigeeregistry/classes/Apigeeregistry.html).
