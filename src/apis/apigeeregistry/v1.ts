...
export namespace apigeeregistry_v1 {
  ...
  export class Resource$Projects$Locations$Apis {
    ...
    list(
      params?: Params$Resource$Projects$Locations$Apis$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListApisResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Apis$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Projects$Locations$Apis$Artifacts {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/artifacts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    getContents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:getContents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    list(
      params?: Params$Resource$Projects$Locations$Apis$Artifacts$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListArtifactsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Apis$Artifacts$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Projects$Locations$Apis$Deployments {
    ...
    create(
      params?: Params$Resource$Projects$Locations$Apis$Deployments$Create,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ApiDeployment>>;
    create(
      params: Params$Resource$Projects$Locations$Apis$Deployments$Create,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    deleteRevision(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:deleteRevision')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'DELETE',
            apiVersion: '',
    ...
    list(
      params?: Params$Resource$Projects$Locations$Apis$Deployments$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListApiDeploymentsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Apis$Deployments$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    listRevisions(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:listRevisions')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    tagRevision(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:tagRevision')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Apis$Versions {
    ...
    list(
      params?: Params$Resource$Projects$Locations$Apis$Versions$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListApiVersionsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Apis$Versions$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Projects$Locations$Apis$Versions$Specs {
    ...
    list(
      params?: Params$Resource$Projects$Locations$Apis$Versions$Specs$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListApiSpecsResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Apis$Versions$Specs$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    listRevisions(
      params?: Params$Resource$Projects$Locations$Apis$Versions$Specs$Listrevisions,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListApiSpecRevisionsResponse>>;
    listRevisions(
      params: Params$Resource$Projects$Locations$Apis$Versions$Specs$Listrevisions,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Projects$Locations$Documents {
     ...
     *
     *   // Do the magic
     *   const res = await apigeeregistry.projects.locations.documents.getIamPolicy({
     *     // Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
     *     'options.requestedPolicyVersion': 'placeholder-value',
     *     // REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     *     resource: 'projects/my-project/locations/my-location/documents',
     *   });
     *   console.log(res.data);
     *
     *   // Example response
    ...
    getIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Documents$Getiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Documents$Getiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *
     *   // Do the magic
     *   const res = await apigeeregistry.projects.locations.documents.setIamPolicy({
     *     // REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     *     resource: 'projects/my-project/locations/my-location/documents',
     *
     *     // Request body metadata
    ...
    setIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Documents$Setiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Documents$Setiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *   // Do the magic
     *   const res =
     *     await apigeeregistry.projects.locations.documents.testIamPermissions({
     *       // REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     *       resource: 'projects/my-project/locations/my-location/documents',
     *
     *       // Request body metadata
    ...
    testIamPermissions(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Documents$Testiampermissions
        | BodyResponseCallback<Schema$TestIamPermissionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Documents$Testiampermissions;
      let options = (optionsOrCallback || {}) as MethodOptions;
