...
```sh
$ npm install @googleapis/workflows
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/workflows/classes/Workflows.html).
...
The generated bundle will be written to `dist/workflows.min.js`. Use it from your HTML file:

```html
<script src="/path/to/workflows.min.js"></script>
<script>
const { workflows, auth } = Workflows;
</script>
```
