...
export namespace sqladmin_v1beta4 {
  ...
  export class Sqladmin {
    ...
    workloadCaptures: Resource$Workloadcaptures;
    ...
    constructor(options: GlobalOptions, google?: GoogleConfigurable) {
      ...
      this.workloadCaptures = new Resource$Workloadcaptures(this.context);
    }
  }
  ...
  export interface Schema$Operation {
    ...
    startTime?: string | null;
    /**
     * The context for the `StartWorkloadCapture` operation, which contains details to start recording the workload (SQL queries) on a Cloud SQL instance.
     */
    startWorkloadCaptureContext?: Schema$StartWorkloadCaptureContext;
    /**
     * The context for the `StartWorkloadReplay` operation, which contains details about starting the execution of a captured workload (recorded read and write SQL queries) on a replay instance (the Cloud SQL instance where the recorded SQL queries are executed).
     */
    ...
    status?: string | null;
    /**
     * The context for the `StopWorkloadCapture` operation, which contains details to stop recording the workload (SQL queries) on a Cloud SQL instance.
     */
    stopWorkloadCaptureContext?: Schema$StopWorkloadCaptureContext;
    /**
     * The context for the `StopWorkloadReplay` operation, which contains details about stopping the execution of a captured workload (recorded read and write SQL queries) on a replay instance.
     */
  ...
  /**
   * Request to start executing a captured workload on a replay instance (the Cloud SQL instance where the recorded SQL queries are executed).
   */
   ...
   */
  export interface Schema$SqlWorkloadCapturesStartRequest {
    /**
   ...
   */
  export interface Schema$SqlWorkloadCapturesStopRequest {
    /**
   ...
   * The context for the `StartWorkloadCapture` operation, which contains details to start recording the workload (SQL queries) on a Cloud SQL instance.
   */
  export interface Schema$StartWorkloadCaptureContext {
    /**
     * Optional. If true, the captured workload is simultaneously executed on a separate, ephemeral Cloud SQL instance. This "live replay" instance is automatically provisioned and is cloned from the source instance. If false (the default), the workload is only stored and no live replay occurs. It can be replayed later using a separate `StartWorkloadReplayRequest`. Note: The workload capture runs continuously until an explicit `StopWorkloadCaptureRequest` is issued.
     */
    enableLiveReplay?: boolean | null;
    /**
     * Optional. Required if `enable_live_replay` is true. The name of the Cloud SQL instance where the captured workload (SQL queries) is being executed, excluding the project ID (for example, `my-replay-instance`). The instance name must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens. The combined length of `project-ID:instance-name` must be 98 characters or less.
     */
   ...
   * The context for the `StartWorkloadReplay` operation, which contains details about starting the execution of a captured workload (recorded read and write SQL queries) on a replay instance (the Cloud SQL instance where the recorded SQL queries are executed).
   */
  export interface Schema$StartWorkloadReplayContext {
    /**
    ...
    replayInstance?: string | null;
    /**
     * Output only. The ID of the workload to start executing on the replay instance. Each workload capture generates a unique ID in the format `workload-` (for example, `workload-1786046400`). Use this ID to start executing the recorded SQL queries.
     */
   ...
   * The context for the `StopWorkloadCapture` operation, which contains details to stop recording the workload (SQL queries) on a Cloud SQL instance.
   */
  export interface Schema$StopWorkloadCaptureContext {
    /**
     * Optional. If true, immediately aborts the concurrent live replay and discards any un-replayed traffic alongside stopping the capture. If false (the default), the capture stops recording new traffic, but the live replay will continue executing until the entire backlog of captured traffic has been replayed.
     */
   ...
   * The context for the `StopWorkloadReplay` operation, which contains details about stopping the execution of a captured workload (recorded read and write SQL queries) on a replay instance.
   */
  export interface Schema$StopWorkloadReplayContext {
    /**
     * Required. The name of the Cloud SQL instance where the captured workload (SQL queries) is being executed, excluding the project ID (for example, `my-replay-instance`). The instance name must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens. The combined length of `project-ID:instance-name` must be 98 characters or less.
     */
    replayInstance?: string | null;
    /**
     * Output only. The ID of the workload to stop executing on the replay instance. Each workload capture generates a unique ID in the format `workload-` (for example, `workload-1786046400`). Use this ID to stop executing the recorded SQL queries.
     */
    workloadId?: string | null;
  }
  /**
   ...
   */
  export interface Schema$WorkloadCapture {
    /**
     ...
     */
    workloadCaptureState?: string | null;
    /**
  ...
  export interface Schema$WorkloadCapturesListResponse {
     ...
     */
    workloadCaptures?: Schema$WorkloadCapture[];
  }
  ...
  export class Resource$Backupruns {
     ...
     *   //   "maxChargeableBytes": "my_maxChargeableBytes",
     *   //   "selfLink": "my_selfLink",
     *   //   "startTime": "my_startTime",
     *   //   "status": "my_status",
  ...
  export class Resource$Backups {
     ...
     *
     *   // Do the magic
     *   const res = await sql.backups.createBackup({
     ...
     *       //   "backupInterval": {},
     *       //   "backupKind": "my_backupKind",
     *       //   "backupRun": "my_backupRun",
     *       //   "databaseVersion": "my_databaseVersion",
     *       //   "description": "my_description",
     *       //   "error": {},
     *       //   "expiryTime": "my_expiryTime",
     *       //   "instance": "my_instance",
     *       //   "instanceDeletionTime": "my_instanceDeletionTime",
     *       //   "instanceSettings": {},
     *       //   "kind": "my_kind",
     *       //   "kmsKey": "my_kmsKey",
     ...
     *
     *   // Do the magic
     *   const res = await sql.backups.deleteBackup({
     *     // Required. The name of the backup to delete. Format: projects/{project\}/backups/{backup\}
     *     name: 'projects/my-project/backups/my-backup',
     *   });
     *   console.log(res.data);
     *
     *   // Example response
     ...
     *
     *   // Do the magic
     *   const res = await sql.backups.getBackup({
     ...
     *
     *   // Do the magic
     *   const res = await sql.backups.listBackups({
     ...
     *
     *   // Do the magic
     *   const res = await sql.backups.updateBackup({
     *     // Output only. The resource name of the backup. Format: projects/{project\}/backups/{backup\}.
     *     name: 'projects/my-project/backups/my-backup',
  ...
  export class Resource$Connect {
    ...
    generateEphemeralCert(
      params?: Params$Resource$Connect$Generateephemeralcert,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$GenerateEphemeralCertResponse>>;
    generateEphemeralCert(
      params: Params$Resource$Connect$Generateephemeralcert,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/sql/v1beta4/locations/{location}/dns/{dnsName}:resolveConnectSettings'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
  ...
  export class Resource$Instances {
     ...
     *     enableFinalBackup: 'placeholder-value',
     *     // Optional. The description of the final backup.
     *     finalBackupDescription: 'placeholder-value',
     *     // Optional. Final Backup expiration time. Timestamp in UTC of when this resource is considered expired.
     *     finalBackupExpiryTime: 'placeholder-value',
     ...
     *   //   "outOfDiskReport": {},
     *   //   "primaryDnsName": "my_primaryDnsName",
     *   //   "project": "my_project",
     ...
     *   //   "settings": {},
     *   //   "sqlNetworkArchitecture": "my_sqlNetworkArchitecture",
     *   //   "state": "my_state",
     *   //   "suspensionReason": [],
     *   //   "switchTransactionLogsToCloudStorageEnabled": false,
     *   //   "tags": {},
     *   //   "upgradableDatabaseVersions": [],
     *   //   "writeEndpoint": "my_writeEndpoint"
     *   // }
     * }
     *
     * main().catch(e => {
     ...
     *
     *   // Do the magic
     *   const res = await sql.instances.pointInTimeRestore({
     ...
     *       // request body parameters
     *       // {
     *       //   "allocatedIpRange": "my_allocatedIpRange",
     *       //   "datasource": "my_datasource",
     *       //   "pointInTime": "my_pointInTime",
     ...
     *
     *   // Do the magic
     *   const res = await sql.instances.switchover({
  ...
  export class Resource$Workloadcaptures {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *
     *   // Do the magic
     *   const res = await sql.workloadCaptures.list({
     *     // Required. Cloud SQL instance ID. This does not include the project ID.
     *     instance: 'placeholder-value',
     *     // Required. Project ID of the project that contains the instance.
     *     project: 'placeholder-value',
     ...
     */
    list(
      params: Params$Resource$Workloadcaptures$List,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    list(
      params?: Params$Resource$Workloadcaptures$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$WorkloadCapturesListResponse>>;
    list(
      params: Params$Resource$Workloadcaptures$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$WorkloadCapturesListResponse>,
      callback: BodyResponseCallback<Schema$WorkloadCapturesListResponse>
    ): void;
    list(
      params: Params$Resource$Workloadcaptures$List,
      callback: BodyResponseCallback<Schema$WorkloadCapturesListResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Workloadcaptures$List
        | BodyResponseCallback<Schema$WorkloadCapturesListResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Workloadcaptures$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Workloadcaptures$List;
        options = {};
      }
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
      ...
      if (callback) {
        createAPIRequest<Schema$WorkloadCapturesListResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$WorkloadCapturesListResponse>(
          parameters
        );
      }
    }
     ...
     *
     *   // Do the magic
     *   const res = await sql.workloadCaptures.start({
     *     // Required. Cloud SQL instance ID. This does not include the project ID.
     *     instance: 'placeholder-value',
     *     // Required. Project ID of the project that contains the instance.
     *     project: 'placeholder-value',
     ...
     */
    start(
      params: Params$Resource$Workloadcaptures$Start,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    start(
      params?: Params$Resource$Workloadcaptures$Start,
    ...
    start(
      paramsOrCallback?:
        | Params$Resource$Workloadcaptures$Start
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Workloadcaptures$Start;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Workloadcaptures$Start;
        options = {};
      }
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures:start'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
     ...
     *
     *   // Do the magic
     *   const res = await sql.workloadCaptures.startReplay({
     *     // Required. Cloud SQL instance ID. This does not include the project ID.
     *     instance: 'placeholder-value',
     *     // Required. Project ID of the project that contains the instance.
     *     project: 'placeholder-value',
     ...
     */
    startReplay(
      params: Params$Resource$Workloadcaptures$Startreplay,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    startReplay(
      params?: Params$Resource$Workloadcaptures$Startreplay,
    ...
    startReplay(callback: BodyResponseCallback<Schema$Operation>): void;
    startReplay(
      paramsOrCallback?:
        | Params$Resource$Workloadcaptures$Startreplay
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Workloadcaptures$Startreplay;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Workloadcaptures$Startreplay;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:startReplay'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
        ...
        params,
        requiredParams: ['project', 'instance', 'workloadId'],
        pathParams: ['instance', 'project', 'workloadId'],
        context: this.context,
      };
      if (callback) {
        createAPIRequest<Schema$Operation>(
     ...
     *
     *   // Do the magic
     *   const res = await sql.workloadCaptures.stop({
     *     // Required. Cloud SQL instance ID. This does not include the project ID.
     *     instance: 'placeholder-value',
     *     // Required. Project ID of the project that contains the instance.
     *     project: 'placeholder-value',
     ...
     */
    stop(
      params: Params$Resource$Workloadcaptures$Stop,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    stop(
      params?: Params$Resource$Workloadcaptures$Stop,
    ...
    stop(
      paramsOrCallback?:
        | Params$Resource$Workloadcaptures$Stop
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Workloadcaptures$Stop;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Workloadcaptures$Stop;
        options = {};
      }
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures:stop'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
     ...
     *
     *   // Do the magic
     *   const res = await sql.workloadCaptures.stopReplay({
     *     // Required. Cloud SQL instance ID. This does not include the project ID.
     *     instance: 'placeholder-value',
     *     // Required. Project ID of the project that contains the instance.
     *     project: 'placeholder-value',
    ...
    stopReplay(callback: BodyResponseCallback<Schema$Operation>): void;
    stopReplay(
      paramsOrCallback?:
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Workloadcaptures$Stopreplay;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Workloadcaptures$Stopreplay;
        options = {};
      }
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/sql/v1beta4/projects/{project}/instances/{instance}/workloadCaptures/{workloadId}:stopReplay'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
            apiVersion: '',
          },
  ...
  export interface Params$Resource$Workloadcaptures$List extends StandardParameters {
    /**
     * Required. Cloud SQL instance ID. This does not include the project ID.
     */
    instance?: string;
  ...
  export interface Params$Resource$Workloadcaptures$Start extends StandardParameters {
    /**
     * Required. Cloud SQL instance ID. This does not include the project ID.
     */
    instance?: string;
  ...
  export interface Params$Resource$Workloadcaptures$Startreplay extends StandardParameters {
    /**
     * Required. Cloud SQL instance ID. This does not include the project ID.
     */
    instance?: string;
  ...
  export interface Params$Resource$Workloadcaptures$Stop extends StandardParameters {
    /**
     * Required. Cloud SQL instance ID. This does not include the project ID.
     */
    instance?: string;
     ...
     * Request body metadata
     */
    requestBody?: Schema$SqlWorkloadCapturesStopRequest;
  }
  export interface Params$Resource$Workloadcaptures$Stopreplay extends StandardParameters {
    /**
     * Required. Cloud SQL instance ID. This does not include the project ID.
     */
    instance?: string;
