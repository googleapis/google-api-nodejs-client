...
export namespace sqladmin_v1 {
  ...
  export interface Schema$ConfigDiff {
    /**
     * Output only. The name of the field that differs in the blue and green instances, fully-qualified. Example: `settings.tier`
     */
    field?: string | null;
    /**
  ...
  export class Resource$Bluegreendeployments {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/blueGreenDeployments').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/v1/projects/{project}/instances/{instance}/workloadCaptures'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
