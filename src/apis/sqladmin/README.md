...
legacy application, please use [@google-cloud/sql](https://www.npmjs.com/package/@google-cloud/sql) instead.
The [@google-cloud/sql](https://www.npmjs.com/package/@google-cloud/sql) library is faster, easier to use, and better maintained.
...
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/sqladmin/classes/Sqladmin.html).
