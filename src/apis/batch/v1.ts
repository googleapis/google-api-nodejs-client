...
export namespace batch_v1 {
  ...
  export class Resource$Projects$Locations$State {
    ...
    report(
      params?: Params$Resource$Projects$Locations$State$Report,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ReportAgentStateResponse>>;
    report(
      params: Params$Resource$Projects$Locations$State$Report,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    report(
      params: Params$Resource$Projects$Locations$State$Report,
      options:
        MethodOptions | BodyResponseCallback<Schema$ReportAgentStateResponse>,
    ...
    report(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/state:report')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
