...
legacy application, please use [@google-cloud/batch](https://www.npmjs.com/package/@google-cloud/batch) instead.
The [@google-cloud/batch](https://www.npmjs.com/package/@google-cloud/batch) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/batch
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/batch/classes/Batch.html).
