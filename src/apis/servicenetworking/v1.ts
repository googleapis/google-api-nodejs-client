...
export namespace servicenetworking_v1 {
  ...
  export class Resource$Services$Projects$Global {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.networks = new Resource$Services$Projects$Global$Networks(
        this.context
      );
    }
  }
  ...
  export class Resource$Services$Projects$Global$Networks$Peereddnsdomains {
     ...
     * @desc Creates a peered DNS domain which sends requests for records in given namespace originating in the service producer VPC network to the consumer VPC network to be resolved.
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/servicenetworking.googleapis.com
     ...
     * });
     *
     * @alias servicenetworking.services.projects.global.networks.peeredDnsDomains.create
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.parent Required. Parent resource identifying the connection for which the peered DNS domain will be created in the format: `services/{service}/projects/{project}/global/networks/{network}` {service} is the peering service that is managing connectivity for the service producer's organization. For Google services that support this functionality, this value is `servicenetworking.googleapis.com`. {project} is the number of the project that contains the service consumer's VPC network e.g. `12345`. {network} is the name of the service consumer's VPC network.
     * @param {().PeeredDnsDomain} params.requestBody Request body data
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Services$Projects$Global$Networks$Peereddnsdomains$Create
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/peeredDnsDomains').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
     ...
     * @desc Deletes a peered DNS domain.
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/servicenetworking.googleapis.com
     ...
     * });
     *
     * @alias servicenetworking.services.projects.global.networks.peeredDnsDomains.delete
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.name Required. The name of the peered DNS domain to delete in the format: `services/{service}/projects/{project}/global/networks/{network}/peeredDnsDomains/{name}`. {service} is the peering service that is managing connectivity for the service producer's organization. For Google services that support this functionality, this value is `servicenetworking.googleapis.com`. {project} is the number of the project that contains the service consumer's VPC network e.g. `12345`. {network} is the name of the service consumer's VPC network. {name} is the name of the peered DNS domain.
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Services$Projects$Global$Networks$Peereddnsdomains$Delete
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
     ...
     * @desc Lists peered DNS domains for a connection.
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/servicenetworking.googleapis.com
     ...
     * });
     *
     * @alias servicenetworking.services.projects.global.networks.peeredDnsDomains.list
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {string} params.parent Required. Parent resource identifying the connection which owns this collection of peered DNS domains in the format: `services/{service}/projects/{project}/global/networks/{network}`. {service} is the peering service that is managing connectivity for the service producer's organization. For Google services that support this functionality, this value is `servicenetworking.googleapis.com`. {project} is a project number e.g. `12345` that contains the service consumer's VPC network. {network} is the name of the service consumer's VPC network.
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
    ...
    list(
      params?: Params$Resource$Services$Projects$Global$Networks$Peereddnsdomains$List,
      options?: MethodOptions
    ): GaxiosPromise<Schema$ListPeeredDnsDomainsResponse>;
    list(
      params: Params$Resource$Services$Projects$Global$Networks$Peereddnsdomains$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$ListPeeredDnsDomainsResponse>,
      callback: BodyResponseCallback<Schema$ListPeeredDnsDomainsResponse>
    ): void;
    list(
      params: Params$Resource$Services$Projects$Global$Networks$Peereddnsdomains$List,
      callback: BodyResponseCallback<Schema$ListPeeredDnsDomainsResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Services$Projects$Global$Networks$Peereddnsdomains$List
        | BodyResponseCallback<Schema$ListPeeredDnsDomainsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (callback) {
        createAPIRequest<Schema$ListPeeredDnsDomainsResponse>(
          parameters,
          callback as BodyResponseCallback<{} | void>
        );
      } else {
        return createAPIRequest<Schema$ListPeeredDnsDomainsResponse>(
          parameters
        );
      }
    }
  ...
  export class Resource$Services$Roles {
     ...
     * @desc Service producers can use this method to add roles in the shared VPC host project. Each role is bound to the provided member. Each role must be selected from within an allowlisted set of roles. Each role is applied at only the granularity specified in the allowlist.
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/servicenetworking.googleapis.com
