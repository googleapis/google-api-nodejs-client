...
export namespace agentidentitycredentials_v1 {
  ...
  export class Resource$Projects$Locations$Authproviders$Credentials {
    ...
    finalize(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse>
    >;
    finalize(
      params: Params$Resource$Projects$Locations$Authproviders$Credentials$Finalize,
    ...
    finalize(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse>
    ): void;
    finalize(
      params: Params$Resource$Projects$Locations$Authproviders$Credentials$Finalize,
      callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse>
    ...
    finalize(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+authProvider}/credentials:finalize').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponse>(
          parameters
        );
      }
    }
    ...
    retrieve(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponse>
    >;
    retrieve(
      params: Params$Resource$Projects$Locations$Authproviders$Credentials$Retrieve,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    retrieve(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponse>,
    ...
    retrieve(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+authProvider}/credentials:retrieve').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponse>(
          parameters
        );
      }
    }
