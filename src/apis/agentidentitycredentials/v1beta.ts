...
export namespace agentidentitycredentials_v1beta {
  ...
  export class Resource$Projects$Locations$Authproviders$Credentials {
    ...
    finalize(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsResponse>
    >;
    finalize(
      params: Params$Resource$Projects$Locations$Authproviders$Credentials$Finalize,
    ...
    finalize(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsResponse>,
    ...
    finalize(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1beta_FinalizeCredentialsResponse>(
          parameters
        );
      }
    }
    ...
    retrieve(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>
    >;
    retrieve(
      params: Params$Resource$Projects$Locations$Authproviders$Credentials$Retrieve,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    retrieve(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>,
      callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>
    ): void;
    retrieve(
      params: Params$Resource$Projects$Locations$Authproviders$Credentials$Retrieve,
      callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>
    ...
    retrieve(
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudAgentidentitycredentialsV1beta_RetrieveCredentialsResponse>(
          parameters
        );
      }
    }
