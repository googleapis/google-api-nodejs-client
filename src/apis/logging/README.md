...
legacy application, please use [@google-cloud/logging-winston](https://www.npmjs.com/package/@google-cloud/logging-winston) instead.
The [@google-cloud/logging-winston](https://www.npmjs.com/package/@google-cloud/logging-winston) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/logging
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/logging/classes/Logging.html).
