...
```sh
$ npm install @googleapis/bigtableadmin
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/bigtableadmin/classes/Bigtableadmin.html).
...
```html
<script src="/path/to/bigtableadmin.min.js"></script>
<script>
const { bigtableadmin, auth } = Bigtableadmin;
</script>
```
