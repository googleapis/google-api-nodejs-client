...
export namespace bigtableadmin_v2 {
   ...
   */
  export interface Schema$GoogleBigtableAdminV2MemoryLayerMemoryConfig {
    /**
   ...
   */
  export interface Schema$GoogleBigtableAdminV2TypeInt32 {
    /**
     * The encoding to use when converting to or from lower level types.
     */
    encoding?: Schema$GoogleBigtableAdminV2TypeInt32Encoding;
  }
  /**
   * Rules used to convert to or from lower level types.
   */
  export interface Schema$GoogleBigtableAdminV2TypeInt32Encoding {
    /**
     * Use `BigEndianBytes` encoding.
     */
    bigEndianBytes?: Schema$GoogleBigtableAdminV2TypeInt32EncodingBigEndianBytes;
    /**
     * Use `OrderedCodeBytes` encoding.
     */
    orderedCodeBytes?: Schema$GoogleBigtableAdminV2TypeInt32EncodingOrderedCodeBytes;
  }
  /**
   ...
   */
  export interface Schema$GoogleBigtableAdminV2TypeInt32EncodingBigEndianBytes {}
  /**
   ...
   */
  export interface Schema$GoogleBigtableAdminV2TypeInt32EncodingOrderedCodeBytes {}
  /**
   ...
   */
  export interface Schema$ListMemoryLayersResponse {
    /**
     ...
     */
    memoryLayers?: Schema$MemoryLayer[];
    /**
     * A token, which can be sent as `page_token` to retrieve the next page. If this field is omitted, there are no subsequent pages.
     */
    nextPageToken?: string | null;
  ...
  export interface Schema$MemoryLayer {
     ...
     */
    memoryConfig?: Schema$GoogleBigtableAdminV2MemoryLayerMemoryConfig;
    /**
  ...
  export interface Schema$Type {
     ...
     * Int32
     */
    int32Type?: Schema$GoogleBigtableAdminV2TypeInt32;
    /**
     * Int64
     */
   ...
   */
  export interface Schema$UpdateMemoryLayerMetadata {
    /**
     * The time at which the operation failed or was completed successfully.
     */
    finishTime?: string | null;
     ...
     */
    originalRequest?: Schema$UpdateMemoryLayerRequest;
    /**
     * The time at which the original request was received.
     */
    requestTime?: string | null;
   ...
   */
  export interface Schema$UpdateMemoryLayerRequest {
    /**
     ...
     */
    memoryLayer?: Schema$MemoryLayer;
    /**
     * Optional. The list of fields to update.
     */
    updateMask?: string | null;
  ...
  export class Resource$Projects$Instances$Clusters {
    ...
    memoryLayers: Resource$Projects$Instances$Clusters$Memorylayers;
    constructor(context: APIRequestContext) {
      this.context = context;
      ...
      this.memoryLayers = new Resource$Projects$Instances$Clusters$Memorylayers(
        this.context
      );
    }
     ...
     *
     *   // Do the magic
     *   const res = await bigtableadmin.projects.instances.clusters.getMemoryLayer({
     ...
     */
    getMemoryLayer(
      params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    getMemoryLayer(
      params?: Params$Resource$Projects$Instances$Clusters$Getmemorylayer,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$MemoryLayer>>;
    getMemoryLayer(
      params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    getMemoryLayer(
      params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer,
      options: MethodOptions | BodyResponseCallback<Schema$MemoryLayer>,
      callback: BodyResponseCallback<Schema$MemoryLayer>
    ): void;
    getMemoryLayer(
      params: Params$Resource$Projects$Instances$Clusters$Getmemorylayer,
      callback: BodyResponseCallback<Schema$MemoryLayer>
    ): void;
    getMemoryLayer(callback: BodyResponseCallback<Schema$MemoryLayer>): void;
    getMemoryLayer(
      paramsOrCallback?:
        | Params$Resource$Projects$Instances$Clusters$Getmemorylayer
        | BodyResponseCallback<Schema$MemoryLayer>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Instances$Clusters$Getmemorylayer;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      if (callback) {
        createAPIRequest<Schema$MemoryLayer>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$MemoryLayer>(parameters);
      }
    }
  ...
  export interface Params$Resource$Projects$Instances$Clusters$Getmemorylayer extends StandardParameters {
    /**
     * Required. The unique name of the requested cluster's memory layer. Values are of the form `projects/{project\}/instances/{instance\}/clusters/{cluster\}/memoryLayer`.
     */
    name?: string;
  ...
  export class Resource$Projects$Instances$Clusters$Backups {
    ...
    copy(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/backups:copy')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Instances$Clusters$Hottablets {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/hotTablets')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Instances$Clusters$Memorylayers {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *
     *   // Do the magic
     *   const res = await bigtableadmin.projects.instances.clusters.memoryLayers.list(
     *     {
    ...
    list(
      params?: Params$Resource$Projects$Instances$Clusters$Memorylayers$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListMemoryLayersResponse>>;
    list(
      params: Params$Resource$Projects$Instances$Clusters$Memorylayers$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(callback: BodyResponseCallback<Schema$ListMemoryLayersResponse>): void;
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Instances$Clusters$Memorylayers$List
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Instances$Clusters$Memorylayers$List;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/memoryLayers')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$ListMemoryLayersResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListMemoryLayersResponse>(parameters);
      }
    }
  }

  export interface Params$Resource$Projects$Instances$Clusters$Memorylayers$List extends StandardParameters {
    /**
     * Optional. The maximum number of memory layers to return. The service may return fewer than this value.
     */
    pageSize?: number;
  ...
  export class Resource$Projects$Instances$Logicalviews {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/logicalViews')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Instances$Materializedviews {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/materializedViews')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Instances$Tables {
    ...
    restore(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/tables:restore')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Instances$Tables$Schemabundles {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/schemaBundles')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
