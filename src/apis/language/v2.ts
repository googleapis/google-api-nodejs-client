  ...
  export class Resource$Documents {
    ...
    analyzeEntities(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/documents:analyzeEntities')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    annotateText(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/documents:annotateText')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    classifyText(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/documents:classifyText')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    moderateText(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/documents:moderateText')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
