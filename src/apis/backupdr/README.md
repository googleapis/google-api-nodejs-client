...
legacy application, please use [@google-cloud/backupdr](https://www.npmjs.com/package/@google-cloud/backupdr) instead.
The [@google-cloud/backupdr](https://www.npmjs.com/package/@google-cloud/backupdr) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/backupdr
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/backupdr/classes/Backupdr.html).
