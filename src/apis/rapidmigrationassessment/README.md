...
legacy application, please use [@google-cloud/rapidmigrationassessment](https://www.npmjs.com/package/@google-cloud/rapidmigrationassessment) instead.
The [@google-cloud/rapidmigrationassessment](https://www.npmjs.com/package/@google-cloud/rapidmigrationassessment) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/rapidmigrationassessment
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/rapidmigrationassessment/classes/Rapidmigrationassessment.html).
