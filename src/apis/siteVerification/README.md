...
```sh
$ npm install @google/siteVerification
```
...
```sh
$ cd src/apis/siteVerification
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/siteVerification.min.js`. Use it from your HTML file:

```html
<script src="/path/to/siteVerification.min.js"></script>
<script>
const { siteVerification, auth } = Siteverification;
</script>
```
