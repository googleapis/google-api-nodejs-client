  ...
  export class Resource$Projects$Tenants {
    ...
    completeQuery(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+tenant}:completeQuery')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Tenants$Clientevents {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/clientEvents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Tenants$Companies {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/companies')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Tenants$Jobs {
    ...
    batchCreate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/jobs:batchCreate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    batchDelete(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/jobs:batchDelete')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    batchUpdate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/jobs:batchUpdate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    search(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v4/{+parent}/jobs:search')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
