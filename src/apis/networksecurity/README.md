...
legacy application, please use [@google-cloud/network-security](https://www.npmjs.com/package/@google-cloud/network-security) instead.
The [@google-cloud/network-security](https://www.npmjs.com/package/@google-cloud/network-security) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/networksecurity
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/networksecurity/classes/Networksecurity.html).
