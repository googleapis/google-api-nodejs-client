...
legacy application, please use [@google-cloud/domains](https://www.npmjs.com/package/@google-cloud/domains) instead.
The [@google-cloud/domains](https://www.npmjs.com/package/@google-cloud/domains) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/domains
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/domains/classes/Domains.html).
