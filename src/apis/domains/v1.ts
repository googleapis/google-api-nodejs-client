...
export namespace domains_v1 {
  ...
  export class Resource$Projects$Locations$Registrations {
    ...
    configureContactSettings(
      ...
      if (params.registration !== undefined && params.registration !== null) {
        validateMultiSegment('registration', String(params.registration));
        params.registration = encodeWithoutSlashes(String(params.registration));
      }
    ...
    configureDnsSettings(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+registration}:configureDnsSettings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    configureManagementSettings(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+registration}:configureManagementSettings')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    import(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/registrations:import')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    list(
      params: Params$Resource$Projects$Locations$Registrations$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListRegistrationsResponse>,
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/registrations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    register(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/registrations:register')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    renewDomain(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+registration}:renewDomain')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    resetAuthorizationCode(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+registration}:resetAuthorizationCode')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    retrieveAuthorizationCode(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+registration}:retrieveAuthorizationCode')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    searchDomains(
      params: Params$Resource$Projects$Locations$Registrations$Searchdomains,
      options:
        MethodOptions | BodyResponseCallback<Schema$SearchDomainsResponse>,
    ...
    searchDomains(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+location}/registrations:searchDomains')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    transfer(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/registrations:transfer')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
