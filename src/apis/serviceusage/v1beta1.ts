...
export namespace serviceusage_v1beta1 {
  ...
  export class Resource$Services {
     ...
     * @desc Enable multiple services on a project. The operation is atomic: if enabling any service fails, then the entire batch fails, and no state changes occur. Operation
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/serviceusage.googleapis.com
     ...
     * @desc Enable a service so that it can be used with a project. Operation
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/serviceusage.googleapis.com
