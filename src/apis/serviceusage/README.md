...
```sh
$ npm install @google/serviceusage
```
...
```sh
$ cd src/apis/serviceusage
$ npm install
$ npm run webpack
```

The generated bundle will be written to `dist/serviceusage.min.js`. Use it from your HTML file:

```html
<script src="/path/to/serviceusage.min.js"></script>
<script>
const { serviceusage, auth } = Serviceusage;
</script>
```
