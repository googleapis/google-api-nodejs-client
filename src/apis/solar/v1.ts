...
export namespace solar_v1 {
  ...
  export class Resource$Buildinginsights {
    ...
    findClosest(
      params: Params$Resource$Buildinginsights$Findclosest,
      options: MethodOptions | BodyResponseCallback<Schema$BuildingInsights>,
      callback: BodyResponseCallback<Schema$BuildingInsights>
    ): void;
    findClosest(
      params: Params$Resource$Buildinginsights$Findclosest,
      callback: BodyResponseCallback<Schema$BuildingInsights>
    ...
    findClosest(
      paramsOrCallback?:
        | Params$Resource$Buildinginsights$Findclosest
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$Buildinginsights$Findclosest;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/buildingInsights:findClosest').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
      ...
      if (callback) {
        createAPIRequest<Schema$BuildingInsights>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$BuildingInsights>(parameters);
      }
    }
  }
  ...
  export class Resource$Datalayers {
    ...
    get(
      params: Params$Resource$Datalayers$Get,
      options: MethodOptions | BodyResponseCallback<Schema$DataLayers>,
      callback: BodyResponseCallback<Schema$DataLayers>
    ): void;
    get(
      params: Params$Resource$Datalayers$Get,
      callback: BodyResponseCallback<Schema$DataLayers>
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Datalayers$Get
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Datalayers$Get;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$DataLayers>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$DataLayers>(parameters);
      }
    }
  }
  ...
  export class Resource$Geotiff {
    ...
    get(
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Geotiff$Get;
        options = {};
      }
