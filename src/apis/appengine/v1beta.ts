...
export class Resource$Apps {
   ...
   * @return {object} Request object
   */
  repair(params: any, options?: MethodOptions): AxiosPromise<Schema$Operation>;
  repair(
      params: any,
      options: MethodOptions|BodyResponseCallback<Schema$Operation>,
      callback?: BodyResponseCallback<Schema$Operation>): void;
...
export class Resource$Apps$Domainmappings {
   ...
   * @desc Updates the specified domain mapping. To map an SSL certificate to a
...
export class Resource$Apps$Firewall$Ingressrules {
   ...
   */
  create(params: any, options?: MethodOptions):
      AxiosPromise<Schema$FirewallRule>;
  create(
      params: any,
   ...
   * @return {object} Request object
   */
  get(params: any, options?: MethodOptions): AxiosPromise<Schema$FirewallRule>;
  get(params: any,
      options: MethodOptions|BodyResponseCallback<Schema$FirewallRule>,
      callback?: BodyResponseCallback<Schema$FirewallRule>): void;
  get(params: any,
   ...
   */
  list(params: any, options?: MethodOptions):
      AxiosPromise<Schema$ListIngressRulesResponse>;
  list(
      params: any,
      options: MethodOptions|
...
export class Resource$Apps$Services$Versions {
   ...
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta/apps.services.versions#Version.FIELDS.automatic_scaling):
   * For Version resources that use automatic scaling and run in the App  Engine
   * standard environment. automatic_scaling.min_total_instances
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta/apps.services.versions#Version.FIELDS.automatic_scaling):
   * For Version resources that use automatic scaling and run in the App  Engine
   * flexible environment. automatic_scaling.max_total_instances
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta/apps.services.versions#Version.FIELDS.automatic_scaling):
   * For Version resources that use automatic scaling and run in the App  Engine
   * flexible environment. automatic_scaling.cool_down_period_sec
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta/apps.services.versions#Version.FIELDS.automatic_scaling):
   * For Version resources that use automatic scaling and run in the App  Engine
   * flexible environment. automatic_scaling.cpu_utilization.target_utilization
   * (https://cloud.google.com/appengine/docs/admin-api/reference/rest/v1beta/apps.services.versions#Version.FIELDS.automatic_scaling):
   * For Version resources that use automatic scaling and run in the App  Engine
   * flexible environment.
