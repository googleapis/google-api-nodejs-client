 ...
 * @property {appengine(v1beta).FeatureSettings} featureSettings The feature specific settings to be used in the application.
 ...
 * @property {integer} maxTotalInstances Maximum number of instances that should be started to handle requests for this version.
 ...
 * @property {integer} minTotalInstances Minimum number of running instances that should be maintained for this version.
 ...
 * @property {appengine(v1beta).StandardSchedulerSettings} standardSchedulerSettings Scheduler settings for standard environment.
 */
/**
 ...
 * @memberOf! appengine(v1beta)
 * @type object
 * @property {appengine(v1beta).FirewallRule[]} ingressRules A list of FirewallRules to replace the existing set.
 */
/**
 * @typedef BatchUpdateIngressRulesResponse
 * @memberOf! appengine(v1beta)
 * @type object
 * @property {appengine(v1beta).FirewallRule[]} ingressRules The full list of ingress FirewallRules for this application.
 */
/**
 * @typedef BuildInfo
 * @memberOf! appengine(v1beta)
 * @type object
 * @property {string} cloudBuildId The Google Cloud Container Builder build id. Example: &quot;f966068f-08b2-42c8-bdfe-74137dff2bf9&quot;
 */
/**
 ...
 * @memberOf! appengine(v1beta)
 * @type object
 * @property {appengine(v1beta).FirewallRule[]} ingressRules The ingress FirewallRules for this application.
 * @property {string} nextPageToken Continuation token for fetching the next page of results.
 */
/**
 ...
 * @property {string} instanceTag Tag to apply to the instance during creation. Only applicable in the App Engine flexible environment.
 ...
 * @property {string} pendingManagedCertificateId ID of the managed AuthorizedCertificate resource currently being provisioned, if applicable. Until the new managed certificate has been successfully provisioned, the previous SSL state will be preserved. Once the provisioning process completes, the certificate_id field will reflect the new managed certificate and this field will be left empty. To remove SSL support while there is still a pending managed certificate, clear the certificate_id field with an UpdateDomainMappingRequest.@OutputOnly
 * @property {string} sslManagementType SSL management type for this domain. If AUTOMATIC, a managed certificate is automatically provisioned. If MANUAL, certificate_id must be manually specified in order to configure SSL for this domain.
 */
/**
 * @typedef StandardSchedulerSettings
 * @memberOf! appengine(v1beta)
 * @type object
 * @property {integer} maxInstances Maximum number of instances to run for this version. Set to zero to disable max_instances configuration.
 * @property {integer} minInstances Minimum number of instances to run for this version. Set to zero to disable min_instances configuration.
 ...
 * @property {appengine(v1beta).HealthCheck} healthCheck Configures health checking for instances. Unhealthy instances are stopped and replaced with new instances. Only applicable in the App Engine flexible environment.Only returned in GET requests if view=FULL is set.
 ...
 * @property {appengine(v1beta).LivenessCheck} livenessCheck Configures liveness health checking for instances. Unhealthy instances are stopped and replaced with new instancesOnly returned in GET requests if view=FULL is set.
 ...
 * @property {appengine(v1beta).ReadinessCheck} readinessCheck Configures readiness health checking for instances. Unhealthy instances are not put into the backend traffic rotation.Only returned in GET requests if view=FULL is set.
 * @property {appengine(v1beta).Resources} resources Machine resources for this version. Only applicable in the App Engine flexible environment.
 ...
 * @property {string[]} zones The Google Compute Engine zones that are supported by this version in the App Engine flexible environment.
 */
/**
 * @typedef Volume
 * @memberOf! appengine(v1beta)
