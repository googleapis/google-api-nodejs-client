...
legacy application, please use [@google-cloud/appengine-admin](https://www.npmjs.com/package/@google-cloud/appengine-admin) instead.
The [@google-cloud/appengine-admin](https://www.npmjs.com/package/@google-cloud/appengine-admin) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/appengine
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/appengine/classes/Appengine.html).
