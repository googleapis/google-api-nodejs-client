...
export namespace appengine_v1alpha {
  ...
  export class Resource$Apps$Domainmappings {
     ...
     * @param {string} params.appsId Part of `parent`. Name of the parent
     *     Application resource. Example: apps/myapp.
     * @param {boolean=} params.noManagedCertificate Whether a managed
     *     certificate should be provided by App Engine. If true, a certificate
     *     ID must be manaually set in the DomainMapping resource to configure
     *     SSL for this domain. If false, a managed certificate will be
     ...
     * @param {boolean=} params.noManagedCertificate Whether a managed
     *     certificate should be provided by App Engine. If true, a certificate
     *     ID must be manually set in the DomainMapping resource to configure
     *     SSL for this domain. If false, a managed certificate will be
     *     provisioned and a certificate ID will be automatically populated.
     *     Only applicable if ssl_settings.certificate_id is specified in the
     *     update mask.
     * @param {string=} params.updateMask Standard field mask for the set of
