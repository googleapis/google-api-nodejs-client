...
export namespace appengine_v1beta5 {
   ...
   * services to handle other tasks such as API requests from mobile devices or
   * backend data analysis. Each service has a collection of versions that
  ...
  export class Resource$Apps {
     ...
     *     can cause the request to take longer to complete. Note: This
    ...
    get(paramsOrCallback?: Params$Resource$Apps$Operations$Get|
      ...
      const parameters = {
        options: Object.assign(
            {
              url:
                  (rootUrl + '/v1beta5/apps/{appsId}/operations/{operationsId}')
                      .replace(/([^:]\/)\/+/g, '$1'),
              method: 'GET'
            },
            options),
  ...
  export class Resource$Apps$Services$Versions {
     ...
     * @param {object} params Parameters for request
     * @param {string} params.appsId Part of `name`. Name of the resource to
     *     update. For example: "apps/myapp/services/default".
     * @param {string} params.servicesId Part of `name`. See documentation of
     *     `appsId`.
