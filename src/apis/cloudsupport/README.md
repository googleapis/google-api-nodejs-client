...
legacy application, please use [@google-cloud/support](https://www.npmjs.com/package/@google-cloud/support) instead.
The [@google-cloud/support](https://www.npmjs.com/package/@google-cloud/support) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/cloudsupport
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/cloudsupport/classes/Cloudsupport.html).
