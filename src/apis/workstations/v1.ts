...
export namespace workstations_v1 {
  ...
  export class Resource$Projects$Locations {
     ...
     *
     *   // Do the magic
     *   const res = await workstations.projects.locations.get({
  ...
  export class Resource$Projects$Locations$Workstationclusters {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workstationClusters').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Workstationclusters$Workstationconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workstationConfigs').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    listUsable(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1/{+parent}/workstationConfigs:listUsable'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
            apiVersion: '',
          },
  ...
  export class Resource$Projects$Locations$Workstationclusters$Workstationconfigs$Workstations {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workstations').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    generateAccessToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workstation}:generateAccessToken').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    listUsable(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workstations:listUsable').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
