...
legacy application, please use [@google-cloud/workstations](https://www.npmjs.com/package/@google-cloud/workstations) instead.
The [@google-cloud/workstations](https://www.npmjs.com/package/@google-cloud/workstations) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/workstations
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/workstations/classes/Workstations.html).
