...
legacy application, please use [@google-cloud/cloudcontrolspartner](https://www.npmjs.com/package/@google-cloud/cloudcontrolspartner) instead.
The [@google-cloud/cloudcontrolspartner](https://www.npmjs.com/package/@google-cloud/cloudcontrolspartner) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/cloudcontrolspartner
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/cloudcontrolspartner/classes/Cloudcontrolspartner.html).
