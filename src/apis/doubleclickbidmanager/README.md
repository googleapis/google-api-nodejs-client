...
```sh
$ npm install @googleapis/doubleclickbidmanager
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/doubleclickbidmanager/classes/Doubleclickbidmanager.html).
...
```html
<script src="/path/to/doubleclickbidmanager.min.js"></script>
<script>
const { doubleclickbidmanager, auth } = Doubleclickbidmanager;
</script>
```
