...
export namespace analyticshub_v1beta1 {
  ...
  export interface Schema$DataExchange {
    ...
    /**
     * Required. Human-readable display name of the data exchange. The display name must contain only Unicode letters, numbers (0-9), underscores (_), dashes (-), spaces ( ), and must not start or end with spaces. Default value is an empty string. Max length: 63 bytes.
     */
  ...
  export class Resource$Projects$Locations {
     ...
     *
     *   // Do the magic
     *   const res = await analyticshub.projects.locations.get({
     ...
     *
     *   // Do the magic
     *   const res = await analyticshub.projects.locations.list({
