...
legacy application, please use [@google-cloud/migrationcenter](https://www.npmjs.com/package/@google-cloud/migrationcenter) instead.
The [@google-cloud/migrationcenter](https://www.npmjs.com/package/@google-cloud/migrationcenter) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/migrationcenter
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/migrationcenter/classes/Migrationcenter.html).
