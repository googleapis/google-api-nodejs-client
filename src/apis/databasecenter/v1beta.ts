    ...
    aggregateQueryStats(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta/{+parent}:aggregateQueryStats').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$V1beta {
    ...
    aggregateFleet(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta:aggregateFleet').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    aggregateIssueStats(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta:aggregateIssueStats').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    queryDatabaseResourceGroups(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta:queryDatabaseResourceGroups').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    queryIssues(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta:queryIssues').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    queryProducts(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta:queryProducts').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
