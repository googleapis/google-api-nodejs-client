...
export namespace safebrowsing_v5 {
  ...
  export class Resource$Hashlist {
    ...
    get(
      params?: Params$Resource$Hashlist$Get,
      options?: MethodOptions
    ): GaxiosPromise<Schema$GoogleSecuritySafebrowsingV5HashList>;
    get(
      params: Params$Resource$Hashlist$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
  ...
  export class Resource$Hashlists {
    ...
    batchGet(
      params?: Params$Resource$Hashlists$Batchget,
      options?: MethodOptions
    ): GaxiosPromise<Schema$GoogleSecuritySafebrowsingV5BatchGetHashListsResponse>;
    batchGet(
      params: Params$Resource$Hashlists$Batchget,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      params?: Params$Resource$Hashlists$List,
      options?: MethodOptions
    ): GaxiosPromise<Schema$GoogleSecuritySafebrowsingV5ListHashListsResponse>;
    list(
      params: Params$Resource$Hashlists$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
