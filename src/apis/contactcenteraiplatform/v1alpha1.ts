...
export namespace contactcenteraiplatform_v1alpha1 {
  ...
  export class Resource$Projects$Locations {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.contactCenters = new Resource$Projects$Locations$Contactcenters(
        this.context
      );
    ...
    generateShifts(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+parent}:generateShifts')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    queryContactCenterQuota(
      params?: Params$Resource$Projects$Locations$Querycontactcenterquota,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ContactCenterQuota>>;
    queryContactCenterQuota(
      params: Params$Resource$Projects$Locations$Querycontactcenterquota,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    queryContactCenterQuota(
      params: Params$Resource$Projects$Locations$Querycontactcenterquota,
      options: MethodOptions | BodyResponseCallback<Schema$ContactCenterQuota>,
      callback: BodyResponseCallback<Schema$ContactCenterQuota>
    ): void;
    queryContactCenterQuota(
      params: Params$Resource$Projects$Locations$Querycontactcenterquota,
      callback: BodyResponseCallback<Schema$ContactCenterQuota>
    ...
    queryContactCenterQuota(
      paramsOrCallback?:
        ...
        | BodyResponseCallback<Schema$ContactCenterQuota>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Querycontactcenterquota;
      let options = (optionsOrCallback || {}) as MethodOptions;
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+parent}:queryContactCenterQuota')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
      ...
      if (callback) {
        createAPIRequest<Schema$ContactCenterQuota>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ContactCenterQuota>(parameters);
      }
    }
  }
  ...
  export class Resource$Projects$Locations$Contactcenters {
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Contactcenters$Create
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Contactcenters$Create;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Contactcenters$Create;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha1/{+parent}/contactCenters')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Contactcenters$Delete
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Contactcenters$Delete;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Contactcenters$Delete;
        options = {};
      }
    ...
    get(
      params?: Params$Resource$Projects$Locations$Contactcenters$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ContactCenter>>;
    get(
      params: Params$Resource$Projects$Locations$Contactcenters$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      params: Params$Resource$Projects$Locations$Contactcenters$Get,
      options: MethodOptions | BodyResponseCallback<Schema$ContactCenter>,
      callback: BodyResponseCallback<Schema$ContactCenter>
    ): void;
    get(
      params: Params$Resource$Projects$Locations$Contactcenters$Get,
      callback: BodyResponseCallback<Schema$ContactCenter>
    ...
    get(
      paramsOrCallback?:
        ...
        | BodyResponseCallback<Schema$ContactCenter>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Contactcenters$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Contactcenters$Get;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ContactCenter>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ContactCenter>(parameters);
      }
    }
    ...
    list(
      params?: Params$Resource$Projects$Locations$Contactcenters$List,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListContactCentersResponse>>;
    list(
      params: Params$Resource$Projects$Locations$Contactcenters$List,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    list(
      params: Params$Resource$Projects$Locations$Contactcenters$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListContactCentersResponse>,
      callback: BodyResponseCallback<Schema$ListContactCentersResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Contactcenters$List,
      callback: BodyResponseCallback<Schema$ListContactCentersResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Contactcenters$List
        | BodyResponseCallback<Schema$ListContactCentersResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
        | StreamMethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Contactcenters$List;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Contactcenters$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ListContactCentersResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListContactCentersResponse>(parameters);
      }
    }
    ...
    patch(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Contactcenters$Patch
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Contactcenters$Patch;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Contactcenters$Patch;
        options = {};
      }
