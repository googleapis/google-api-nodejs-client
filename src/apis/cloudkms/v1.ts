    ...
    locations:
        {
          ...
          get(params, options, callback) {
            ...
            options = options || {};
            const rootUrl =
                options.rootUrl || 'https://cloudkms.googleapis.com/';
            const parameters = {
                ...
                cryptoKeys: {
                  ...
                  create(params, options, callback) {
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * @return {object} Request object
                      */
                  decrypt(params, options, callback) {
                    if (typeof options === 'function') {
                      callback = options;
                      options = {};
                    }
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * @desc Encrypts data, so that it can only be recovered by
                      * a call to Decrypt.
                      * @alias
                      * cloudkms.projects.locations.keyRings.cryptoKeys.encrypt
                      * @memberOf! cloudkms(v1)
                      ...
                      * @return {object} Request object
                      */
                  encrypt(params, options, callback) {
                    if (typeof options === 'function') {
                      callback = options;
                      options = {};
                    }
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * @desc Returns metadata for a given CryptoKey, as well as
                      * its primary CryptoKeyVersion.
                      * @alias
                      * cloudkms.projects.locations.keyRings.cryptoKeys.get
                      * @memberOf! cloudkms(v1)
                      *
                  ...
                  setIamPolicy(params, options, callback) {
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * will return an empty set of permissions, not a NOT_FOUND
                      * error.  Note: This operation is designed to be used for
                      * building permission-aware UIs and command-line tools,
                      * not for authorization checking. This operation may "fail
                  ...
                  testIamPermissions(params, options, callback) {
                    ...
                    return createAPIRequest(parameters, callback);
                      ...
                      * @desc Update the version of a CryptoKey that will be
                      * used in Encrypt
                      * @alias
                      * cloudkms.projects.locations.keyRings.cryptoKeys.updatePrimaryVersion
                      * @memberOf! cloudkms(v1)
                      ...
                      * @return {object} Request object
                      */
                  updatePrimaryVersion(params, options, callback) {
                    if (typeof options === 'function') {
                      callback = options;
                      options = {};
                    }
                  ...
                  cryptoKeyVersions:
                      {
                        ...
                        create(params, options, callback) {
                          ...
                          return createAPIRequest(parameters, callback);
                            ...
                            * will be set to DESTROY_SCHEDULED and destroy_time
                            * will be set to a time 24 hours in the future, at
                            * which point the state will be changed to
                            * DESTROYED, and the key material will be
                            * irrevocably destroyed.  Before the destroy_time is
                            * reached, RestoreCryptoKeyVersion may be called to
                            * reverse the process.
                            * @alias
                            * cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.destroy
                            * @memberOf! cloudkms(v1)
                            ...
                            * @return {object} Request object
                            */
                        destroy(params, options, callback) {
                          if (typeof options === 'function') {
                            callback = options;
                            options = {};
                          }
                          ...
                          return createAPIRequest(parameters, callback);
                            ...
                            * @desc Returns metadata for a given
                            * CryptoKeyVersion.
                            * @alias
                            * cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.get
                            * @memberOf! cloudkms(v1)
                        ...
                        list(params, options, callback) {
                          ...
                          return createAPIRequest(parameters, callback);
                            ...
                            * @desc Update a CryptoKeyVersion's metadata.  state
                            * may be changed between ENABLED and DISABLED using
                            * this method. See DestroyCryptoKeyVersion and
                            * RestoreCryptoKeyVersion to move between other
                            * states.
                            * @alias
                            * cloudkms.projects.locations.keyRings.cryptoKeys.cryptoKeyVersions.patch
                            * @memberOf! cloudkms(v1)
                        ...
                        patch(params, options, callback) {
                          ...
                          return createAPIRequest(parameters, callback);
                            ...
                            * DESTROY_SCHEDULED, state.  Upon restoration of the
                            * CryptoKeyVersion, state will be set to DISABLED,
 ...
 * @property {string} purpose The immutable purpose of this CryptoKey. Currently, the only acceptable purpose is ENCRYPT_DECRYPT.
 * @property {string} rotationPeriod next_rotation_time will be advanced by this period when the service automatically rotates a key. Must be at least one day.  If rotation_period is set, next_rotation_time must also be set.
 */
/**
 ...
 * @property {string} destroyEventTime Output only. The time this CryptoKeyVersion&#39;s key material was destroyed. Only present if state is DESTROYED.
 * @property {string} destroyTime Output only. The time this CryptoKeyVersion&#39;s key material is scheduled for destruction. Only present if state is DESTROY_SCHEDULED.
 * @property {string} name Output only. The resource name for this CryptoKeyVersion in the format `projects/x/locations/x/keyRings/x/cryptoKeys/x/cryptoKeyVersions/x.
 ...
 * @memberOf! cloudkms(v1)
 * @type object
 * @property {string} additionalAuthenticatedData Optional data that must match the data originally supplied in EncryptRequest.additional_authenticated_data.
 * @property {string} ciphertext Required. The encrypted data originally returned in EncryptResponse.ciphertext.
 */
/**
 ...
 * @memberOf! cloudkms(v1)
 * @type object
 * @property {string} additionalAuthenticatedData Optional data that, if specified, must also be provided during decryption through DecryptRequest.additional_authenticated_data.  Must be no larger than 64KiB.
 ...
 * @property {string} name Output only. The resource name for the KeyRing in the format `projects/x/locations/x/keyRings/x.
 */
/**
 ...
 * @property {string} nextPageToken A token to retrieve next page of results. Pass this value in ListCryptoKeysRequest.page_token to retrieve the next page of results.
 ...
 * @property {string} nextPageToken A token to retrieve next page of results. Pass this value in ListCryptoKeyVersionsRequest.page_token to retrieve the next page of results.
 * @property {integer} totalSize The total number of CryptoKeyVersions that matched the query.
 */
/**
 ...
 * @property {string} nextPageToken A token to retrieve next page of results. Pass this value in ListKeyRingsRequest.page_token to retrieve the next page of results.
 ...
 * @memberOf! cloudkms(v1)
 * @type object
 * @property {cloudkms(v1).Policy} policy REQUIRED: The complete policy to be applied to the `resource`. The size of the policy is limited to a few 10s of KB. An empty policy is a valid policy but certain Cloud Platform services (such as Projects) might reject them.
