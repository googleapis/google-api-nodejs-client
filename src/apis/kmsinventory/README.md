...
legacy application, please use [@google-cloud/kms-inventory](https://www.npmjs.com/package/@google-cloud/kms-inventory) instead.
The [@google-cloud/kms-inventory](https://www.npmjs.com/package/@google-cloud/kms-inventory) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/kmsinventory
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/kmsinventory/classes/Kmsinventory.html).
