...
legacy application, please use [@google-cloud/vmmigration](https://www.npmjs.com/package/@google-cloud/vmmigration) instead.
The [@google-cloud/vmmigration](https://www.npmjs.com/package/@google-cloud/vmmigration) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/vmmigration
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/vmmigration/classes/Vmmigration.html).
