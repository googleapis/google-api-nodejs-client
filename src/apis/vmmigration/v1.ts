...
export namespace vmmigration_v1 {
  ...
  export class Resource$Projects$Locations$Groups {
    ...
    addGroupMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+group}:addGroupMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    removeGroupMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+group}:removeGroupMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Imageimports {
    ...
    list(
      params: Params$Resource$Projects$Locations$Imageimports$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListImageImportsResponse>,
  ...
  export class Resource$Projects$Locations$Sources {
    ...
    fetchInventory(
      params: Params$Resource$Projects$Locations$Sources$Fetchinventory,
      options:
        MethodOptions | BodyResponseCallback<Schema$FetchInventoryResponse>,
    ...
    fetchInventory(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+source}:fetchInventory').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Sources$Datacenterconnectors {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/datacenterConnectors').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Sources$Migratingvms {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/migratingVms').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    finalizeMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+migratingVm}:finalizeMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      params: Params$Resource$Projects$Locations$Sources$Migratingvms$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListMigratingVmsResponse>,
    ...
    pauseMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+migratingVm}:pauseMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    resumeMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+migratingVm}:resumeMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    startMigration(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+migratingVm}:startMigration').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Sources$Migratingvms$Clonejobs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/cloneJobs').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    get(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$CloneJob> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$CloneJob>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
    ...
    list(
      params: Params$Resource$Projects$Locations$Sources$Migratingvms$Clonejobs$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListCloneJobsResponse>,
  ...
  export class Resource$Projects$Locations$Sources$Migratingvms$Cutoverjobs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/cutoverJobs').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    get(
      ...
      optionsOrCallback?:
        ...
        | BodyResponseCallback<Readable>,
      callback?:
        BodyResponseCallback<Schema$CutoverJob> | BodyResponseCallback<Readable>
    ):
      | void
      | Promise<GaxiosResponseWithHTTP2<Schema$CutoverJob>>
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
    ...
    list(
      params: Params$Resource$Projects$Locations$Sources$Migratingvms$Cutoverjobs$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListCutoverJobsResponse>,
  ...
  export class Resource$Projects$Locations$Sources$Utilizationreports {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/utilizationReports').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Targetprojects {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/targetProjects').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      params: Params$Resource$Projects$Locations$Targetprojects$List,
      options:
        MethodOptions | BodyResponseCallback<Schema$ListTargetProjectsResponse>,
