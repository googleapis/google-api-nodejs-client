  ...
  export class Resource$Projects$Locations$Connections {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/connections')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchLinkableRepositories(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+connection}:fetchLinkableRepositories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    processWebhook(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/connections:processWebhook')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Connections$Repositories {
    ...
    accessReadToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+repository}:accessReadToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    batchCreate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/repositories:batchCreate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/repositories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchGitRefs(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+repository}:fetchGitRefs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
