...
export namespace cloudbuild_v1 {
    ...
    receive(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/githubDotComWebhook:receive')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Locations {
    ...
    regionalWebhook(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+location}/regionalWebhook')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Githubenterpriseconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/githubEnterpriseConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Bitbucketserverconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/bitbucketServerConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    removeBitbucketServerConnectedRepository(
      ...
      if (params.config !== undefined && params.config !== null) {
        validateMultiSegment('config', String(params.config));
        params.config = encodeWithoutSlashes(String(params.config));
      }
  ...
  export class Resource$Projects$Locations$Bitbucketserverconfigs$Connectedrepositories {
    ...
    batchCreate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/connectedRepositories:batchCreate')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Gitlabconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/gitLabConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Triggers {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/triggers')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Workerpools {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workerPools')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Triggers {
    ...
    delete(
      ...
      if (params.triggerId !== undefined && params.triggerId !== null) {
        validateSingleSegment('triggerId', String(params.triggerId));
        params.triggerId = encodeWithSlashes(String(params.triggerId));
      }
    ...
    webhook(
      ...
      if (params.trigger !== undefined && params.trigger !== null) {
        validateSingleSegment('trigger', String(params.trigger));
        params.trigger = encodeWithSlashes(String(params.trigger));
      }
