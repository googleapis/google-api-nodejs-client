...
export namespace firebaseappcheck_v1 {
   ...
   */
  export interface Schema$GoogleFirebaseAppcheckV1LimitedUseConfig {
    /**
   ...
   */
  export interface Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenRequest {
    /**
     ...
     */
    limitedUseConfig?: Schema$GoogleFirebaseAppcheckV1LimitedUseConfig;
    /**
   ...
   */
  export interface Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse {
    /**
  ...
  export class Resource$Projects$Apps {
    ...
    mintAppCheckToken(
      ...
      GaxiosResponseWithHTTP2<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>
    >;
    mintAppCheckToken(
      params: Params$Resource$Projects$Apps$Mintappchecktoken,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
    ...
    mintAppCheckToken(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>,
      callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>
    ): void;
    mintAppCheckToken(
      params: Params$Resource$Projects$Apps$Mintappchecktoken,
      callback: BodyResponseCallback<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>
    ...
    mintAppCheckToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+app}:mintAppCheckToken').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleFirebaseAppcheckV1MintAppCheckTokenResponse>(
          parameters
        );
      }
    }
