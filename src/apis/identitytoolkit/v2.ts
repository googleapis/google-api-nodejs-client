    ...
    revokeToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/accounts:revokeToken')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Mfaenrollment {
    ...
    finalize(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/accounts/mfaEnrollment:finalize')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    start(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/accounts/mfaEnrollment:start')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Accounts$Mfasignin {
    ...
    finalize(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/accounts/mfaSignIn:finalize')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    start(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/accounts/mfaSignIn:start')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Defaultsupportedidps {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/defaultSupportedIdps')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Identityplatform {
    ...
    initializeAuth(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+project}/identityPlatform:initializeAuth')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Inboundsamlconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/inboundSamlConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Oauthidpconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v2/{+parent}/oauthIdpConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
