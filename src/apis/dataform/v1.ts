...
export namespace dataform_v1 {
  ...
  export class Resource$Projects$Locations {
    context: APIRequestContext;
    folders: Resource$Projects$Locations$Folders;
    operations: Resource$Projects$Locations$Operations;
    repositories: Resource$Projects$Locations$Repositories;
    teamFolders: Resource$Projects$Locations$Teamfolders;
    constructor(context: APIRequestContext) {
      this.context = context;
      this.folders = new Resource$Projects$Locations$Folders(this.context);
      ...
      this.teamFolders = new Resource$Projects$Locations$Teamfolders(
        this.context
      );
    }
    ...
    queryUserRootContents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+location}:queryUserRootContents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Folders {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
    ...
    deleteTree(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:deleteTree')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.folders.getIamPolicy({
     ...
     *     resource: 'projects/my-project/locations/my-location/folders/my-folder',
     *   });
     *   console.log(res.data);
     *
     *   // Example response
     ...
     */
    getIamPolicy(
      params: Params$Resource$Projects$Locations$Folders$Getiampolicy,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    getIamPolicy(
      params?: Params$Resource$Projects$Locations$Folders$Getiampolicy,
    ...
    getIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Folders$Getiampolicy
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Folders$Getiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Folders$Getiampolicy;
        options = {};
      }
    ...
    queryFolderContents(
      ...
      if (params.folder !== undefined && params.folder !== null) {
        validateMultiSegment('folder', String(params.folder));
        params.folder = encodeWithoutSlashes(String(params.folder));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+folder}:queryFolderContents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.folders.setIamPolicy({
    ...
    setIamPolicy(
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Folders$Setiampolicy;
        options = {};
      }
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.folders.testIamPermissions({
    ...
    testIamPermissions(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Folders$Testiampermissions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Folders$Testiampermissions;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export class Resource$Projects$Locations$Operations {
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.operations.cancel({
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.operations.delete({
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.operations.get({
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.operations.list({
  ...
  export class Resource$Projects$Locations$Repositories {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/repositories')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchRemoteBranches(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:fetchRemoteBranches')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    queryDirectoryContents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:queryDirectoryContents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Compilationresults {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/compilationResults')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Releaseconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/releaseConfigs')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Workflowinvocations {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workflowInvocations')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Repositories$Workspaces {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/workspaces')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    fetchFileDiff(
      ...
      if (params.workspace !== undefined && params.workspace !== null) {
        validateMultiSegment('workspace', String(params.workspace));
        params.workspace = encodeWithoutSlashes(String(params.workspace));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:fetchFileDiff')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    fetchGitAheadBehind(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:fetchGitAheadBehind')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    installNpmPackages(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:installNpmPackages')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    moveDirectory(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:moveDirectory')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    moveFile(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:moveFile')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    queryDirectoryContents(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:queryDirectoryContents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    readFile(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:readFile')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    removeDirectory(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:removeDirectory')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    removeFile(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:removeFile')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    searchFiles(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:searchFiles')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    writeFile(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+workspace}:writeFile')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Locations$Teamfolders {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/teamFolders')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.teamFolders.getIamPolicy({
     *     // Optional. The maximum policy version that will be used to format the policy. Valid values are 0, 1, and 3. Requests specifying an invalid value will be rejected. Requests for policies with any conditional role bindings must specify version 3. Policies with no conditional role bindings may specify any valid value or leave the field unset. The policy in the response might use the policy version that you specified, or it might use a lower policy version. For example, if you specify version 3, but the policy has no conditional role bindings, the response uses version 1. To learn which resources support conditions in their IAM policies, see the [IAM documentation](https://cloud.google.com/iam/help/conditions/resource-policies).
     *     'options.requestedPolicyVersion': 'placeholder-value',
     *     // REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     *     resource:
     ...
     */
    getIamPolicy(
      params: Params$Resource$Projects$Locations$Teamfolders$Getiampolicy,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    getIamPolicy(
      params?: Params$Resource$Projects$Locations$Teamfolders$Getiampolicy,
    ...
    getIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Teamfolders$Getiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Teamfolders$Getiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;
    ...
    queryContents(
      ...
      if (params.teamFolder !== undefined && params.teamFolder !== null) {
        validateMultiSegment('teamFolder', String(params.teamFolder));
        params.teamFolder = encodeWithoutSlashes(String(params.teamFolder));
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+teamFolder}:queryContents')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
    ...
    search(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+location}/teamFolders:search')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.teamFolders.setIamPolicy({
     *     // REQUIRED: The resource for which the policy is being specified. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     *     resource:
     *       'projects/my-project/locations/my-location/teamFolders/my-teamFolder',
     *
     ...
     */
    setIamPolicy(
      params: Params$Resource$Projects$Locations$Teamfolders$Setiampolicy,
      options: StreamMethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Readable>>;
    setIamPolicy(
      params?: Params$Resource$Projects$Locations$Teamfolders$Setiampolicy,
    ...
    setIamPolicy(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Teamfolders$Setiampolicy
        | BodyResponseCallback<Schema$Policy>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Teamfolders$Setiampolicy;
      let options = (optionsOrCallback || {}) as MethodOptions;
     ...
     *
     *   // Do the magic
     *   const res = await dataform.projects.locations.teamFolders.testIamPermissions({
     *     // REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
     *     resource:
     *       'projects/my-project/locations/my-location/teamFolders/my-teamFolder',
     *
    ...
    testIamPermissions(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Teamfolders$Testiampermissions
        | BodyResponseCallback<Schema$TestIamPermissionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Teamfolders$Testiampermissions;
      let options = (optionsOrCallback || {}) as MethodOptions;
