...
legacy application, please use [@google-cloud/dataform](https://www.npmjs.com/package/@google-cloud/dataform) instead.
The [@google-cloud/dataform](https://www.npmjs.com/package/@google-cloud/dataform) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/dataform
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/dataform/classes/Dataform.html).
