...
legacy application, please use [@google-cloud/dataplex](https://www.npmjs.com/package/@google-cloud/dataplex) instead.
The [@google-cloud/dataplex](https://www.npmjs.com/package/@google-cloud/dataplex) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/dataplex
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/dataplex/classes/Dataplex.html).
