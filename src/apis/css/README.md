...
legacy application, please use [@google-shopping/css](https://www.npmjs.com/package/@google-shopping/css) instead.
The [@google-shopping/css](https://www.npmjs.com/package/@google-shopping/css) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/css
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/css/classes/Css.html).
