...
legacy application, please use [@google-cloud/dns](https://www.npmjs.com/package/@google-cloud/dns) instead.
The [@google-cloud/dns](https://www.npmjs.com/package/@google-cloud/dns) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/dns
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/dns/classes/Dns.html).
...
```html
<script src="/path/to/dns.min.js"></script>
<script>
const { dns, auth } = Dns;
</script>
```
