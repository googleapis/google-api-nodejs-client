...
export namespace dns_v2 {
    ...
    get(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/dns/v2/projects/{project}/locations/{location}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
  ...
  export class Resource$Responsepolicies {
    ...
    create(
      ...
      callback?:
        | BodyResponseCallback<Schema$ResponsePolicy>
        | BodyResponseCallback<Readable>
    ): void | Promise<GaxiosResponseWithHTTP2<Schema$ResponsePolicy>> | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
  ...
  export class Resource$Responsepolicyrules {
    ...
    patch(
      params?: Params$Resource$Responsepolicyrules$Patch,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ResponsePolicyRulesPatchResponse>>;
    patch(
      params: Params$Resource$Responsepolicyrules$Patch,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    update(
      params?: Params$Resource$Responsepolicyrules$Update,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$ResponsePolicyRulesUpdateResponse>>;
    update(
      params: Params$Resource$Responsepolicyrules$Update,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
