...
legacy application, please use [@google-cloud/lineage](https://www.npmjs.com/package/@google-cloud/lineage) instead.
The [@google-cloud/lineage](https://www.npmjs.com/package/@google-cloud/lineage) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/datalineage
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/datalineage/classes/Datalineage.html).
