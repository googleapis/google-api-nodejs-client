...
```sh
$ npm install @googleapis/billingbudgets
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/billingbudgets/classes/Billingbudgets.html).
...
The generated bundle will be written to `dist/billingbudgets.min.js`. Use it from your HTML file:

```html
<script src="/path/to/billingbudgets.min.js"></script>
<script>
const { billingbudgets, auth } = Billingbudgets;
</script>
```
