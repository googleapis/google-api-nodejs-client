...
legacy application, please use [@google-cloud/contentwarehouse](https://www.npmjs.com/package/@google-cloud/contentwarehouse) instead.
The [@google-cloud/contentwarehouse](https://www.npmjs.com/package/@google-cloud/contentwarehouse) library is faster, easier to use, and better maintained.
...
```sh
$ npm install @googleapis/contentwarehouse
```

## Usage
All documentation and usage information can be found on [GitHub](https://github.com/googleapis/google-api-nodejs-client).
Information on classes can be found in [Googleapis Documentation](https://googleapis.dev/nodejs/googleapis/latest/contentwarehouse/classes/Contentwarehouse.html).
