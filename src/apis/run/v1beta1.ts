...
export namespace run_v1beta1 {
  ...
  export class Run {
    ...
    constructor(options: GlobalOptions, google?: GoogleConfigurable) {
      ...
      this.customresourcedefinitions = new Resource$Customresourcedefinitions(
        this.context
      );
  ...
  export interface Schema$JSONSchemaProps {
    ...
    default?: Schema$JSON;
    definitions?: {[key: string]: Schema$JSONSchemaProps} | null;
    dependencies?: {[key: string]: Schema$JSONSchemaPropsOrStringArray} | null;
    description?: string | null;
    enum?: string[] | null;
    example?: Schema$JSON;
    ...
    pattern?: string | null;
    patternProperties?: {[key: string]: Schema$JSONSchemaProps} | null;
    properties?: {[key: string]: Schema$JSONSchemaProps} | null;
    ref?: string | null;
  ...
  export class Resource$Customresourcedefinitions {
    ...
    ): Promise<GaxiosResponseWithHTTP2<Schema$ListCustomResourceDefinitionsResponse>>;
    list(
      params: Params$Resource$Customresourcedefinitions$List,
    ...
    list(
      ...
      if (typeof paramsOrCallback === 'function') {
        ...
        params = {} as Params$Resource$Customresourcedefinitions$List;
        options = {};
      }
  ...
  export class Resource$Namespaces$Customresourcedefinitions {
    ...
    get(
      params?: Params$Resource$Namespaces$Customresourcedefinitions$Get,
      options?: MethodOptions
    ): Promise<GaxiosResponseWithHTTP2<Schema$CustomResourceDefinition>>;
    get(
      params: Params$Resource$Namespaces$Customresourcedefinitions$Get,
      options: StreamMethodOptions | BodyResponseCallback<Readable>,
      callback: BodyResponseCallback<Readable>
    ...
    get(
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Namespaces$Customresourcedefinitions$Get;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/apis/apiextensions.k8s.io/v1beta1/{+name}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1beta1/{+parent}/customresourcedefinitions'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
