...
The generated bundle will be written to `dist/mirror.min.js`. Use it from your HTML file:

```html
<script src="/path/to/mirror.min.js"></script>
<script>
const { mirror, auth } = Mirror;
</script>
```
