    ...
    upload(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+app}/releases:upload')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
        ...
        params,
        mediaUrl: (rootUrl + '/upload/v1/{+app}/releases:upload')
          .replace(/([^:]\/)\/+/g, '$1')
          .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
        requiredParams: ['app'],
        pathParams: ['app'],
  ...
  export class Resource$Projects$Apps$Releases {
    ...
    distribute(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+name}:distribute')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Apps$Releases$Feedbackreports {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/feedbackReports')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'GET',
            apiVersion: '',
  ...
  export class Resource$Projects$Groups {
    ...
    batchJoin(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+group}:batchJoin')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    batchLeave(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+group}:batchLeave')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
  ...
  export class Resource$Projects$Testers {
    ...
    batchAdd(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+project}/testers:batchAdd')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
    ...
    batchRemove(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+project}/testers:batchRemove')
              .replace(/([^:]\/)\/+/g, '$1')
              .replace(/\{([^+:][^}]*)\}/g, '{+$1}'),
            method: 'POST',
            apiVersion: '',
