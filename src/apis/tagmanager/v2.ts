          ...
          workspaces:
              {
                ...
                create(params, options, callback) {
                  ...
                  return createAPIRequest(parameters, callback);
                    ...
                    * present in the workspace, deletes the workspace, and sets
                    * the base container version to the newly created version.
                    * @alias
                    * tagmanager.accounts.containers.workspaces.create_version
                    * @memberOf! tagmanager(v2)
                    *
                ...
                create_version(params, options, callback) {
                  ...
                  const parameters = {
                    options: Object.assign(
                        {
                          url:
                              (rootUrl + '/tagmanager/v2/{path}:create_version')
                                  .replace(/([^:]\/)\/+/g, '$1'),
                          method: 'POST'
                        },
                        options),
