...
export namespace transcoder_v1beta1 {
  ...
  export class Resource$Projects$Locations {
    ...
    constructor(context: APIRequestContext) {
      ...
      this.jobTemplates = new Resource$Projects$Locations$Jobtemplates(
        this.context
      );
    }
  }
  ...
  export class Resource$Projects$Locations$Jobtemplates {
    ...
    create(
      params: Params$Resource$Projects$Locations$Jobtemplates$Create,
      options: MethodOptions | BodyResponseCallback<Schema$JobTemplate>,
      callback: BodyResponseCallback<Schema$JobTemplate>
    ): void;
    create(
      params: Params$Resource$Projects$Locations$Jobtemplates$Create,
      callback: BodyResponseCallback<Schema$JobTemplate>
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Jobtemplates$Create
      ...
      callback?:
        | BodyResponseCallback<Schema$JobTemplate>
        | BodyResponseCallback<Readable>
    ): void | Promise<GaxiosResponseWithHTTP2<Schema$JobTemplate>> | Promise<GaxiosResponseWithHTTP2<Readable>> {
      let params = (paramsOrCallback ||
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Jobtemplates$Create;
        options = {};
      }
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1beta1/{+parent}/jobTemplates').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
      ...
      if (callback) {
        createAPIRequest<Schema$JobTemplate>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$JobTemplate>(parameters);
      }
    }
    ...
    delete(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Jobtemplates$Delete
        | BodyResponseCallback<Schema$Empty>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Jobtemplates$Delete;
        options = {};
      }
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Jobtemplates$Get
        | BodyResponseCallback<Schema$JobTemplate>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Jobtemplates$Get;
        options = {};
      }
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$ListJobTemplatesResponse>,
      callback: BodyResponseCallback<Schema$ListJobTemplatesResponse>
    ): void;
    list(
      params: Params$Resource$Projects$Locations$Jobtemplates$List,
      callback: BodyResponseCallback<Schema$ListJobTemplatesResponse>
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Jobtemplates$List
        | BodyResponseCallback<Schema$ListJobTemplatesResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Projects$Locations$Jobtemplates$List;
        options = {};
      }
      ...
      if (callback) {
        createAPIRequest<Schema$ListJobTemplatesResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$ListJobTemplatesResponse>(parameters);
      }
    }
  }
