...
export namespace transcoder_v1 {
  ...
  export class Resource$Projects$Locations$Jobtemplates {
    ...
    create(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$JobTemplate>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1/{+parent}/jobTemplates').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      ...
      | void
      | GaxiosResponseWithHTTP2<Schema$ListJobTemplatesResponse>
      | GaxiosResponseWithHTTP2<Readable> {
      let params = (paramsOrCallback ||
