...
BatchTransporter.prototype.wrapCallback_ = function(opt_callback) {
  return function(err, body, res) {
    ...
    responses.forEach(function(response) {
      //Parse HTTP response data into a proper JSON object if possible
      ...
      try {        
        ...
        //If JSON parsing fails, just push the string into the response array.
        batch_response.push(resp_obj.body);
      }
    });
