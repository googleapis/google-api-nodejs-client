...
/**
 * Gets the API's canonical name.
 * If no canonical name, returns the name.
 * @return {String}
 */
Client.prototype.getCanonicalName = function() {
	return this.apiMeta.canonicalName || this.getName()
}
