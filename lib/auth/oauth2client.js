...
OAuth2Client.prototype.request =
  ...
  creds.token_type = creds.token_type || 'Bearer';
  opts.headers = opts.headers || {};
  opts.headers['Authorization'] = creds.token_type + ' ' + creds.access_token;
  ...
  return this.transporter.request(opts, function(err, body, res) {
    ...
    if (!opt_dontForceRefresh && hasAuthError && creds.refresh_token) {
      // refresh access token and re-request
      that.refreshToken_(creds.refresh_token, function(err, result) {
