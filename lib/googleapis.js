...
function GoogleApis(options) {
  ...
  this.transporter = this._options.transporter || new DefaultTransporter();
  this.auth = this._options.auth || null;
  this.addAPIs(apis);
}

/**
 * Set options on GoogleApis object
 * @param  {object} options object full of options
 */
GoogleApis.prototype = {
  get options() {
