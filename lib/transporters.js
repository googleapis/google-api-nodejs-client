...
/**
 * Sets default configuration for all subsequent googleapi HTTP requests.
 * @param {object} options Default options for requests
 * @link https://github.com/mikeal/request#requestdefaultsoptions
 */
DefaultTransporter.prototype.defaults = function(options) {
