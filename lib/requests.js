...
var generateUploadPath = function(rootUrl, params) {
    var basePath = url.resolve(rootUrl, '/upload');
    return url.resolve(basePath, this.generatePath(params));
};
...
Request.prototype.generateUploadBody = function(rootUrl) {
  ...
  if (!this.body) {
    ...
    return {
      uri: generateUploadPath(rootUrl, params),
      method: this.methodMeta.httpMethod,
      headers: {
