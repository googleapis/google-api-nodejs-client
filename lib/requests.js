 ...
 * @param  {String} baseUri     The base Uri of the method
 *                              e.g. http://servername
 * @param  {Array} paths        Array of string that will be joined into
 *                              the method path
...
Request.prototype.generateMethodUri = function(baseUri, paths, queryParams) {
    ...
    return buildUri(baseUri, paths, queryParams);
};

Request.prototype.generatePath = function(params) {
    return this.generateMethodUri(BaseRequest.BASE_URL, [], params);
};
...
Request.prototype.generatePayload = function(rootUrl) {
  return !this.media ?
    this.generateBody(rootUrl) : this.generateUploadBody(rootUrl);
};
